...
public abstract class AndroidLiveWallpaperService extends WallpaperService {
    ...
    public class AndroidWallpaperEngine extends Engine {
        ...
        /* renamed from: com.badlogic.gdx.backends.android.AndroidLiveWallpaperService.AndroidWallpaperEngine.2 */
        class C00452 implements Runnable {
            final /* synthetic */ boolean val$currentPreviewState;

            C00452(boolean z) {
                this.val$currentPreviewState = z;
            }

            public void run() {
                boolean shouldNotify = false;
                synchronized (AndroidLiveWallpaperService.this.sync) {
                    if (!(AndroidLiveWallpaperService.this.isPreviewNotified && AndroidLiveWallpaperService.this.notifiedPreviewState == this.val$currentPreviewState)) {
                        AndroidLiveWallpaperService.this.notifiedPreviewState = this.val$currentPreviewState;
                ...
                if (shouldNotify) {
                    ...
                    if (currentApp != null) {
                        ((AndroidWallpaperListener) currentApp.listener).previewStateChange(this.val$currentPreviewState);
                    }
                }
            }
        }
        ...
        protected void notifyPreviewState() {
            if (AndroidLiveWallpaperService.this.linkedEngine == this && (AndroidLiveWallpaperService.this.app.listener instanceof AndroidWallpaperListener)) {
                AndroidLiveWallpaperService.this.app.postRunnable(new C00452(AndroidLiveWallpaperService.this.linkedEngine.isPreview()));
            }
        }
    }
