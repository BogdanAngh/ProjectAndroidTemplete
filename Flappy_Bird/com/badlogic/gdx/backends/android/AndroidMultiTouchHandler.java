...
public class AndroidMultiTouchHandler implements AndroidTouchHandler {
    ...
    L_0x001f:
        ...
        return;
    L_0x002a:
        r5 = r15.getFreePointerIndex();	 Catch:{ all -> 0x005a }
        r0 = r15.realId;	 Catch:{ all -> 0x005a }
        r0[r5] = r11;	 Catch:{ all -> 0x005a }
        r0 = r14.getX(r12);	 Catch:{ all -> 0x005a }
        r3 = (int) r0;	 Catch:{ all -> 0x005a }
        r0 = r14.getY(r12);	 Catch:{ all -> 0x005a }
        r4 = (int) r0;	 Catch:{ all -> 0x005a }
        r2 = 0;
        r0 = r13;
        r1 = r15;
        r0.postTouchEvent(r1, r2, r3, r4, r5, r6);	 Catch:{ all -> 0x005a }
        r0 = r15.touchX;	 Catch:{ all -> 0x005a }
        r0[r5] = r3;	 Catch:{ all -> 0x005a }
        r0 = r15.touchY;	 Catch:{ all -> 0x005a }
        r0[r5] = r4;	 Catch:{ all -> 0x005a }
        r0 = r15.deltaX;	 Catch:{ all -> 0x005a }
        r1 = 0;
        r0[r5] = r1;	 Catch:{ all -> 0x005a }
        r0 = r15.deltaY;	 Catch:{ all -> 0x005a }
        r1 = 0;
        r0[r5] = r1;	 Catch:{ all -> 0x005a }
        r0 = r15.touched;	 Catch:{ all -> 0x005a }
        r1 = 1;
        r0[r5] = r1;	 Catch:{ all -> 0x005a }
        goto L_0x001f;
    L_0x005a:
        ...
        throw r0;
    L_0x005d:
        r5 = r15.lookUpPointerIndex(r11);	 Catch:{ all -> 0x005a }
        r0 = -1;
    ...
    L_0x0064:
        ...
        goto L_0x001f;
    L_0x0091:
        r10 = r14.getPointerCount();	 Catch:{ all -> 0x005a }
        r9 = 0;
    L_0x0096:
        if (r9 >= r10) goto L_0x001f;
    L_0x0098:
        r12 = r9;
        r11 = r14.getPointerId(r12);	 Catch:{ all -> 0x005a }
        r0 = r14.getX(r12);	 Catch:{ all -> 0x005a }
        r3 = (int) r0;	 Catch:{ all -> 0x005a }
        r0 = r14.getY(r12);	 Catch:{ all -> 0x005a }
        r4 = (int) r0;	 Catch:{ all -> 0x005a }
    ...
    L_0x00b1:
        ...
        r0.postTouchEvent(r1, r2, r3, r4, r5, r6);	 Catch:{ all -> 0x005a }
        r0 = r15.deltaX;	 Catch:{ all -> 0x005a }
        r1 = r15.touchX;	 Catch:{ all -> 0x005a }
        r1 = r1[r5];	 Catch:{ all -> 0x005a }
        r1 = r3 - r1;
        r0[r5] = r1;	 Catch:{ all -> 0x005a }
        r0 = r15.deltaY;	 Catch:{ all -> 0x005a }
        r1 = r15.touchY;	 Catch:{ all -> 0x005a }
        r1 = r1[r5];	 Catch:{ all -> 0x005a }
        r1 = r4 - r1;
        r0[r5] = r1;	 Catch:{ all -> 0x005a }
        r0 = r15.touchX;	 Catch:{ all -> 0x005a }
