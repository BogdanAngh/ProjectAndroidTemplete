...
class GLLogWrapper extends GLWrapperBase {
    ...
    private String getClearBufferMask(int mask) {
        ...
        if ((mask & Place.TYPE_SUBLOCALITY_LEVEL_2) != 0) {
            if (b.length() > 0) {
                b.append(" | ");
            }
    ...
    private String getFactor(int factor) {
        switch (factor) {
            ...
            case GL20.GL_DST_ALPHA /*772*/:
                return "GL_DST_ALPHA";
            case GL20.GL_ONE_MINUS_DST_ALPHA /*773*/:
                return "GL_ONE_MINUS_DST_ALPHA";
            case GL20.GL_DST_COLOR /*774*/:
                return "GL_DST_COLOR";
            case GL20.GL_ONE_MINUS_DST_COLOR /*775*/:
    ...
    private String getCap(int cap) {
        switch (cap) {
            ...
            case GL10.GL_FOG /*2912*/:
                return "GL_FOG";
            case GL20.GL_DEPTH_TEST /*2929*/:
                return "GL_DEPTH_TEST";
            case GL20.GL_STENCIL_TEST /*2960*/:
                return "GL_STENCIL_TEST";
            case GL10.GL_NORMALIZE /*2977*/:
                return "GL_NORMALIZE";
            case GL10.GL_ALPHA_TEST /*3008*/:
                return "GL_ALPHA_TEST";
            case GL20.GL_DITHER /*3024*/:
                return "GL_DITHER";
            case GL20.GL_BLEND /*3042*/:
                return "GL_BLEND";
            ...
            case GL20.GL_SAMPLE_ALPHA_TO_COVERAGE /*32926*/:
                return "GL_SAMPLE_ALPHA_TO_COVERAGE";
            case GL10.GL_SAMPLE_ALPHA_TO_ONE /*32927*/:
                return "GL_SAMPLE_ALPHA_TO_ONE";
            case GL20.GL_SAMPLE_COVERAGE /*32928*/:
    ...
    private String getTexturePName(int pname) {
        switch (pname) {
            case GL20.GL_TEXTURE_MAG_FILTER /*10240*/:
                return "GL_TEXTURE_MAG_FILTER";
            case GL20.GL_TEXTURE_MIN_FILTER /*10241*/:
                return "GL_TEXTURE_MIN_FILTER";
            case GL20.GL_TEXTURE_WRAP_S /*10242*/:
                return "GL_TEXTURE_WRAP_S";
            case GL20.GL_TEXTURE_WRAP_T /*10243*/:
    ...
    private String getTextureParamName(float param) {
        ...
        switch (iparam) {
            ...
            case GL20.GL_REPEAT /*10497*/:
                return "GL_REPEAT";
            case GL20.GL_CLAMP_TO_EDGE /*33071*/:
    ...
    private String getIntegerStateName(int pname) {
        switch (pname) {
            ...
            case GL20.GL_MAX_TEXTURE_SIZE /*3379*/:
            ...
            case GL20.GL_MAX_VIEWPORT_DIMS /*3386*/:
                return "GL_MAX_VIEWPORT_DIMS";
            case GL20.GL_SUBPIXEL_BITS /*3408*/:
                return "GL_SUBPIXEL_BITS";
            case GL20.GL_RED_BITS /*3410*/:
                return "GL_RED_BITS";
            case GL20.GL_GREEN_BITS /*3411*/:
                return "GL_GREEN_BITS";
            case GL20.GL_BLUE_BITS /*3412*/:
                return "GL_BLUE_BITS";
            case GL20.GL_ALPHA_BITS /*3413*/:
                return "GL_ALPHA_BITS";
            case GL20.GL_DEPTH_BITS /*3414*/:
                return "GL_DEPTH_BITS";
            case GL20.GL_STENCIL_BITS /*3415*/:
                return "GL_STENCIL_BITS";
            case GL11.GL_MAX_ELEMENTS_VERTICES /*33000*/:
                return "GL_MAX_ELEMENTS_VERTICES";
            case GL11.GL_MAX_ELEMENTS_INDICES /*33001*/:
                return "GL_MAX_ELEMENTS_INDICES";
            case GL20.GL_ALIASED_POINT_SIZE_RANGE /*33901*/:
                return "GL_ALIASED_POINT_SIZE_RANGE";
            case GL20.GL_ALIASED_LINE_WIDTH_RANGE /*33902*/:
                return "GL_ALIASED_LINE_WIDTH_RANGE";
            case GL20.GL_MAX_TEXTURE_UNITS /*34018*/:
                return "GL_MAX_TEXTURE_UNITS";
            case GL20.GL_NUM_COMPRESSED_TEXTURE_FORMATS /*34466*/:
                return "GL_NUM_COMPRESSED_TEXTURE_FORMATS";
            case GL20.GL_COMPRESSED_TEXTURE_FORMATS /*34467*/:
    ...
    private int getIntegerStateSize(int pname) {
        switch (pname) {
            ...
            case GL20.GL_COMPRESSED_TEXTURE_FORMATS /*34467*/:
                ...
                this.mgl.glGetIntegerv(GL20.GL_NUM_COMPRESSED_TEXTURE_FORMATS, buffer, 0);
                return buffer[0];
            case 35213:
            case 35214:
            case 35215:
    ...
    private String getHintTarget(int target) {
        switch (target) {
            ...
            case GL10.GL_FOG_HINT /*3156*/:
                return "GL_FOG_HINT";
            case GL11.GL_GENERATE_MIPMAP_HINT /*33170*/:
    ...
    private String getHintMode(int mode) {
        switch (mode) {
            case GL20.GL_DONT_CARE /*4352*/:
                return "GL_DONT_CARE";
            case GL20.GL_FASTEST /*4353*/:
                return "GL_FASTEST";
            case GL20.GL_NICEST /*4354*/:
                return "GL_NICEST";
            default:
                return getHex(mode);
        }
    ...
    private String getLightName(int light) {
        if (light < GL20.GL_COLOR_BUFFER_BIT || light > GL10.GL_LIGHT7) {
            return getHex(light);
        }
    ...
    ByteBuffer toByteBuffer(int byteCount, Buffer input) {
        ...
        if (input instanceof ByteBuffer) {
            ...
            if (convertWholeBuffer) {
                byteCount = input22.limit() * FORMAT_FIXED;
            }
            ...
            if (convertWholeBuffer) {
                byteCount = input23.limit() * FORMAT_FIXED;
            }
        ...
        switch (type) {
            case GL20.GL_UNSIGNED_BYTE /*5121*/:
                ...
                for (int i = 0; i < count; i += FORMAT_FLOAT) {
                    result[i] = (char) (array[offset + i] & Keys.F12);
                }
                break;
            case GL20.GL_UNSIGNED_SHORT /*5123*/:
                ...
                for (int i = 0; i < size; i += FORMAT_FLOAT) {
                    ...
                    switch (type) {
                        case GL20.GL_BYTE /*5120*/:
                            ...
                            break;
                        case GL20.GL_UNSIGNED_BYTE /*5121*/:
                            builder.append(Integer.toString(byteBuffer.get(byteOffset) & Keys.F12));
                            break;
                        case GL20.GL_SHORT /*5122*/:
