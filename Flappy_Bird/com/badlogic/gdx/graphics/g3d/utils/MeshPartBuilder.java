...
public interface MeshPartBuilder {
    ...
    public static class VertexInfo implements Poolable {
        ...
        public VertexInfo() {
            ...
            this.normal = new Vector3(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f);
        ...
        public void reset() {
            ...
            this.normal.set(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f);
            this.color.set(TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE, TextTrackStyle.DEFAULT_FONT_SCALE);
