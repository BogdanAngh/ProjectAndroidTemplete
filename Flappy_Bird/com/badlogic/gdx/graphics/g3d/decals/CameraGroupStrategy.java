...
public class CameraGroupStrategy implements GroupStrategy, Disposable {
    ...
    class C00572 implements Comparator<Decal> {
        final /* synthetic */ Camera val$camera;

        C00572(Camera camera) {
    ...
    /* renamed from: com.badlogic.gdx.graphics.g3d.decals.CameraGroupStrategy.1 */
    class C03511 extends Pool<Array<Decal>> {
        C03511(int x0) {
            super(x0);
        }
