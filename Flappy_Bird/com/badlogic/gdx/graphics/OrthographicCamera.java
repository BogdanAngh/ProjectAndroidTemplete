...
public class OrthographicCamera extends Camera {
    ...
    public OrthographicCamera() {
        this.zoom = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    public void setToOrtho(boolean yDown, float viewportWidth, float viewportHeight) {
        if (yDown) {
            this.up.set(0.0f, GroundOverlayOptions.NO_DIMENSION, 0.0f);
            this.direction.set(0.0f, 0.0f, TextTrackStyle.DEFAULT_FONT_SCALE);
        } else {
            this.up.set(0.0f, TextTrackStyle.DEFAULT_FONT_SCALE, 0.0f);
            this.direction.set(0.0f, 0.0f, GroundOverlayOptions.NO_DIMENSION);
        }
    ...
    public void translate(Vector2 vec) {
        translate(vec.f100x, vec.f101y, 0.0f);
    }
}
