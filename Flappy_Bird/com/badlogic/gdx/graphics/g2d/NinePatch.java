...
public class NinePatch {
    ...
    private void load(TextureRegion[] patches) {
        ...
        if (patches[BOTTOM_LEFT] != null) {
            this.bottomLeft = add(patches[BOTTOM_LEFT], color);
        ...
        if (patches[BOTTOM_CENTER] != null) {
            this.bottomCenter = add(patches[BOTTOM_CENTER], color);
        ...
        if (patches[BOTTOM_RIGHT] != null) {
            this.bottomRight = add(patches[BOTTOM_RIGHT], color);
        ...
        if (patches[MIDDLE_LEFT] != null) {
            this.middleLeft = add(patches[MIDDLE_LEFT], color);
        ...
        if (patches[MIDDLE_CENTER] != null) {
            this.middleCenter = add(patches[MIDDLE_CENTER], color);
        ...
        if (patches[MIDDLE_RIGHT] != null) {
            this.middleRight = add(patches[MIDDLE_RIGHT], color);
        ...
        if (patches[TOP_LEFT] != null) {
            this.topLeft = add(patches[TOP_LEFT], color);
        ...
        if (patches[TOP_CENTER] != null) {
            this.topCenter = add(patches[TOP_CENTER], color);
        ...
        if (patches[TOP_RIGHT] != null) {
            this.topRight = add(patches[TOP_RIGHT], color);
    ...
    public void draw(SpriteBatch batch, float x, float y, float width, float height) {
        ...
        batch.draw(this.texture, this.vertices, TOP_LEFT, this.idx);
    }
