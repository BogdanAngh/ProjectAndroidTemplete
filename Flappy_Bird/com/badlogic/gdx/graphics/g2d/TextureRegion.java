...
public class TextureRegion {
    ...
    public void setRegion(int x, int y, int width, int height) {
        float invTexWidth = TextTrackStyle.DEFAULT_FONT_SCALE / ((float) this.texture.getWidth());
        float invTexHeight = TextTrackStyle.DEFAULT_FONT_SCALE / ((float) this.texture.getHeight());
    ...
    public void scroll(float xAmount, float yAmount) {
        if (xAmount != 0.0f) {
            ...
            this.f51u = (this.f51u + xAmount) % TextTrackStyle.DEFAULT_FONT_SCALE;
            this.u2 = this.f51u + (width / ((float) this.texture.getWidth()));
        }
        if (yAmount != 0.0f) {
            float height = (this.v2 - this.f52v) * ((float) this.texture.getHeight());
            this.f52v = (this.f52v + yAmount) % TextTrackStyle.DEFAULT_FONT_SCALE;
