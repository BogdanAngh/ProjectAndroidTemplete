...
public class IndexBufferObject implements IndexData {
    ...
    public void setIndices(short[] indices, int offset, int count) {
        ...
        if (this.isBound) {
            if (Gdx.gl11 != null) {
                Gdx.gl11.glBufferData(GL11.GL_ELEMENT_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
            } else if (Gdx.gl20 != null) {
                Gdx.gl20.glBufferData(GL11.GL_ELEMENT_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
            }
            this.isDirty = false;
        }
    }
    ...
    public void bind() {
        ...
        if (Gdx.gl11 != null) {
            ...
            if (this.isDirty) {
                ...
                gl.glBufferData(GL11.GL_ELEMENT_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
                this.isDirty = false;
            }
        } else {
            GL20 gl2 = Gdx.gl20;
            ...
            if (this.isDirty) {
                this.byteBuffer.limit(this.buffer.limit() * 2);
                gl2.glBufferData(GL11.GL_ELEMENT_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
                this.isDirty = false;
            }
        }
        this.isBound = true;
