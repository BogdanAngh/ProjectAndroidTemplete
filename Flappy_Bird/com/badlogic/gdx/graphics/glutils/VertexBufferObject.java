...
public class VertexBufferObject implements VertexData {
    ...
    public void setVertices(float[] vertices, int offset, int count) {
        ...
        if (this.isBound) {
            if (Gdx.gl20 != null) {
                Gdx.gl20.glBufferData(GL11.GL_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
            } else {
                Gdx.gl11.glBufferData(GL11.GL_ARRAY_BUFFER, this.byteBuffer.limit(), this.byteBuffer, this.usage);
            }
            this.isDirty = false;
        }
    }
