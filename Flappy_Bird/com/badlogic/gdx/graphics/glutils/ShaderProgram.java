...
public class ShaderProgram implements Disposable {
    ...
    public void setUniformMatrix4fv(String name, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        gl.glUniformMatrix4fv(fetchUniformLocation(name), length / 16, false, this.floatBuffer);
    }

    public void setUniformf(String name, Vector2 values) {
        setUniformf(name, values.f100x, values.f101y);
    }

    public void setUniformf(int location, Vector2 values) {
        setUniformf(location, values.f100x, values.f101y);
    }

    public void setUniformf(String name, Vector3 values) {
        setUniformf(name, values.f105x, values.f106y, values.f107z);
    }

    public void setUniformf(int location, Vector3 values) {
        setUniformf(location, values.f105x, values.f106y, values.f107z);
    }
