...
public class DataOutput extends DataOutputStream {
    ...
    public int writeInt(int value, boolean optimizePositive) throws IOException {
        ...
        write((byte) ((value & 127) | Cast.MAX_NAMESPACE_LENGTH));
        if ((value >>> 14) == 0) {
            write((byte) (value >>> 7));
            return 2;
        }
        write((byte) ((value >>> 7) | Cast.MAX_NAMESPACE_LENGTH));
        if ((value >>> 21) == 0) {
            write((byte) (value >>> 14));
            return 3;
        }
        write((byte) ((value >>> 14) | Cast.MAX_NAMESPACE_LENGTH));
        if ((value >>> 28) == 0) {
            write((byte) (value >>> 21));
            return 4;
        }
        write((byte) ((value >>> 21) | Cast.MAX_NAMESPACE_LENGTH));
        write((byte) (value >>> 28));
        return 5;
    }
    ...
    private void writeString_slow(String value, int charCount, int charIndex) throws IOException {
        while (charIndex < charCount) {
            ...
            if (c <= 127) {
                ...
                write((byte) (((c >> 6) & 63) | Cast.MAX_NAMESPACE_LENGTH));
                write((byte) ((c & 63) | Cast.MAX_NAMESPACE_LENGTH));
            } else {
