...
class TimSort<T> {
    ...
    private T[] f89a;
    private Comparator<? super T> f90c;
    ...
    private void mergeAt(int i) {
        ...
        this.stackSize--;
        int k = gallopRight(this.f89a[base2], this.f89a, base1, len1, 0, this.f90c);
        base1 += k;
        len1 -= k;
        if (len1 != 0) {
            len2 = gallopLeft(this.f89a[(base1 + len1) - 1], this.f89a, base2, len2, len2 - 1, this.f90c);
            if (len2 == 0) {
                return;
            }
            if (len1 <= len2) {
    ...
    private T[] ensureCapacity(int minCapacity) {
        ...
        if (this.tmp.length < minCapacity) {
            ...
            if (newSize < 0) {
                ...
                newSize = Math.min(newSize, this.f89a.length >>> 1);
            }
