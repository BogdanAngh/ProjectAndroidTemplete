...
public class Encoder {
    ...
    class LiteralEncoder {
        ...
        class Encoder2 {
            ...
            Encoder2() {
                this.m_Encoders = new short[GL20.GL_SRC_COLOR];
            }
    ...
    static {
        g_FastPos = new byte[GL10.GL_EXP];
        int c = 2;
    ...
    static int GetPosSlot2(int pos) {
        if (pos < MetadataChangeSet.INDEXABLE_TEXT_SIZE_LIMIT_BYTES) {
    ...
    public Encoder() {
        ...
        this._posSlotPrices = new int[GL20.GL_DEPTH_BUFFER_BIT];
        this._distancesPrices = new int[GL20.GL_NEVER];
        ...
        this.tempPrices = new int[Cast.MAX_NAMESPACE_LENGTH];
    ...
    int GetPosLenPrice(int pos, int len, int posState) {
        ...
        if (pos < Cast.MAX_NAMESPACE_LENGTH) {
            price = this._distancesPrices[(lenToPosState * Cast.MAX_NAMESPACE_LENGTH) + pos];
        } else {
        ...
        if (!this._finished) {
            ...
            while (true) {
                ...
                if (this._additionalOffset == 0) {
                    ...
                    if (this.nowPos64 - progressPosValuePrev >= 4096) {
    ...
    void FillDistancesPrices() {
        int i;
        for (i = 4; i < Cast.MAX_NAMESPACE_LENGTH; i += EMatchFinderTypeBT4) {
    ...
    public boolean SetDictionarySize(int dictionarySize) {
        if (dictionarySize < EMatchFinderTypeBT4 || dictionarySize > DriveFile.MODE_WRITE_ONLY) {
            return false;
        }
