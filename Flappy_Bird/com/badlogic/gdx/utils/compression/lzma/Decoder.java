...
public class Decoder {
    ...
    class LiteralDecoder {
        ...
        class Decoder2 {
            ...
            Decoder2() {
                this.m_Decoders = new short[GL20.GL_SRC_COLOR];
            }
            ...
            public byte DecodeNormal(com.badlogic.gdx.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException {
                ...
                } while (symbol < GL20.GL_DEPTH_BUFFER_BIT);
                return (byte) symbol;
            }
    ...
    boolean SetDictionarySize(int dictionarySize) {
        ...
        this.m_OutWindow.Create(Math.max(this.m_DictionarySizeCheck, Connections.MAX_RELIABLE_MESSAGE_LEN));
        return true;
    }
