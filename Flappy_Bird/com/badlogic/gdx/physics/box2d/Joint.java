...
public abstract class Joint {
    ...
    public Vector2 getAnchorA() {
        ...
        this.anchorA.f100x = this.tmp[0];
        this.anchorA.f101y = this.tmp[1];
        return this.anchorA;
    }

    public Vector2 getAnchorB() {
        jniGetAnchorB(this.addr, this.tmp);
        this.anchorB.f100x = this.tmp[0];
        this.anchorB.f101y = this.tmp[1];
        return this.anchorB;
    }

    public Vector2 getReactionForce(float inv_dt) {
        jniGetReactionForce(this.addr, inv_dt, this.tmp);
        this.reactionForce.f100x = this.tmp[0];
        this.reactionForce.f101y = this.tmp[1];
