    ...
    public static void showActivityResultError(Activity activity, int requestCode, int actResp, int errorDescription) {
        ...
        switch (actResp) {
            case GamesActivityResultCodes.RESULT_SIGN_IN_FAILED /*10002*/:
                errorDialog = makeSimpleDialog(activity, activity.getString(C0326R.string.sign_in_failed));
                break;
            case GamesActivityResultCodes.RESULT_LICENSE_FAILED /*10003*/:
                errorDialog = makeSimpleDialog(activity, activity.getString(C0326R.string.license_failed));
                break;
            case GamesActivityResultCodes.RESULT_APP_MISCONFIGURED /*10004*/:
                errorDialog = makeSimpleDialog(activity, activity.getString(C0326R.string.app_misconfigured));
                break;
            default:
