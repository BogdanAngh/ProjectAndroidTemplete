...
public class DataReadRequest implements SafeParcelable {
    ...
    public static class Builder {
        ...
        private List<DataType> zzalU;
        private List<DataSource> zzalV;
        private long zzalW;
        private DataSource zzalX;
        private int zzalY;
        private boolean zzalZ;
        private boolean zzama;
        private List<Device> zzamc;
    ...
    public DataReadRequest(DataReadRequest request, zzmf callback, String packageName) {
        zzmf com_google_android_gms_internal_zzmf = callback;
        String str = packageName;
        this(request.zzajQ, request.zzalP, request.zzKT, request.zzajH, request.zzalU, request.zzalV, request.zzajT, request.zzalW, request.zzalX, request.zzalY, request.zzalZ, request.zzama, com_google_android_gms_internal_zzmf, str, request.zzamc);
    }
