...
public class Session implements SafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder setDescription(String description) {
            zzu.zzb(description.length() <= GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE, "Session description cannot exceed %d characters", Integer.valueOf(GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE));
