...
public final class Application implements SafeParcelable {
    ...
    static {
        zzajM = new Application(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, String.valueOf(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE), null);
        CREATOR = new zza();
    }
    ...
    public static Application zze(String str, String str2, String str3) {
        return GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE.equals(str) ? zzajM : new Application(str, str2, str3);
    }
