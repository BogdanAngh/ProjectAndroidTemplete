...
public final class PublisherAdRequest {
    ...
    public static final class Builder {
        ...
        public Builder setContentUrl(String contentUrl) {
            ...
            boolean z = contentUrl.length() <= GL20.GL_NEVER;
            Object[] objArr = new Object[PublisherAdRequest.GENDER_FEMALE];
            objArr[PublisherAdRequest.ERROR_CODE_INTERNAL_ERROR] = Integer.valueOf(GL20.GL_NEVER);
            objArr[PublisherAdRequest.GENDER_MALE] = Integer.valueOf(contentUrl.length());
            zzu.zzb(z, "Content URL must not exceed %d in length.  Provided length was %d.", objArr);
