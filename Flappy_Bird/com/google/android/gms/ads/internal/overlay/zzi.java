...
public class zzi extends SurfaceView implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, Callback {
    private static final Map<Integer, String> zzzU;
    private int zzAa;
    private int zzAb;
    private int zzAc;
    private int zzAd;
    ...
    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.1 */
    class C00781 implements Runnable {
        final /* synthetic */ MediaPlayer zzAk;
        final /* synthetic */ zzi zzAl;

        C00781(zzi com_google_android_gms_ads_internal_overlay_zzi, MediaPlayer mediaPlayer) {
        ...
        public void run() {
            if (this.zzAl.zzAj != null) {
                this.zzAl.zzAj.onPrepared(this.zzAk);
            }
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.2 */
    class C00792 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C00792(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.3 */
    class C00803 implements Runnable {
        final /* synthetic */ zzi zzAl;
        final /* synthetic */ String zzAm;
        final /* synthetic */ String zzAn;

        C00803(zzi com_google_android_gms_ads_internal_overlay_zzi, String str, String str2) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
            this.zzAm = str;
            this.zzAn = str2;
        }
        ...
        public void run() {
            if (this.zzAl.zzAj != null) {
                this.zzAl.zzAj.zzg(this.zzAm, this.zzAn);
            }
        }
    }

    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.4 */
    class C00814 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C00814(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.5 */
    class C00825 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C00825(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.6 */
    class C00836 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C00836(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    /* renamed from: com.google.android.gms.ads.internal.overlay.zzi.7 */
    class C00847 implements Runnable {
        final /* synthetic */ zzi zzAl;

        C00847(zzi com_google_android_gms_ads_internal_overlay_zzi) {
            this.zzAl = com_google_android_gms_ads_internal_overlay_zzi;
        }
    ...
    public zzi(Context context) {
        ...
        this.zzzV = 0;
        this.zzzW = 0;
        this.zzAf = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        this.zzzV = 5;
        this.zzzW = 5;
        zzhl.zzGk.post(new C00792(this));
    }

    public boolean onError(MediaPlayer mp, int what, int extra) {
        String str = (String) zzzU.get(Integer.valueOf(what));
        String str2 = (String) zzzU.get(Integer.valueOf(extra));
        zzb.zzaC("AdVideoView MediaPlayer error: " + str + ":" + str2);
        this.zzzV = -1;
        this.zzzW = -1;
        zzhl.zzGk.post(new C00803(this, str, str2));
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        ...
        this.zzzV = 2;
        zzhl.zzGk.post(new C00781(this, mediaPlayer));
    ...
    public void pause() {
        ...
        if (zzeT() && this.zzzY.isPlaying()) {
            this.zzzY.pause();
            this.zzzV = 4;
            zzhl.zzGk.post(new C00847(this));
        }
        this.zzzW = 4;
    }
    ...
    public void play() {
        ...
        if (zzeT()) {
            this.zzzY.start();
            this.zzzV = 3;
            zzhl.zzGk.post(new C00836(this));
        }
        this.zzzW = 3;
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        this.zzzX = holder;
        zzeP();
        zzhl.zzGk.post(new C00814(this));
    }
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        this.zzzX = null;
        zzhl.zzGk.post(new C00825(this));
        zzv(true);
    }
