...
public final class zzc {
    ...
    static class C03861 implements zzb {
        ...
        public boolean zzd(AdRequestInfoParcel adRequestInfoParcel) {
            return adRequestInfoParcel.zzpJ.zzGJ || GooglePlayServicesUtil.zzae(this.zzqV);
        }
    }

    public static zzhh zza(Context context, AdRequestInfoParcel adRequestInfoParcel, zza com_google_android_gms_ads_internal_request_zzc_zza) {
        return zza(context, adRequestInfoParcel, com_google_android_gms_ads_internal_request_zzc_zza, new C03861(context));
    }
