...
public final class zzj {
    ...
    public zzj(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0074R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C0074R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C0074R.styleable.AdsAttrs_adSizes);
        ...
        this.zzoL = obtainAttributes.getString(C0074R.styleable.AdsAttrs_adUnitId);
