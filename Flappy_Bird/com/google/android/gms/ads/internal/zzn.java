...
public class zzn {
    ...
    class C00991 implements Runnable {
        ...
        C00991(zzn com_google_android_gms_ads_internal_zzn, WeakReference weakReference) {
            this.zzpm = com_google_android_gms_ads_internal_zzn;
    ...
    zzn(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzn_zza) {
        ...
        this.zzx = new C00991(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
