...
public class GoogleCloudMessaging {
    ...
    private final BlockingQueue<Intent> zzavW;
    ...
    class C01711 extends Handler {
        ...
        C01711(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
            this.zzavY = googleCloudMessaging;
            super(looper);
        }
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzavX = new Messenger(new C01711(this, Looper.getMainLooper()));
    }
