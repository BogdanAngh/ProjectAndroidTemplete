...
public abstract class GcmListenerService extends Service {
    ...
    class C01691 implements Runnable {
        ...
        C01691(GcmListenerService gcmListenerService, Intent intent) {
            this.zzavD = gcmListenerService;
            this.val$intent = intent;
        }

        public void run() {
            this.zzavD.zzk(this.val$intent);
        }
    }

    /* renamed from: com.google.android.gms.gcm.GcmListenerService.2 */
    class C01702 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzavD;

        C01702(GcmListenerService gcmListenerService, Intent intent) {
            this.zzavD = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    public final int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C01691(this, intent));
        } else {
            new C01702(this, intent).execute(new Void[0]);
        }
        return 3;
    }
