...
public class zzh extends zzi<zzf> implements zzps {
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzd.zza {
        ...
        /* renamed from: com.google.android.gms.signin.internal.zzh.zza.1 */
        class C02841 implements Runnable {
            final /* synthetic */ List zzaKc;
            final /* synthetic */ String zzaKd;
            final /* synthetic */ zzf zzaKe;
            final /* synthetic */ zza zzaKf;

            C02841(zza com_google_android_gms_signin_internal_zzh_zza, List list, String str, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaKf = com_google_android_gms_signin_internal_zzh_zza;
                this.zzaKc = list;
                this.zzaKd = str;
                this.zzaKe = com_google_android_gms_signin_internal_zzf;
            }

            public void run() {
                try {
                    CheckResult onCheckServerAuthorization = this.zzaKf.zzyb().onCheckServerAuthorization(this.zzaKd, Collections.unmodifiableSet(new HashSet(this.zzaKc)));
        ...
        /* renamed from: com.google.android.gms.signin.internal.zzh.zza.2 */
        class C02852 implements Runnable {
            final /* synthetic */ String zzaKd;
            final /* synthetic */ zzf zzaKe;
            final /* synthetic */ zza zzaKf;
            final /* synthetic */ String zzaKg;

            C02852(zza com_google_android_gms_signin_internal_zzh_zza, String str, String str2, zzf com_google_android_gms_signin_internal_zzf) {
                this.zzaKf = com_google_android_gms_signin_internal_zzh_zza;
                this.zzaKd = str;
                this.zzaKg = str2;
                this.zzaKe = com_google_android_gms_signin_internal_zzf;
            ...
            public void run() {
                try {
                    this.zzaKe.zzal(this.zzaKf.zzyb().onUploadServerAuthCode(this.zzaKd, this.zzaKg));
                } catch (Throwable e) {
        ...
        public void zza(String str, String str2, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaKb.submit(new C02852(this, str, str2, com_google_android_gms_signin_internal_zzf));
        }

        public void zza(String str, List<Scope> list, zzf com_google_android_gms_signin_internal_zzf) throws RemoteException {
            this.zzaKb.submit(new C02841(this, list, str, com_google_android_gms_signin_internal_zzf));
        }
    }
