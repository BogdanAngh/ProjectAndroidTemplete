...
public class zzdg extends zzdd {
    ...
    private static final List<String> zzaOL;
    ...
    static {
        ...
        zzaOC = zzae.ACCOUNT.toString();
        zzaOD = zzae.ANALYTICS_PASS_THROUGH.toString();
        zzaOE = zzae.ENABLE_ECOMMERCE.toString();
        zzaOF = zzae.ECOMMERCE_USE_DATA_LAYER.toString();
        zzaOG = zzae.ECOMMERCE_MACRO_DATA.toString();
        zzaOH = zzae.ANALYTICS_FIELDS.toString();
        zzaOI = zzae.TRACK_TRANSACTION.toString();
        zzaOJ = zzae.TRANSACTION_DATALAYER_MAP.toString();
        zzaOK = zzae.TRANSACTION_ITEM_DATALAYER_MAP.toString();
        zzaOL = Arrays.asList(new String[]{ProductAction.ACTION_DETAIL, ProductAction.ACTION_CHECKOUT, ProductAction.ACTION_CHECKOUT_OPTION, Promotion.ACTION_CLICK, ProductAction.ACTION_ADD, ProductAction.ACTION_REMOVE, ProductAction.ACTION_PURCHASE, ProductAction.ACTION_REFUND});
        zzaOM = Pattern.compile("dimension(\\d+)");
        zzaON = Pattern.compile("metric(\\d+)");
    }
