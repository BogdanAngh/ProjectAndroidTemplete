...
class zzcp {
    private static final zzbw<com.google.android.gms.internal.zzag.zza> zzaNe;
    ...
    private static class zzc {
        private final Map<zze, List<String>> zzaNA;
        private com.google.android.gms.internal.zzqf.zza zzaNB;
        private final Set<zze> zzaNm;
        private final Map<zze, List<com.google.android.gms.internal.zzqf.zza>> zzaNx;
        private final Map<zze, List<com.google.android.gms.internal.zzqf.zza>> zzaNy;
        private final Map<zze, List<String>> zzaNz;
    ...
    class C05241 implements com.google.android.gms.tagmanager.zzm.zza<com.google.android.gms.internal.zzqf.zza, zzbw<com.google.android.gms.internal.zzag.zza>> {
        final /* synthetic */ zzcp zzaNq;

        C05241(zzcp com_google_android_gms_tagmanager_zzcp) {
    ...
    class C05252 implements com.google.android.gms.tagmanager.zzm.zza<String, zzb> {
        final /* synthetic */ zzcp zzaNq;

        C05252(zzcp com_google_android_gms_tagmanager_zzcp) {
            this.zzaNq = com_google_android_gms_tagmanager_zzcp;
        }
    ...
    class C05263 implements zza {
        final /* synthetic */ zzcp zzaNq;
        final /* synthetic */ Map zzaNr;
        final /* synthetic */ Map zzaNs;
        final /* synthetic */ Map zzaNt;
        final /* synthetic */ Map zzaNu;

        C05263(zzcp com_google_android_gms_tagmanager_zzcp, Map map, Map map2, Map map3, Map map4) {
            this.zzaNq = com_google_android_gms_tagmanager_zzcp;
            this.zzaNr = map;
            this.zzaNs = map2;
            this.zzaNt = map3;
        ...
        public void zza(zze com_google_android_gms_internal_zzqf_zze, Set<com.google.android.gms.internal.zzqf.zza> set, Set<com.google.android.gms.internal.zzqf.zza> set2, zzck com_google_android_gms_tagmanager_zzck) {
            List list = (List) this.zzaNr.get(com_google_android_gms_internal_zzqf_zze);
            List list2 = (List) this.zzaNs.get(com_google_android_gms_internal_zzqf_zze);
            if (list != null) {
                set.addAll(list);
                com_google_android_gms_tagmanager_zzck.zzyU().zzc(list, list2);
            }
            list = (List) this.zzaNt.get(com_google_android_gms_internal_zzqf_zze);
            list2 = (List) this.zzaNu.get(com_google_android_gms_internal_zzqf_zze);
            if (list != null) {
                set2.addAll(list);
    ...
    class C05274 implements zza {
        final /* synthetic */ zzcp zzaNq;

        C05274(zzcp com_google_android_gms_tagmanager_zzcp) {
            this.zzaNq = com_google_android_gms_tagmanager_zzcp;
        }
    ...
    public zzcp(Context context, com.google.android.gms.internal.zzqf.zzc com_google_android_gms_internal_zzqf_zzc, DataLayer dataLayer, com.google.android.gms.tagmanager.zzt.zza com_google_android_gms_tagmanager_zzt_zza, com.google.android.gms.tagmanager.zzt.zza com_google_android_gms_tagmanager_zzt_zza2, zzah com_google_android_gms_tagmanager_zzah) {
        ...
        this.zzaNk = new zzm().zza(AccessibilityEventCompat.TYPE_TOUCH_INTERACTION_START, new C05241(this));
        this.zzaNl = new zzm().zza(AccessibilityEventCompat.TYPE_TOUCH_INTERACTION_START, new C05252(this));
    ...
    zzbw<Set<com.google.android.gms.internal.zzqf.zza>> zza(String str, Set<zze> set, Map<zze, List<com.google.android.gms.internal.zzqf.zza>> map, Map<zze, List<String>> map2, Map<zze, List<com.google.android.gms.internal.zzqf.zza>> map3, Map<zze, List<String>> map4, Set<String> set2, zzco com_google_android_gms_tagmanager_zzco) {
        return zza((Set) set, (Set) set2, new C05263(this, map, map2, map3, map4), com_google_android_gms_tagmanager_zzco);
    }

    zzbw<Set<com.google.android.gms.internal.zzqf.zza>> zza(Set<zze> set, zzco com_google_android_gms_tagmanager_zzco) {
        return zza((Set) set, new HashSet(), new C05274(this), com_google_android_gms_tagmanager_zzco);
    }
