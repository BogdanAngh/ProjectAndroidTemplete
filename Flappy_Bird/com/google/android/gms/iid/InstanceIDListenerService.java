...
public class InstanceIDListenerService extends Service {
    ...
    class C01771 extends Handler {
        final /* synthetic */ InstanceIDListenerService zzawZ;

        C01771(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C01782 extends BroadcastReceiver {
        ...
        C01782(InstanceIDListenerService instanceIDListenerService) {
            this.zzawZ = instanceIDListenerService;
        }
    ...
    static {
        ACTION = "action";
        zzavK = "google.com/iid";
        zzawW = "CMD";
    }

    public InstanceIDListenerService() {
        this.zzawU = new MessengerCompat(new C01771(this, Looper.getMainLooper()));
        this.zzawV = new C01782(this);
    }
