...
public final class WalletFragmentOptions implements SafeParcelable {
    ...
    public static WalletFragmentOptions zza(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0074R.styleable.WalletFragmentOptions);
        int i = obtainStyledAttributes.getInt(C0074R.styleable.WalletFragmentOptions_appTheme, 0);
        int i2 = obtainStyledAttributes.getInt(C0074R.styleable.WalletFragmentOptions_environment, 1);
        int resourceId = obtainStyledAttributes.getResourceId(C0074R.styleable.WalletFragmentOptions_fragmentStyle, 0);
        int i3 = obtainStyledAttributes.getInt(C0074R.styleable.WalletFragmentOptions_fragmentMode, 1);
