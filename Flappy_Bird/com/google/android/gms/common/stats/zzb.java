...
public class zzb {
    ...
    static {
        zzaaJ = new Object();
        zzacp = new ComponentName(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, "com.google.android.gms.common.stats.GmsCoreStatsService");
    }
    ...
    private zzb() {
        ...
        this.zzacq = new zze(Place.TYPE_SUBLOCALITY_LEVEL_2, ((Long) zza.zzacy.get()).longValue());
    }
    ...
    private boolean zza(Context context, Intent intent) {
        ...
        return (component == null || (zzd.zzZR && GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE.equals(component.getPackageName()))) ? false : zzla.zzi(context, component.getPackageName());
    }
    ...
    private static ServiceInfo zzb(Context context, Intent intent) {
        List queryIntentServices = context.getPackageManager().queryIntentServices(intent, Cast.MAX_NAMESPACE_LENGTH);
