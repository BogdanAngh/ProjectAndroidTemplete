...
final class zzg implements GoogleApiClient {
    ...
    final Map<ClientKey<?>, Client> zzXu;
    final Map<ClientKey<?>, ConnectionResult> zzXv;
    Set<Scope> zzXw;
    ...
    class C04101 implements zzc {
        final /* synthetic */ zzg zzXE;

        C04101(zzg com_google_android_gms_common_api_zzg) {
            this.zzXE = com_google_android_gms_common_api_zzg;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.zzg.3 */
    class C04113 implements com.google.android.gms.common.internal.zzj.zza {
        final /* synthetic */ zzg zzXE;

        C04113(zzg com_google_android_gms_common_api_zzg) {
            this.zzXE = com_google_android_gms_common_api_zzg;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.zzg.4 */
    class C04124 implements OnConnectionFailedListener {
        final /* synthetic */ zzg zzXE;
        final /* synthetic */ Api zzXF;
        final /* synthetic */ int zzXG;

        C04124(zzg com_google_android_gms_common_api_zzg, Api api, int i) {
            this.zzXE = com_google_android_gms_common_api_zzg;
            this.zzXF = api;
            this.zzXG = i;
        }
        ...
        public void onConnectionFailed(ConnectionResult result) {
            this.zzXE.zzXx.zza(result, this.zzXF, this.zzXG);
        }
    }

    /* renamed from: com.google.android.gms.common.api.zzg.5 */
    class C04135 implements ConnectionCallbacks {
        final /* synthetic */ zzg zzXE;
        final /* synthetic */ AtomicReference zzXH;
        final /* synthetic */ zzl zzXI;

        C04135(zzg com_google_android_gms_common_api_zzg, AtomicReference atomicReference, zzl com_google_android_gms_common_api_zzl) {
            this.zzXE = com_google_android_gms_common_api_zzg;
            this.zzXH = atomicReference;
            this.zzXI = com_google_android_gms_common_api_zzl;
        }

        public void onConnected(Bundle connectionHint) {
            this.zzXE.zza((GoogleApiClient) this.zzXH.get(), this.zzXI, true);
        }
    ...
    /* renamed from: com.google.android.gms.common.api.zzg.6 */
    class C04146 implements OnConnectionFailedListener {
        final /* synthetic */ zzg zzXE;
        final /* synthetic */ zzl zzXI;

        C04146(zzg com_google_android_gms_common_api_zzg, zzl com_google_android_gms_common_api_zzl) {
            this.zzXE = com_google_android_gms_common_api_zzg;
            this.zzXI = com_google_android_gms_common_api_zzl;
        }
    ...
    /* renamed from: com.google.android.gms.common.api.zzg.7 */
    class C04157 implements ResultCallback<Status> {
        final /* synthetic */ GoogleApiClient zzSA;
        final /* synthetic */ zzg zzXE;
        final /* synthetic */ zzl zzXI;
        final /* synthetic */ boolean zzXJ;

        C04157(zzg com_google_android_gms_common_api_zzg, zzl com_google_android_gms_common_api_zzl, boolean z, GoogleApiClient googleApiClient) {
            this.zzXE = com_google_android_gms_common_api_zzg;
            this.zzXI = com_google_android_gms_common_api_zzl;
            this.zzXJ = z;
    ...
    /* renamed from: com.google.android.gms.common.api.zzg.2 */
    class C06072 extends zzd {
        final /* synthetic */ zzg zzXE;

        C06072(zzg com_google_android_gms_common_api_zzg) {
            this.zzXE = com_google_android_gms_common_api_zzg;
    ...
    public zzg(Context context, Looper looper, com.google.android.gms.common.internal.zze com_google_android_gms_common_internal_zze, com.google.android.gms.common.api.Api.zza<? extends zzps, zzpt> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzps__com_google_android_gms_internal_zzpt, Map<Api<?>, ApiOptions> map, Set<ConnectionCallbacks> set, Set<OnConnectionFailedListener> set2, int i, int i2) {
        ...
        this.zzXB = new C04101(this);
        this.zzXC = new C06072(this);
        this.zzXD = new C04113(this);
    ...
    private void zza(GoogleApiClient googleApiClient, zzl com_google_android_gms_common_api_zzl, boolean z) {
        zzkl.zzabj.zzc(googleApiClient).setResultCallback(new C04157(this, com_google_android_gms_common_api_zzl, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        zzl com_google_android_gms_common_api_zzl = new zzl(this.zzWt);
        if (this.zzXu.containsKey(zzkl.zzNX)) {
            zza(this, com_google_android_gms_common_api_zzl, false);
        } else {
            AtomicReference atomicReference = new AtomicReference();
            ConnectionCallbacks c04135 = new C04135(this, atomicReference, com_google_android_gms_common_api_zzl);
            GoogleApiClient build = new Builder(this.mContext).addApi(zzkl.API).addConnectionCallbacks(c04135).addOnConnectionFailedListener(new C04146(this, com_google_android_gms_common_api_zzl)).setHandler(this.zzXs).build();
