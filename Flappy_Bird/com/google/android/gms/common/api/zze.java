...
public class zze implements zzh {
    ...
    private final Set<ClientKey> zzWS;
    private zzps zzWT;
    private int zzWU;
    ...
    /* renamed from: com.google.android.gms.common.api.zze.1 */
    class C01351 implements Runnable {
        final /* synthetic */ ConnectionResult zzXc;
        final /* synthetic */ zze zzXd;

        C01351(zze com_google_android_gms_common_api_zze, ConnectionResult connectionResult) {
    ...
    private static class zzb extends com.google.android.gms.common.internal.zzq.zza {
        ...
        /* renamed from: com.google.android.gms.common.api.zze.zzb.1 */
        class C01371 implements Runnable {
            final /* synthetic */ zze zzXf;
            final /* synthetic */ ResolveAccountResponse zzXi;
            final /* synthetic */ zzb zzXj;

            C01371(zzb com_google_android_gms_common_api_zze_zzb, zze com_google_android_gms_common_api_zze, ResolveAccountResponse resolveAccountResponse) {
                this.zzXj = com_google_android_gms_common_api_zze_zzb;
                this.zzXf = com_google_android_gms_common_api_zze;
                this.zzXi = resolveAccountResponse;
            }

            public void run() {
                this.zzXf.zza(this.zzXi);
            }
        }
        ...
        public void zzb(ResolveAccountResponse resolveAccountResponse) {
            zze com_google_android_gms_common_api_zze = (zze) this.zzXe.get();
            if (com_google_android_gms_common_api_zze != null) {
                com_google_android_gms_common_api_zze.zzWK.zzXs.post(new C01371(this, com_google_android_gms_common_api_zze, resolveAccountResponse));
            }
        }
    }
    ...
    private static class zza extends com.google.android.gms.signin.internal.zzb {
        ...
        /* renamed from: com.google.android.gms.common.api.zze.zza.1 */
        class C01361 implements Runnable {
            final /* synthetic */ zze zzXf;
            final /* synthetic */ ConnectionResult zzXg;
            final /* synthetic */ zza zzXh;

            C01361(zza com_google_android_gms_common_api_zze_zza, zze com_google_android_gms_common_api_zze, ConnectionResult connectionResult) {
                this.zzXh = com_google_android_gms_common_api_zze_zza;
                this.zzXf = com_google_android_gms_common_api_zze;
                this.zzXg = connectionResult;
            }

            public void run() {
                this.zzXf.zza(this.zzXg);
            }
        }
        ...
        public void zza(ConnectionResult connectionResult, AuthAccountResult authAccountResult) {
            zze com_google_android_gms_common_api_zze = (zze) this.zzXe.get();
            if (com_google_android_gms_common_api_zze != null) {
                com_google_android_gms_common_api_zze.zzWK.zzXs.post(new C01361(this, com_google_android_gms_common_api_zze, connectionResult));
            }
        }
    }
    ...
    public void begin() {
        ...
        if (isGooglePlayServicesAvailable != 0) {
            this.zzWK.zzXs.post(new C01351(this, new ConnectionResult(isGooglePlayServicesAvailable, null)));
            return;
        }
