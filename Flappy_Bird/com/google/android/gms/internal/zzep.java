...
public class zzep extends zzeu {
    ...
    /* renamed from: com.google.android.gms.internal.zzep.1 */
    class C02231 implements OnClickListener {
        final /* synthetic */ zzep zzyI;

        C02231(zzep com_google_android_gms_internal_zzep) {
    ...
    static {
        zzyu = new HashSet(Arrays.asList(new String[]{"top-left", "top-right", "top-center", "center", "bottom-left", "bottom-right", "bottom-center"}));
    }
