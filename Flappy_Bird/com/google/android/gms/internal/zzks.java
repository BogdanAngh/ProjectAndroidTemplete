...
public class zzks<K, V> extends zzkw<K, V> implements Map<K, V> {
    ...
    /* renamed from: com.google.android.gms.internal.zzks.1 */
    class C04881 extends zzkv<K, V> {
        final /* synthetic */ zzks zzabm;

        C04881(zzks com_google_android_gms_internal_zzks) {
