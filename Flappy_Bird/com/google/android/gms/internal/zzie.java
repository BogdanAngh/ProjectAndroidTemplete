...
public class zzie extends WebViewClient {
    ...
    class C02521 implements Runnable {
        ...
        C02521(zzie com_google_android_gms_internal_zzie, com.google.android.gms.ads.internal.overlay.zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzHm = com_google_android_gms_internal_zzie;
            this.zzHl = com_google_android_gms_ads_internal_overlay_zzc;
        }
        ...
        synchronized (this.zzqt) {
            ...
            if (zzgD != null) {
                if (com.google.android.gms.ads.internal.client.zzk.zzcA().zzgw()) {
                    ...
                    zzhl.zzGk.post(new C02521(this, zzgD));
                }
            }
        }
    }
