...
public final class zziv implements zzk, AppIndexApi {
    ...
    class C10171 extends zzc<Status> {
        final /* synthetic */ String zzNP;
        final /* synthetic */ UsageInfo[] zzNQ;
        final /* synthetic */ zziv zzNR;

        C10171(zziv com_google_android_gms_internal_zziv, GoogleApiClient googleApiClient, String str, UsageInfo[] usageInfoArr) {
            this.zzNR = com_google_android_gms_internal_zziv;
            this.zzNP = str;
            this.zzNQ = usageInfoArr;
            super(googleApiClient);
        }

        protected void zza(zziq com_google_android_gms_internal_zziq) throws RemoteException {
            com_google_android_gms_internal_zziq.zza(new zzd(this), this.zzNP, this.zzNQ);
        }
    }
    ...
    public PendingResult<Status> zza(GoogleApiClient googleApiClient, UsageInfo... usageInfoArr) {
        return googleApiClient.zza(new C10171(this, googleApiClient, googleApiClient.getContext().getPackageName(), usageInfoArr));
    }
}
