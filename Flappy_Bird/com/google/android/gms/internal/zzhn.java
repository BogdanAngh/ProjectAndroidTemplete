...
public class zzhn {
    ...
    class C02491 implements OnClickListener {
        final /* synthetic */ String zzGs;
        final /* synthetic */ zzhn zzGt;

        C02491(zzhn com_google_android_gms_internal_zzhn, String str) {
            this.zzGt = com_google_android_gms_internal_zzhn;
            this.zzGs = str;
        }

        public void onClick(DialogInterface dialog, int which) {
            this.zzGt.mContext.startActivity(Intent.createChooser(new Intent("android.intent.action.SEND").setType("text/plain").putExtra("android.intent.extra.TEXT", this.zzGs), "Share via"));
        }
    }
    ...
    class C02502 implements OnClickListener {
        ...
        C02502(zzhn com_google_android_gms_internal_zzhn) {
            this.zzGt = com_google_android_gms_internal_zzhn;
        }
    ...
    private void showDialog() {
        if (this.mContext instanceof Activity) {
            ...
            builder.setPositiveButton("Share", new C02491(this, obj));
            builder.setNegativeButton("Close", new C02502(this));
            builder.create().show();
            return;
        }
