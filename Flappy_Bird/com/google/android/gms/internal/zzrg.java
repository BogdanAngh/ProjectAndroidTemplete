...
public final class zzrg {
    ...
    private static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < '\u0080' && i5 < i4) {
                ...
                i6 = r6 + 1;
                bArr[r6] = (byte) ((charAt2 & 63) | Cast.MAX_NAMESPACE_LENGTH);
            } else if ((charAt2 < '\ud800' || '\udfff' < charAt2) && i5 <= i4 - 3) {
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 >>> 12) | 480);
                i5 = i6 + 1;
                bArr[i6] = (byte) (((charAt2 >>> 6) & 63) | Cast.MAX_NAMESPACE_LENGTH);
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 & 63) | Cast.MAX_NAMESPACE_LENGTH);
            } else if (i5 <= i4 - 4) {
                if (i3 + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt)) {
                        ...
                        i6 = i5 + 1;
                        bArr[i5] = (byte) ((toCodePoint >>> 18) | TweenCallback.ANY_BACKWARD);
                        i5 = i6 + 1;
                        bArr[i6] = (byte) (((toCodePoint >>> 12) & 63) | Cast.MAX_NAMESPACE_LENGTH);
                        r6 = i5 + 1;
                        bArr[i5] = (byte) (((toCodePoint >>> 6) & 63) | Cast.MAX_NAMESPACE_LENGTH);
                        i6 = r6 + 1;
                        bArr[r6] = (byte) ((toCodePoint & 63) | Cast.MAX_NAMESPACE_LENGTH);
                    }
                }
    ...
    private static void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (charAt < '\u0080') {
                ...
                byteBuffer.put((byte) ((charAt & 63) | Cast.MAX_NAMESPACE_LENGTH));
            } else if (charAt < '\ud800' || '\udfff' < charAt) {
                byteBuffer.put((byte) ((charAt >>> 12) | 480));
                byteBuffer.put((byte) (((charAt >>> 6) & 63) | Cast.MAX_NAMESPACE_LENGTH));
                byteBuffer.put((byte) ((charAt & 63) | Cast.MAX_NAMESPACE_LENGTH));
            } else {
                if (i + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        byteBuffer.put((byte) ((toCodePoint >>> 18) | TweenCallback.ANY_BACKWARD));
                        byteBuffer.put((byte) (((toCodePoint >>> 12) & 63) | Cast.MAX_NAMESPACE_LENGTH));
                        byteBuffer.put((byte) (((toCodePoint >>> 6) & 63) | Cast.MAX_NAMESPACE_LENGTH));
                        byteBuffer.put((byte) ((toCodePoint & 63) | Cast.MAX_NAMESPACE_LENGTH));
                    }
                }
    ...
    public void zzaa(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzkL((((int) j) & 127) | Cast.MAX_NAMESPACE_LENGTH);
            j >>>= 7;
        }
        zzkL((int) j);
    }
    ...
    public void zzac(long j) throws IOException {
        zzkL(((int) j) & Keys.F12);
        zzkL(((int) (j >> 8)) & Keys.F12);
        zzkL(((int) (j >> 16)) & Keys.F12);
        zzkL(((int) (j >> 24)) & Keys.F12);
        zzkL(((int) (j >> 32)) & Keys.F12);
        zzkL(((int) (j >> 40)) & Keys.F12);
        zzkL(((int) (j >> 48)) & Keys.F12);
        zzkL(((int) (j >> 56)) & Keys.F12);
    }
    ...
    public void zzkN(int i) throws IOException {
        while ((i & -128) != 0) {
            zzkL((i & 127) | Cast.MAX_NAMESPACE_LENGTH);
            i >>>= 7;
        }
        zzkL(i);
    }
