...
public class zzdh implements zzdg {
    ...
    class C01971 implements Runnable {
        ...
        class C01961 implements Runnable {
            final /* synthetic */ JSONObject zzwj;
            final /* synthetic */ C01971 zzwk;

            C01961(C01971 c01971, JSONObject jSONObject) {
                this.zzwk = c01971;
                this.zzwj = jSONObject;
            }

            public void run() {
                this.zzwk.zzwh.zzb("fetchHttpRequestCompleted", this.zzwj);
                com.google.android.gms.ads.internal.util.client.zzb.zzay("Dispatched http response.");
            }
        }

        C01971(zzdh com_google_android_gms_internal_zzdh, Map map, zzid com_google_android_gms_internal_zzid) {
            this.zzwi = com_google_android_gms_internal_zzdh;
            this.zzwg = map;
            this.zzwh = com_google_android_gms_internal_zzid;
        }

        public void run() {
            com.google.android.gms.ads.internal.util.client.zzb.zzay("Received Http request.");
            JSONObject zzT = this.zzwi.zzT((String) this.zzwg.get("http_request"));
            if (zzT == null) {
                com.google.android.gms.ads.internal.util.client.zzb.zzaz("Response should not be null.");
            } else {
                zzhl.zzGk.post(new C01961(this, zzT));
            }
        }
    }
    ...
    public void zza(zzid com_google_android_gms_internal_zzid, Map<String, String> map) {
        zzhk.zza(new C01971(this, map, com_google_android_gms_internal_zzid));
    }
