...
public class zzka implements CastRemoteDisplayApi {
    ...
    class C08111 extends com.google.android.gms.internal.zzke.zza {
        final /* synthetic */ zzka zzVx;

        C08111(zzka com_google_android_gms_internal_zzka) {
    ...
    /* renamed from: com.google.android.gms.internal.zzka.2 */
    class C08602 extends zzb {
        final /* synthetic */ zzka zzVx;
        final /* synthetic */ String zzVy;

        C08602(zzka com_google_android_gms_internal_zzka, GoogleApiClient googleApiClient, String str) {
            this.zzVx = com_google_android_gms_internal_zzka;
            this.zzVy = str;
            super(com_google_android_gms_internal_zzka, googleApiClient);
        }

        protected void zza(zzkb com_google_android_gms_internal_zzkb) throws RemoteException {
            com_google_android_gms_internal_zzkb.zza(new zza(this, com_google_android_gms_internal_zzkb), this.zzVx.zzVw, this.zzVy);
        }
    }

    /* renamed from: com.google.android.gms.internal.zzka.3 */
    class C08613 extends zzb {
        final /* synthetic */ zzka zzVx;

        C08613(zzka com_google_android_gms_internal_zzka, GoogleApiClient googleApiClient) {
            this.zzVx = com_google_android_gms_internal_zzka;
            super(com_google_android_gms_internal_zzka, googleApiClient);
        }
    ...
    public PendingResult<CastRemoteDisplaySessionResult> startRemoteDisplay(GoogleApiClient apiClient, String appId) {
        ...
        return apiClient.zzb(new C08602(this, apiClient, appId));
    }
    ...
    public PendingResult<CastRemoteDisplaySessionResult> stopRemoteDisplay(GoogleApiClient apiClient) {
        ...
        return apiClient.zzb(new C08613(this, apiClient));
    }
}
