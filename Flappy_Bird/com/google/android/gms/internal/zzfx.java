...
public class zzfx extends zzhh {
    ...
    class C02331 implements Runnable {
        ...
        C02331(zzfx com_google_android_gms_internal_zzfx, zzha com_google_android_gms_internal_zzha) {
            this.zzBE = com_google_android_gms_internal_zzfx;
            this.zzpd = com_google_android_gms_internal_zzha;
        }

        public void run() {
            this.zzBE.zzBq.zzb(this.zzpd);
        }
    }
    ...
    public void zzdP() {
        ...
        zzhl.zzGk.post(new C02331(this, com_google_android_gms_internal_zzha));
    }
}
