...
public class zzc extends Thread {
    ...
    class C01941 implements Runnable {
        ...
        C01941(zzc com_google_android_gms_internal_zzc, zzk com_google_android_gms_internal_zzk) {
                ...
                if (com_google_android_gms_internal_zzk.isCanceled()) {
                    ...
                    if (zza == null) {
                        ...
                        if (zza.zzc()) {
                            ...
                            com_google_android_gms_internal_zzk.zza(zza);
                            zza2.zzai = true;
                            this.zzk.zza(com_google_android_gms_internal_zzk, zza2, new C01941(this, com_google_android_gms_internal_zzk));
                        } else {
