...
public final class MediaStatus {
    ...
    private class zza {
        ...
        zza(MediaStatus mediaStatus) {
            ...
            this.zzSm = MediaStatus.REPEAT_MODE_REPEAT_OFF;
    ...
    public MediaStatus(JSONObject json) throws JSONException {
        this.zzSa = REPEAT_MODE_REPEAT_OFF;
        this.zzSj = REPEAT_MODE_REPEAT_OFF;
        this.zzSk = REPEAT_MODE_REPEAT_OFF;
    ...
    public int zza(JSONObject jSONObject, int i) throws JSONException {
        ...
        if (jSONObject.has("volume") && (i & REPEAT_MODE_REPEAT_ALL) == 0) {
