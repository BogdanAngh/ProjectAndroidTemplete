...
public final class MediaTrack {
    ...
    private void clear() {
        this.zzOw = 0;
        this.zzSq = TYPE_UNKNOWN;
        this.zzRC = null;
        this.mName = null;
        this.zzRA = null;
        this.zzSr = SUBTYPE_UNKNOWN;
        this.zzRJ = null;
    }
    ...
    private void zzf(JSONObject jSONObject) throws JSONException {
        ...
        if ("TEXT".equals(string)) {
            ...
            this.zzSq = TYPE_AUDIO;
        } else if ("VIDEO".equals(string)) {
            this.zzSq = TYPE_VIDEO;
        } else {
        ...
        if (jSONObject.has("subtype")) {
            ...
            if ("SUBTITLES".equals(string)) {
                ...
                this.zzSr = TYPE_AUDIO;
            } else if ("DESCRIPTIONS".equals(string)) {
                this.zzSr = TYPE_VIDEO;
            } else if ("CHAPTERS".equals(string)) {
                this.zzSr = SUBTYPE_CHAPTERS;
            } else if ("METADATA".equals(string)) {
                this.zzSr = SUBTYPE_METADATA;
            } else {
                throw new JSONException("invalid subtype: " + string);
            }
        }
        this.zzSr = TYPE_UNKNOWN;
    ...
    public boolean equals(Object other) {
        ...
        if ((this.zzRJ == null ? TYPE_TEXT : false) != (mediaTrack.zzRJ == null ? TYPE_TEXT : false)) {
            return false;
        }
    ...
    void zzaG(int i) throws IllegalArgumentException {
        ...
        } else if (i == 0 || this.zzSq == TYPE_TEXT) {
            this.zzSr = i;
        } else {
