...
public final class zze extends zzi<zzi> {
    ...
    private final Map<String, MessageReceivedCallback> zzUn;
    ...
    private static class zzb extends com.google.android.gms.cast.internal.zzj.zza {
        ...
        class C01311 implements Runnable {
            ...
            C01311(zzb com_google_android_gms_cast_internal_zze_zzb, zze com_google_android_gms_cast_internal_zze, int i) {
                this.zzUL = com_google_android_gms_cast_internal_zze_zzb;
                this.zzUJ = com_google_android_gms_cast_internal_zze;
                this.zzUK = i;
            }

            public void run() {
                if (this.zzUJ.zzQI != null) {
                    this.zzUJ.zzQI.onApplicationDisconnected(this.zzUK);
                }
            }
        }
        ...
        class C01322 implements Runnable {
            final /* synthetic */ zze zzUJ;
            final /* synthetic */ zzb zzUL;
            final /* synthetic */ DeviceStatus zzUM;

            C01322(zzb com_google_android_gms_cast_internal_zze_zzb, zze com_google_android_gms_cast_internal_zze, DeviceStatus deviceStatus) {
                this.zzUL = com_google_android_gms_cast_internal_zze_zzb;
                this.zzUJ = com_google_android_gms_cast_internal_zze;
                this.zzUM = deviceStatus;
            }

            public void run() {
                this.zzUJ.zza(this.zzUM);
            }
        }
        ...
        class C01333 implements Runnable {
            final /* synthetic */ zze zzUJ;
            final /* synthetic */ zzb zzUL;
            final /* synthetic */ ApplicationStatus zzUN;

            C01333(zzb com_google_android_gms_cast_internal_zze_zzb, zze com_google_android_gms_cast_internal_zze, ApplicationStatus applicationStatus) {
                this.zzUL = com_google_android_gms_cast_internal_zze_zzb;
                this.zzUJ = com_google_android_gms_cast_internal_zze;
                this.zzUN = applicationStatus;
            }

            public void run() {
                this.zzUJ.zza(this.zzUN);
            }
        }

        /* renamed from: com.google.android.gms.cast.internal.zze.zzb.4 */
        class C01344 implements Runnable {
            final /* synthetic */ String zzQz;
            final /* synthetic */ zze zzUJ;
            final /* synthetic */ zzb zzUL;
            final /* synthetic */ String zzUO;

            C01344(zzb com_google_android_gms_cast_internal_zze_zzb, zze com_google_android_gms_cast_internal_zze, String str, String str2) {
                this.zzUL = com_google_android_gms_cast_internal_zze_zzb;
                this.zzUJ = com_google_android_gms_cast_internal_zze;
                this.zzQz = str;
                this.zzUO = str2;
            ...
            public void run() {
                synchronized (this.zzUJ.zzUn) {
                    MessageReceivedCallback messageReceivedCallback = (MessageReceivedCallback) this.zzUJ.zzUn.get(this.zzQz);
                }
                if (messageReceivedCallback != null) {
                    messageReceivedCallback.onMessageReceived(this.zzUJ.zzUm, this.zzQz, this.zzUO);
                    return;
                }
                zze.zzQW.zzb("Discarded message for unknown namespace '%s'", this.zzQz);
            }
        }
        ...
        public void onApplicationDisconnected(int statusCode) {
            ...
            if (com_google_android_gms_cast_internal_zze != null) {
                ...
                if (com_google_android_gms_cast_internal_zze.zzQI != null) {
                    this.mHandler.post(new C01311(this, com_google_android_gms_cast_internal_zze, statusCode));
                }
            }
        }
        ...
        public void zzb(ApplicationStatus applicationStatus) {
            ...
            if (com_google_android_gms_cast_internal_zze != null) {
                ...
                this.mHandler.post(new C01333(this, com_google_android_gms_cast_internal_zze, applicationStatus));
            }
        }
        ...
        public void zzb(DeviceStatus deviceStatus) {
            ...
            if (com_google_android_gms_cast_internal_zze != null) {
                ...
                this.mHandler.post(new C01322(this, com_google_android_gms_cast_internal_zze, deviceStatus));
            }
        }
        ...
        public void zzq(String str, String str2) {
            ...
            if (com_google_android_gms_cast_internal_zze != null) {
                ...
                this.mHandler.post(new C01344(this, com_google_android_gms_cast_internal_zze, str, str2));
            }
        }
    }
    ...
    private void zzc(com.google.android.gms.common.api.zza.zzb<ApplicationConnectionResult> com_google_android_gms_common_api_zza_zzb_com_google_android_gms_cast_Cast_ApplicationConnectionResult) {
        synchronized (zzUD) {
            if (this.zzUB != null) {
                this.zzUB.zzm(new zza(new Status(GamesStatusCodes.STATUS_REQUEST_TOO_MANY_RECIPIENTS)));
            }
    ...
    private void zze(com.google.android.gms.common.api.zza.zzb<Status> com_google_android_gms_common_api_zza_zzb_com_google_android_gms_common_api_Status) {
        synchronized (zzUE) {
            if (this.zzUC != null) {
                com_google_android_gms_common_api_zza_zzb_com_google_android_gms_common_api_Status.zzm(new Status(GamesStatusCodes.STATUS_REQUEST_UPDATE_TOTAL_FAILURE));
                return;
            }
