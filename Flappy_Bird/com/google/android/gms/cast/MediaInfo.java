...
public final class MediaInfo {
    ...
    MediaInfo(String contentId) throws IllegalArgumentException {
        ...
        this.zzRC = contentId;
        this.zzRD = STREAM_TYPE_INVALID;
        this.zzRG = UNKNOWN_DURATION;
    }
    ...
    MediaInfo(JSONObject json) throws JSONException {
        ...
        if ("NONE".equals(string)) {
            this.zzRD = STREAM_TYPE_NONE;
        } else if ("BUFFERED".equals(string)) {
            this.zzRD = STREAM_TYPE_BUFFERED;
        } else if ("LIVE".equals(string)) {
            this.zzRD = STREAM_TYPE_LIVE;
        } else {
            this.zzRD = STREAM_TYPE_INVALID;
        }
    ...
    public boolean equals(Object other) {
        ...
        if ((this.zzRJ == null ? STREAM_TYPE_BUFFERED : false) != (mediaInfo.zzRJ == null ? STREAM_TYPE_BUFFERED : false)) {
            return false;
        }
    ...
    void zzlq() throws IllegalArgumentException {
        if (TextUtils.isEmpty(this.zzRC)) {
            ...
            throw new IllegalArgumentException("content type cannot be null or empty");
        } else if (this.zzRD == STREAM_TYPE_INVALID) {
