...
public class ViewPager extends ViewGroup {
    ...
    static class C00171 implements Comparator<ItemInfo> {
        C00171() {
        }
    ...
    static class C00182 implements Interpolator {
        C00182() {
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.mAdapter != null && ViewPager.this.mCurItem >= 0 && ViewPager.this.mCurItem < ViewPager.this.mAdapter.getCount() + ViewPager.INVALID_POINTER) {
                info.addAction(Connections.MAX_RELIABLE_MESSAGE_LEN);
            }
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00193();
    ...
    private void calculatePageOffsets(ItemInfo curItem, int curIndex, ItemInfo oldCurInfo) {
        ...
        this.mLastOffset = curItem.position == N + INVALID_POINTER ? (curItem.offset + curItem.widthFactor) - TextTrackStyle.DEFAULT_FONT_SCALE : Float.MAX_VALUE;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        int action = ev.getAction() & Keys.F12;
