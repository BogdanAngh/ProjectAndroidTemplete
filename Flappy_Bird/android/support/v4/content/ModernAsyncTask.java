...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00071 implements ThreadFactory {
    ...
    class C00083 extends FutureTask<Result> {
        C00083(Callable x0) {
            super(x0);
        }
    ...
    class C03322 extends WorkerRunnable<Params, Result> {
        C03322() {
            super();
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C03322();
        this.mFuture = new C00083(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00094.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
