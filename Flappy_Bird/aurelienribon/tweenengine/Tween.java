...
public final class Tween extends BaseTween<Tween> {
    ...
    private static final Callback<Tween> poolCallback;
    ...
    /* renamed from: aurelienribon.tweenengine.Tween.1 */
    static class C03411 implements Callback<Tween> {
        C03411() {
        }
    ...
    /* renamed from: aurelienribon.tweenengine.Tween.2 */
    static class C03422 extends Pool<Tween> {
        C03422(int x0, Callback x1) {
            super(x0, x1);
        }
    ...
    static {
        ...
        waypointsLimit = 0;
        poolCallback = new C03411();
        pool = new C03422(20, poolCallback);
    ...
    public static Tween call(TweenCallback callback) {
        Tween tween = (Tween) pool.get();
        tween.setup(null, INFINITY, 0.0f);
    ...
    protected boolean containsTarget(Object target) {
        return this.target == target ? true : $assertionsDisabled;
    }

    protected boolean containsTarget(Object target, int tweenType) {
        return (this.target == target && this.type == tweenType) ? true : $assertionsDisabled;
    }
