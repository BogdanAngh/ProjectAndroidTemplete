...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C02601 implements OnGlobalLayoutListener {
        C02601() {
        }
    ...
    class C02622 implements MenuItemHoverListener {
        ...
        class C02611 implements Runnable {
            ...
            C02611(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C02611(nextInfo, item, menu), menu, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mGlobalLayoutListener = new C02601();
        this.mMenuItemHoverListener = new C02622();
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0248R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0248R.layout.abc_popup_menu_header_item_layout, listView, false);
