...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C02931 implements OnAttachStateChangeListener {
        C02931() {
        }
    ...
    class C02942 implements OnGlobalLayoutListener {
        boolean mIsAttached;
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C02931());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C02942());
    }
