...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        ...
        this.mShadowStartColor = resources.getColor(C0249R.color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0249R.color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0249R.dimen.cardview_compat_inset_shadow);
        this.mPaint = new Paint(5);
        setBackground(backgroundColor);
        this.mCornerShadowPaint = new Paint(5);
        this.mCornerShadowPaint.setStyle(Style.FILL);
        this.mCornerRadius = (float) ((int) (GenVectorModul.DEFAULT_DENSITY + radius));
    ...
    private int toEven(float value) {
        int i = (int) (GenVectorModul.DEFAULT_DENSITY + value);
        if (i % 2 == 1) {
            return i - 1;
        }
        return i;
    ...
    void setShadowSize(float shadowSize, float maxShadowSize) {
        if (shadowSize < 0.0f) {
            ...
            if (this.mRawShadowSize != shadowSize || this.mRawMaxShadowSize != maxShadowSize) {
                ...
                this.mShadowSize = (float) ((int) (((SHADOW_MULTIPLIER * shadowSize) + ((float) this.mInsetShadow)) + GenVectorModul.DEFAULT_DENSITY));
    ...
    void setCornerRadius(float radius) {
        ...
        radius = (float) ((int) (GenVectorModul.DEFAULT_DENSITY + radius));
    ...
    private void buildShadowCorners() {
        ...
        this.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, (-this.mCornerRadius) + this.mShadowSize, 0.0f, (-this.mCornerRadius) - this.mShadowSize, new int[]{this.mShadowStartColor, this.mShadowStartColor, this.mShadowEndColor}, new float[]{0.0f, GenVectorModul.DEFAULT_DENSITY, 1.0f}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
