...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs) {
        this(context, attrs, C0248R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0248R.styleable.ActionMode, defStyle, 0);
        ViewCompat.setBackground(this, a.getDrawable(C0248R.styleable.ActionMode_background));
        this.mTitleStyleRes = a.getResourceId(C0248R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = a.getResourceId(C0248R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = a.getLayoutDimension(C0248R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = a.getResourceId(C0248R.styleable.ActionMode_closeItemLayout, C0248R.layout.abc_action_mode_close_item_material);
        a.recycle();
    }
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0248R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0248R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0248R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0248R.id.action_mode_close_button).setOnClickListener(new C02671(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int i = lp2.width;
                int customWidthMode = r0 != -2 ? Ints.MAX_POWER_OF_TWO : RtlSpacingHelper.UNDEFINED;
                if (lp2.width >= 0) {
                ...
                i = lp2.height;
                int customHeightMode = r0 != -2 ? Ints.MAX_POWER_OF_TWO : RtlSpacingHelper.UNDEFINED;
                if (lp2.height >= 0) {
