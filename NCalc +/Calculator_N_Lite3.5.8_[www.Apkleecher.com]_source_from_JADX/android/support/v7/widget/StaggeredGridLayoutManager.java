...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            static class C03281 implements Creator<FullSpanItem> {
                C03281() {
                }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCheckForGapsRunnable = new C03271();
    ...
    private int updateSpecWithExtra(int spec, int startInset, int endInset) {
        ...
        if (mode == INVALID_OFFSET || mode == Ints.MAX_POWER_OF_TWO) {
    ...
    private void fixStartGap(Recycler recycler, State state, boolean canOffsetChildren) {
        int minStartLine = getMinStart(BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
        if (minStartLine != BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT) {
    ...
    private int fill(Recycler recycler, LayoutState layoutState, State state) {
        ...
        if (this.mLayoutState.mInfinite) {
            if (layoutState.mLayoutDirection == VERTICAL) {
                targetLine = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
            } else {
    ...
    private Span getNextSpan(LayoutState layoutState) {
        ...
        if (layoutState.mLayoutDirection == VERTICAL) {
            Span min = null;
            int minLine = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
