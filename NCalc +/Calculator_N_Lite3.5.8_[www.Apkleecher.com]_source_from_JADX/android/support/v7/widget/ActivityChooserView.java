...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02731 extends DataSetObserver {
        C02731() {
        }
    ...
    class C02753 extends ForwardingListener {
        C02753(View src) {
            super(src);
        }
    ...
    class C02764 extends DataSetObserver {
        C02764() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0248R.id.list_item) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0248R.layout.abc_activity_chooser_view_list_item, parent, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    ((ImageView) convertView.findViewById(C0248R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0248R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0248R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0248R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch (((ActivityChooserViewAdapter) parent.getAdapter()).getItemViewType(position)) {
                ...
                case ValueServer.REPLAY_MODE /*1*/:
                    ActivityChooserView.this.showPopupUnchecked(BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
                default:
                    throw new IllegalArgumentException();
            }
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C02731();
        this.mOnGlobalLayoutListener = new C02742();
        this.mInitialActivityCount = 4;
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0248R.styleable.ActivityChooserView, defStyle, 0);
        this.mInitialActivityCount = attributesArray.getInt(C0248R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0248R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributesArray.recycle();
        LayoutInflater.from(getContext()).inflate(C0248R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0248R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0248R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0248R.id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C0248R.id.expand_activities_button);
        expandButton.setOnClickListener(this.mCallbacks);
        expandButton.setOnTouchListener(new C02753(expandButton));
        this.mExpandActivityOverflowButton = expandButton;
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0248R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C02764());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0248R.dimen.abc_config_prefDialogWidth));
    }
    ...
    void showPopupUnchecked(int maxActivityCount) {
        ...
        if (maxActivityCount == BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT || activityCount <= maxActivityCount + maxActivityCountOffset) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(getContext().getString(C0248R.string.abc_activitychooserview_choose_application));
        }
    }
