...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int minX = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
            int minY = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
            int maxX = RtlSpacingHelper.UNDEFINED;
            int maxY = RtlSpacingHelper.UNDEFINED;
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < count; i += RecyclerView.VERTICAL) {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == RtlSpacingHelper.UNDEFINED || parentMode == Ints.MAX_POWER_OF_TWO) ? RtlSpacingHelper.UNDEFINED : RecyclerView.TOUCH_SLOP_DEFAULT;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.orientation = a.getInt(C0250R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0250R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0250R.styleable.RecyclerView_reverseLayout, RecyclerView.POST_UPDATES_ON_ANIMATION);
            properties.stackFromEnd = a.getBoolean(C0250R.styleable.RecyclerView_stackFromEnd, RecyclerView.POST_UPDATES_ON_ANIMATION);
            a.recycle();
            return properties;
        }
    ...
    static class C03083 implements Interpolator {
        C03083() {
        }
    ...
    class C03094 implements ProcessCallback {
        C03094() {
        }
    ...
    class C03105 implements Callback {
        C03105() {
        }
    ...
    class C03116 implements Callback {
        C03116() {
        }
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (fromScrapOrHiddenOrCache && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD)) {
                ...
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | StaticSettings.MAX_FILE_BUFFER_SIZE, holder.getUnmodifiedPayloads()));
                }
            }
        ...
        void setAdapterPositionsAsUnknown() {
            ...
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < cachedCount; i += RecyclerView.VERTICAL) {
                ViewHolder holder = (ViewHolder) this.mCachedViews.get(i);
                if (holder != null) {
                    holder.addFlags(IExpr.PATTERNID);
                }
            }
        }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, RtlSpacingHelper.UNDEFINED, BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT, RtlSpacingHelper.UNDEFINED, BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
            postOnAnimation();
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C03083();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C03061();
        ...
        this.mItemAnimatorRunner = new C03072();
        this.mViewInfoProcessCallback = new C03094();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0250R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0250R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0250R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == NO_POSITION) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03105());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03116());
    }
    ...
    private boolean isPreferredNextFocusAbsolute(View focused, View next, int direction) {
        ...
        switch (direction) {
            ...
            case com.github.clans.fab.R.styleable.FloatingActionMenu_menu_colorRipple /*33*/:
                ...
                return POST_UPDATES_ON_ANIMATION;
            case com.getkeepsafe.taptargetview.R.styleable.AppCompatTheme_textAppearanceSearchResultTitle /*66*/:
        ...
        if (dispatchOnItemTouchIntercept(e)) {
            ...
            switch (action) {
                case TOUCH_SLOP_DEFAULT /*0*/:
                    ...
                    x = (int) (e.getX() + GenVectorModul.DEFAULT_DENSITY);
                    this.mLastTouchX = x;
                    this.mInitialTouchX = x;
                    x = (int) (e.getY() + GenVectorModul.DEFAULT_DENSITY);
                    this.mLastTouchY = x;
                ...
                case SCROLL_STATE_SETTLING /*2*/:
                    ...
                    if (index >= 0) {
                        int x2 = (int) (e.getX(index) + GenVectorModul.DEFAULT_DENSITY);
                        int y = (int) (e.getY(index) + GenVectorModul.DEFAULT_DENSITY);
                ...
                case ValueServer.CONSTANT_MODE /*5*/:
                    ...
                    x = (int) (e.getX(actionIndex) + GenVectorModul.DEFAULT_DENSITY);
                    this.mLastTouchX = x;
                    this.mInitialTouchX = x;
                    x = (int) (e.getY(actionIndex) + GenVectorModul.DEFAULT_DENSITY);
                    this.mLastTouchY = x;
                    this.mInitialTouchY = x;
                    break;
    ...
    private void onPointerUp(MotionEvent e) {
        ...
        if (e.getPointerId(actionIndex) == this.mScrollPointerId) {
            ...
            int x = (int) (e.getX(newIndex) + GenVectorModul.DEFAULT_DENSITY);
            this.mLastTouchX = x;
            this.mInitialTouchX = x;
            x = (int) (e.getY(newIndex) + GenVectorModul.DEFAULT_DENSITY);
            this.mLastTouchY = x;
            this.mInitialTouchY = x;
        }
    }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if (flags != 0 && isAccessibilityEnabled()) {
            ...
            event.setEventType(IExpr.METHODSYMBOLID);
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (i = TOUCH_SLOP_DEFAULT; i < this.mChildHelper.getChildCount(); i += VERTICAL) {
                ...
                if (!(viewHolder.shouldIgnore() || this.mViewInfoStore.isInPreLayout(viewHolder))) {
                    ...
                    if (!wasHidden) {
                        flags |= StaticSettings.MAX_FILE_BUFFER_SIZE;
                    }
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        int minPositionPreLayout = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
        int maxPositionPreLayout = RtlSpacingHelper.UNDEFINED;
