...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    class C02884 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02884(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02895 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ ViewHolder val$holder;

        C02895(ViewHolder viewHolder, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$animation = viewPropertyAnimatorCompat;
        }
    ...
    class C02906 extends VpaListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorCompat val$animation;
        final /* synthetic */ int val$deltaX;
        final /* synthetic */ int val$deltaY;
        final /* synthetic */ ViewHolder val$holder;

        C02906(ViewHolder viewHolder, int i, int i2, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
            this.val$holder = viewHolder;
            this.val$deltaX = i;
            this.val$deltaY = i2;
            this.val$animation = viewPropertyAnimatorCompat;
    ...
    class C02917 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ ViewPropertyAnimatorCompat val$oldViewAnim;

        C02917(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat) {
    ...
    class C02928 extends VpaListenerAdapter {
        final /* synthetic */ ChangeInfo val$changeInfo;
        final /* synthetic */ View val$newView;
        final /* synthetic */ ViewPropertyAnimatorCompat val$newViewAnimation;

        C02928(ChangeInfo changeInfo, ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view) {
            this.val$changeInfo = changeInfo;
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable mover = new C02851(moves);
                if (removalsPending) {
            ...
            if (changesPending) {
                ...
                Runnable changer = new C02862(changes);
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new C02873(additions);
    ...
    private void animateRemoveImpl(ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new C02884(holder, animation)).start();
    }
    ...
    void animateAddImpl(ViewHolder holder) {
        ...
        animation.alpha(1.0f).setDuration(getAddDuration()).setListener(new C02895(holder, animation)).start();
    }
    ...
    void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new C02906(holder, deltaX, deltaY, animation)).start();
    }
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new C02917(changeInfo, oldViewAnim)).start();
        }
        if (newView != null) {
            ViewPropertyAnimatorCompat newViewAnimation = ViewCompat.animate(newView);
            this.mChangeAnimations.add(changeInfo.newHolder);
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new C02928(changeInfo, newViewAnimation, newView)).start();
        }
    }
