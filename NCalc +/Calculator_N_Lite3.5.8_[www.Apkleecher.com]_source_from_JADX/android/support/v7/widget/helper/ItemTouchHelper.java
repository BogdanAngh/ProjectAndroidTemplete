...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    class C03382 implements OnItemTouchListener {
        C03382() {
        }
    ...
    private class RecoverAnimation implements AnimatorListenerCompat {
        ...
        class C03441 implements AnimatorUpdateListenerCompat {
            final /* synthetic */ ItemTouchHelper val$this$0;

            C03441(ItemTouchHelper itemTouchHelper) {
        ...
        public RecoverAnimation(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            ...
            this.mValueAnimator.addUpdateListener(new C03441(ItemTouchHelper.this));
    ...
    class C03393 extends RecoverAnimation {
        final /* synthetic */ ViewHolder val$prevSelected;
        final /* synthetic */ int val$swipeDir;

        C03393(ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY, int i, ViewHolder viewHolder2) {
            this.val$swipeDir = i;
    ...
    class C03404 implements Runnable {
        ...
        C03404(RecoverAnimation recoverAnimation, int i) {
    ...
    class C03415 implements ChildDrawingOrderCallback {
        C03415() {
        }
    ...
    public static abstract class Callback {
        ...
        static class C03421 implements Interpolator {
            C03421() {
            }
        ...
        static class C03432 implements Interpolator {
            C03432() {
            }
        ...
        static {
            sDragScrollInterpolator = new C03421();
            sDragViewScrollCapInterpolator = new C03432();
        ...
        public float getSwipeThreshold(ViewHolder viewHolder) {
            return GenVectorModul.DEFAULT_DENSITY;
        }
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    RecoverAnimation rv = new C03393(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY, swipeDir, prevSelected);
    ...
    void postDispatchSwipe(RecoverAnimation anim, int swipeDir) {
        this.mRecyclerView.post(new C03404(anim, swipeDir));
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C03415();
            }
