...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0248R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0248R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0248R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0248R.styleable.ActionBar_height, -1);
        if (getId() == C0248R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0248R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0248R.id.action_bar);
        this.mContextView = findViewById(C0248R.id.action_context_bar);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != Ints.MAX_POWER_OF_TWO) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(getMeasuredHeightWithMargins(this.mTabContainer) + topMarginForTabs, mode == RtlSpacingHelper.UNDEFINED ? MeasureSpec.getSize(heightMeasureSpec) : BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT));
            }
        }
    }
