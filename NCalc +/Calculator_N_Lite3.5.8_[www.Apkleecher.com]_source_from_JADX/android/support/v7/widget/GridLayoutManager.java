    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult result) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view) != maxSize) {
                ...
                if (this.mOrientation == 1) {
                    wSpec = LayoutManager.getChildMeasureSpec(totalSpaceInOther, Ints.MAX_POWER_OF_TWO, horizontalInsets, lp.width, DEBUG);
                    ...
                    hSpec = LayoutManager.getChildMeasureSpec(totalSpaceInOther, Ints.MAX_POWER_OF_TWO, verticalInsets, lp.height, DEBUG);
                }
