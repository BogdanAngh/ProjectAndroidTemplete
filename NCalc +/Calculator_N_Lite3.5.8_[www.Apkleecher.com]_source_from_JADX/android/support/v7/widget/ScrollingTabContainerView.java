...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            super(context, null, C0248R.attr.actionBarTabStyle);
            this.BG_ATTRS = new int[]{16842964};
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0248R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0248R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount <= 1 || !(widthMode == Ints.MAX_POWER_OF_TWO || widthMode == RtlSpacingHelper.UNDEFINED)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0248R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0248R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C03141(tabView);
