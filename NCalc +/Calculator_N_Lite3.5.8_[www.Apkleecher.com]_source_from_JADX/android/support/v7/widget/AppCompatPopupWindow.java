...
class AppCompatPopupWindow extends PopupWindow {
    ...
    static class C02771 implements OnScrollChangedListener {
        ...
        C02771(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0248R.styleable.PopupWindow, defStyleAttr, defStyleRes);
        if (a.hasValue(C0248R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(C0248R.styleable.PopupWindow_overlapAnchor, COMPAT_OVERLAP_ANCHOR));
        }
        setBackgroundDrawable(a.getDrawable(C0248R.styleable.PopupWindow_android_popupBackground));
        int sdk = VERSION.SDK_INT;
        if (defStyleRes != 0 && sdk < 11 && a.hasValue(C0248R.styleable.PopupWindow_android_popupAnimationStyle)) {
            setAnimationStyle(a.getResourceId(C0248R.styleable.PopupWindow_android_popupAnimationStyle, -1));
        }
        a.recycle();
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new C02771(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
