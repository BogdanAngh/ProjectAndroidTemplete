...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C02681 extends ViewPropertyAnimatorListenerAdapter {
        C02681() {
        }
    ...
    static {
        ATTRS = new int[]{C0248R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C02681();
        this.mRemoveActionBarHideOffset = new C02692();
        this.mAddActionBarHideOffset = new C02703();
        init(context);
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        if ((diff & IExpr.BLANKID) != 0 && this.mActionBarVisibilityCallback != null) {
            ViewCompat.requestApplyInsets(this);
        }
    }
    ...
    protected boolean fitSystemWindows(Rect insets) {
        pullChildren();
        boolean stable;
        if ((ViewCompat.getWindowSystemUiVisibility(this) & IExpr.BLANKID) != 0) {
            stable = true;
        } else {
            stable = false;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        boolean stable = (ViewCompat.getWindowSystemUiVisibility(this) & IExpr.BLANKID) != 0;
        if (stable) {
    ...
    public void draw(Canvas c) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            int top = this.mActionBarTop.getVisibility() == 0 ? (int) ((((float) this.mActionBarTop.getBottom()) + ViewCompat.getTranslationY(this.mActionBarTop)) + GenVectorModul.DEFAULT_DENSITY) : 0;
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0248R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0248R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0248R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, RtlSpacingHelper.UNDEFINED, BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
