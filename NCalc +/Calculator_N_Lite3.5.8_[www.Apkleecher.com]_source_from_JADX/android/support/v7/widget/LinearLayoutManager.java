...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    static class LayoutState {
        ...
        public View nextViewInLimitedList(View ignore) {
            int size = this.mScrapList.size();
            View closest = null;
            int closestDistance = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
            for (int i = LinearLayoutManager.HORIZONTAL; i < size; i += LAYOUT_END) {
                View view = ((ViewHolder) this.mScrapList.get(i)).itemView;
                LayoutParams lp = (LayoutParams) view.getLayoutParams();
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02961 implements Creator<SavedState> {
            C02961() {
            }
    ...
    boolean shouldMeasureTwice() {
        return (getHeightMode() == Ints.MAX_POWER_OF_TWO || getWidthMode() == Ints.MAX_POWER_OF_TWO || !hasFlexibleChildInBothOrientations()) ? DEBUG : true;
    }
