...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C02993 implements OnItemSelectedListener {
        C02993() {
        }
    ...
    public ListPopupWindow(@NonNull Context context) {
        this(context, null, C0248R.attr.listPopupWindowStyle);
    }

    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, C0248R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        ...
        this.mListItemExpandMaximum = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0248R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0248R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0248R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            int firstItem = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02982();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02993());
