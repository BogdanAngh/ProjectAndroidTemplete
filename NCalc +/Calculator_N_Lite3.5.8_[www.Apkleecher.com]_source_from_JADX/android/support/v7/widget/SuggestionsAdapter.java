...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0248R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0248R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0248R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        Drawable drawable;
        if (drawableId == null || drawableId.length() == 0 || Constants.ZERO.equals(drawableId)) {
            return null;
        }
        try {
    ...
    private Drawable getActivityIcon(ComponentName component) {
        ...
        try {
            ActivityInfo activityInfo = pm.getActivityInfo(component, IExpr.SYMBOLID);
