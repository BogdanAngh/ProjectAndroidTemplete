...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C03251 extends OnScrollListener {
        boolean mScrolled;
    ...
    class C03262 extends LinearSmoothScroller {
        C03262(Context context) {
            super(context);
        }
    ...
    public SnapHelper() {
        this.mScrollListener = new C03251();
    }
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, RtlSpacingHelper.UNDEFINED, BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT, RtlSpacingHelper.UNDEFINED, BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT);
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        if (layoutManager instanceof ScrollVectorProvider) {
            return new C03262(this.mRecyclerView.getContext());
        }
        return null;
    }
}
