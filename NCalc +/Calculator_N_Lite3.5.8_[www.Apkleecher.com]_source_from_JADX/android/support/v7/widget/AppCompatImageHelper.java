...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            if (drawable == null) {
                a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0248R.styleable.AppCompatImageView, defStyleAttr, 0);
                int id = a.getResourceId(C0248R.styleable.AppCompatImageView_srcCompat, -1);
                if (id != -1) {
