...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latitude, double longitude) {
        ...
        double solarLng = (1.796593063d + (((((double) meanAnomaly) + (0.03341960161924362d * Math.sin((double) meanAnomaly))) + (3.4906598739326E-4d * Math.sin((double) (2.0f * meanAnomaly)))) + (5.236000106378924E-6d * Math.sin((double) (3.0f * meanAnomaly))))) + FastMath.PI;
        ...
        if (cosHourAngle >= 1.0d) {
            ...
            float hourAngle = (float) (Math.acos(cosHourAngle) / Angle2D.M_2PI);
