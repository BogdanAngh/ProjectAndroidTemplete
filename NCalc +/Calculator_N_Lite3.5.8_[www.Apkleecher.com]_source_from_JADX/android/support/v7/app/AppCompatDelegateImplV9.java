...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C02331 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & StaticSettings.MAX_FILE_BUFFER_SIZE) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C02385 implements Runnable {
    ...
    class C02396 extends ViewPropertyAnimatorListenerAdapter {
        C02396() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02401());
            }
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02411());
            }
        }
        ...
        void setStyle(Context context) {
            ...
            widgetTheme.resolveAttribute(C0248R.attr.actionBarPopupTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            }
            widgetTheme.resolveAttribute(C0248R.attr.panelMenuListTheme, outValue, true);
            if (outValue.resourceId != 0) {
                widgetTheme.applyStyle(outValue.resourceId, true);
            } else {
                widgetTheme.applyStyle(C0248R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context context2 = new ContextThemeWrapper(context, 0);
            context2.getTheme().setTo(widgetTheme);
            this.listPresenterContext = context2;
            TypedArray a = context2.obtainStyledAttributes(C0248R.styleable.AppCompatTheme);
            this.background = a.getResourceId(C0248R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0248R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            a.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0248R.layout.abc_list_menu_item_layout);
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C02331();
    }
    ...
    private ViewGroup createSubDecor() {
        TypedArray a = this.mContext.obtainStyledAttributes(C0248R.styleable.AppCompatTheme);
        if (a.hasValue(C0248R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0248R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0248R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (a.getBoolean(C0248R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (a.getBoolean(C0248R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0248R.styleable.AppCompatTheme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0248R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0248R.layout.abc_screen_simple, null);
                }
                ...
                subDecor = (ViewGroup) inflater.inflate(C0248R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0248R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0248R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0248R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0248R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0248R.id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0248R.styleable.AppCompatTheme);
        a.getValue(C0248R.styleable.AppCompatTheme_windowMinWidthMajor, cfl.getMinWidthMajor());
        a.getValue(C0248R.styleable.AppCompatTheme_windowMinWidthMinor, cfl.getMinWidthMinor());
        if (a.hasValue(C0248R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            a.getValue(C0248R.styleable.AppCompatTheme_windowFixedWidthMajor, cfl.getFixedWidthMajor());
        }
        if (a.hasValue(C0248R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            a.getValue(C0248R.styleable.AppCompatTheme_windowFixedWidthMinor, cfl.getFixedWidthMinor());
        }
        if (a.hasValue(C0248R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            a.getValue(C0248R.styleable.AppCompatTheme_windowFixedHeightMajor, cfl.getFixedHeightMajor());
        }
        if (a.hasValue(C0248R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            a.getValue(C0248R.styleable.AppCompatTheme_windowFixedHeightMinor, cfl.getFixedHeightMinor());
        }
        a.recycle();
        cfl.requestLayout();
    }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    baseTheme.resolveAttribute(C0248R.attr.actionBarTheme, outValue, true);
                    if (outValue.resourceId != 0) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0248R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    actionBarContext.getTheme().resolveAttribute(C0248R.attr.actionBarSize, outValue, true);
                    ...
                    this.mShowActionModePopup = new C02385();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0248R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C02396());
                    } else {
    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case IExpr.DOUBLECOMPLEXID /*4*/:
                if ((event.getFlags() & IExpr.SYMBOLID) == 0) {
                    z = false;
                }
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(R.styleable.AppCompatTheme_ratingBarStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.applyStyle(outValue.resourceId, true);
                widgetTheme.resolveAttribute(C0248R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                baseTheme.resolveAttribute(C0248R.attr.actionBarWidgetTheme, outValue, true);
            }
            if (outValue.resourceId != 0) {
                if (widgetTheme == null) {
                    widgetTheme = context.getResources().newTheme();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == R.styleable.AppCompatTheme_ratingBarStyle) {
    ...
    void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
    ...
    void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == R.styleable.AppCompatTheme_ratingBarStyle || featureId == 0) && this.mDecorContentParent != null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (mlp.topMargin != newMargin) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0248R.color.abc_input_method_navigation_guard));
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
