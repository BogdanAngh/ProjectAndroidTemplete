...
class ToolbarActionBar extends ActionBar {
    ...
    class C02442 implements OnMenuItemClickListener {
        C02442() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            return true;
        }
        ...
        public void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(R.styleable.AppCompatTheme_ratingBarStyle, menu);
                }
    ...
    private final class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public void onMenuModeChange(MenuBuilder menu) {
            ...
            if (ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing()) {
                ...
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
        }
    }
    ...
    public ToolbarActionBar(Toolbar toolbar, CharSequence title, Callback callback) {
        ...
        this.mMenuInvalidator = new C02431();
        this.mMenuClicker = new C02442();
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0248R.layout.abc_list_menu_item_layout);
