...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, C0248R.styleable.ActionBarLayout);
            this.gravity = a.getInt(C0248R.styleable.ActionBarLayout_android_layout_gravity, ActionBar.NAVIGATION_MODE_STANDARD);
            a.recycle();
        }
