...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02462 extends ViewPropertyAnimatorListenerAdapter {
        C02462() {
        }
    ...
    class C02473 implements ViewPropertyAnimatorUpdateListener {
        C02473() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02451();
        this.mShowListener = new C02462();
        this.mUpdateListener = new C02473();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0248R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0248R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0248R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0248R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0248R.styleable.ActionBar, C0248R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0248R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0248R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0248R.attr.actionBarWidgetTheme, outValue, true);
