...
class AppCompatDelegateImplV14 extends AppCompatDelegateImplV11 {
    ...
    final class AutoNightModeManager {
        ...
        class C02321 extends BroadcastReceiver {
            C02321() {
            }
        ...
        final void setup() {
            ...
            if (this.mAutoTimeChangeReceiver == null) {
                this.mAutoTimeChangeReceiver = new C02321();
            }
    ...
    private boolean shouldRecreateOnNightModeChange() {
        ...
        try {
            if ((this.mContext.getPackageManager().getActivityInfo(new ComponentName(this.mContext, this.mContext.getClass()), 0).configChanges & IExpr.PATTERNID) == 0) {
                return true;
            }
            return false;
