...
class AlertController {
    ...
    class C02232 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02232(View view, View view2) {
            this.val$top = view;
    ...
    class C02254 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02254(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C02271 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ RecycleListView val$listView;

            C02271(Context x0, int x1, int x2, CharSequence[] x3, RecycleListView recycleListView) {
        ...
        class C02282 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C02282(Context x0, Cursor x1, boolean x2, RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
        ...
        class C02293 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;

            C02293(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C02304 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            C02304(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C02271(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c02282 = new C02282(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C02293(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C02304(listView, dialog));
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0248R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0248R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0248R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0248R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C02221();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(di);
        TypedArray a = context.obtainStyledAttributes(null, C0248R.styleable.AlertDialog, C0248R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0248R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0248R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0248R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0248R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0248R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0248R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0248R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View spacer;
        View parentPanel = this.mWindow.findViewById(C0248R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0248R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0248R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0248R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0248R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0248R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0248R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0248R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            spacer = contentPanel.findViewById(C0248R.id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!((this.mMessage == null && this.mListView == null && !hasCustomPanel) || hasCustomPanel)) {
                divider = topPanel.findViewById(C0248R.id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            spacer = contentPanel.findViewById(C0248R.id.textSpacerNoTitle);
            if (spacer != null) {
                spacer.setVisibility(0);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0248R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0248R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C02232(top, bottom));
                this.mScrollView.post(new C02243(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C02254(top, bottom));
                this.mListView.post(new C02265(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0248R.id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0248R.id.title_template).setVisibility(8);
            return;
        }
        ...
        if (hasTextTitle && this.mShowTitle) {
            this.mTitleView = (TextView) this.mWindow.findViewById(C0248R.id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0248R.id.scrollView);
    ...
    private void centerButton(Button button) {
        ...
        params.gravity = 1;
        params.weight = GenVectorModul.DEFAULT_DENSITY;
