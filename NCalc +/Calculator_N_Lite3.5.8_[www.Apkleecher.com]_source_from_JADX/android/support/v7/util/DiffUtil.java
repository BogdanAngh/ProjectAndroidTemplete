...
public class DiffUtil {
    ...
    static class C02531 implements Comparator<Snake> {
        C02531() {
        }
    ...
    public static class DiffResult {
        ...
        class C02541 implements ListUpdateCallback {
            final /* synthetic */ Adapter val$adapter;

            C02541(Adapter adapter) {
        ...
        public void dispatchUpdatesTo(Adapter adapter) {
            dispatchUpdatesTo(new C02541(adapter));
        }
