...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02561 implements MainThreadCallback<T> {
        ...
        class C02551 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C02561.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C02561.UPDATE_ITEM_COUNT /*1*/:
                            C02561.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C02561.ADD_TILE /*2*/:
                            C02561.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C02561.REMOVE_TILE /*3*/:
                            C02561.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C02561.this.mQueue.next();
                }
            }
        }

        C02561(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C02551();
        }
    ...
    class C02582 implements BackgroundCallback<T> {
        ...
        class C02571 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C02582.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C02582.REFRESH /*1*/:
                                C02582.this.mQueue.removeMessages(C02582.REFRESH);
                                C02582.this.val$callback.refresh(msg.arg1);
                                break;
                            case C02582.UPDATE_RANGE /*2*/:
                                C02582.this.mQueue.removeMessages(C02582.UPDATE_RANGE);
                                C02582.this.mQueue.removeMessages(C02582.LOAD_TILE);
                                C02582.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C02582.LOAD_TILE /*3*/:
                                C02582.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C02582.RECYCLE_TILE /*4*/:
                                C02582.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C02582.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C02582(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C02571();
        }
