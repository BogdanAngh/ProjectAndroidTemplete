...
public class AsyncListUtil<T> {
    ...
    class C02511 implements MainThreadCallback<T> {
        C02511() {
        }
    ...
    class C02522 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02511();
        this.mBackgroundCallback = new C02522();
        this.mTClass = klass;
