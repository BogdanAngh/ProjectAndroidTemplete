...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C01001 implements ThreadFactory {
    ...
    class C01012 extends WorkerRunnable<Params, Result> {
        C01012() {
        }
    ...
    class C01023 extends FutureTask<Result> {
        C01023(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C01012();
        this.mFuture = new C01023(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C01034.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
