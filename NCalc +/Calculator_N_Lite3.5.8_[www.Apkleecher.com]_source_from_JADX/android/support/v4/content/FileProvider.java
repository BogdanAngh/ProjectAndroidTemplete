...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) mostSpecific.getKey()) + Constants.DIV_UNICODE + Uri.encode(path, "/")).build();
            } catch (IOException e) {
    ...
    private static PathStrategy parsePathStrategy(Context context, String authority) throws IOException, XmlPullParserException {
        ...
        XmlResourceParser in = context.getPackageManager().resolveContentProvider(authority, IExpr.SYMBOLID).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
        if (in == null) {
