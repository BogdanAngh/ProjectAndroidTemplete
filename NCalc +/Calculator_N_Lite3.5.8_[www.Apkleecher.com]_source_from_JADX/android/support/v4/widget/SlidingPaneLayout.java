...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                if (xvel < 0.0f || (xvel == 0.0f && SlidingPaneLayout.this.mSlideOffset > GenVectorModul.DEFAULT_DENSITY)) {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02101 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02101() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02101());
        }
    }
    ...
    public SlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mOverhangSize = (int) ((32.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        ViewConfiguration viewConfig = ViewConfiguration.get(context);
        setWillNotDraw(false);
        ViewCompat.setAccessibilityDelegate(this, new AccessibilityDelegate());
        ViewCompat.setImportantForAccessibility(this, 1);
        this.mDragHelper = ViewDragHelper.create(this, GenVectorModul.DEFAULT_DENSITY, new DragHelperCallback());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (!isInEditMode()) {
                ...
                heightMode = RtlSpacingHelper.UNDEFINED;
                heightSize = 300;
            }
        }
        int layoutHeight = 0;
        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                i2 = lp.width;
                if (r0 == -2) {
                    childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, RtlSpacingHelper.UNDEFINED);
                } else {
                    i2 = lp.width;
                    if (r0 == -1) {
                ...
                i2 = lp.height;
                if (r0 == -2) {
                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, RtlSpacingHelper.UNDEFINED);
                } else {
                    i2 = lp.height;
                    if (r0 == -1) {
