...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class C02021 extends Animation {
    ...
    class C02032 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    float getMinProgressArc(Ring ring) {
        return (float) Math.toRadians(((double) ring.getStrokeWidth()) / (Angle2D.M_2PI * ring.getCenterRadius()));
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C02021(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(DEFAULT);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C02032(ring));
