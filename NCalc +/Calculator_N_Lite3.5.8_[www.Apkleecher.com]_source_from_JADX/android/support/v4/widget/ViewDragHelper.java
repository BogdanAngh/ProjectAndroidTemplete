...
public class ViewDragHelper {
    ...
    static class C02191 implements Interpolator {
        C02191() {
        }
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        ...
        this.mSetIdleRunnable = new C02202();
        if (forParent == null) {
            ...
            this.mEdgeSize = (int) ((20.0f * context.getResources().getDisplayMetrics().density) + GenVectorModul.DEFAULT_DENSITY);
    ...
    private boolean checkNewEdgeDrag(float delta, float odelta, int pointerId, int edge) {
        ...
        if (absDelta < GenVectorModul.DEFAULT_DENSITY * absODelta && this.mCallback.onEdgeLock(edge)) {
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(EmpiricalDistribution.DEFAULT_BIN_COUNT, this.mMaxVelocity);
