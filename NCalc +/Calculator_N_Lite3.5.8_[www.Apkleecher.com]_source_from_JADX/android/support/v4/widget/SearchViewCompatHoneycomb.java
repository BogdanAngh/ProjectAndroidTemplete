...
class SearchViewCompatHoneycomb {
    ...
    static class C02081 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C02081(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C02092 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C02092(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
