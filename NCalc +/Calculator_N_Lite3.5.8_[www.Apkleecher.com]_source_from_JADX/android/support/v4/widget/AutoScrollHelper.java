...
public abstract class AutoScrollHelper implements OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        public void start() {
            ...
            this.mStopValue = GenVectorModul.DEFAULT_DENSITY;
            this.mDeltaX = AutoScrollHelper.HORIZONTAL;
            this.mDeltaY = AutoScrollHelper.HORIZONTAL;
        }
        ...
        private float getValueAt(long currentTime) {
            ...
            if (this.mStopTime < 0 || currentTime < this.mStopTime) {
                return AutoScrollHelper.constrain(((float) (currentTime - this.mStartTime)) / ((float) this.mRampUpDuration), (float) AutoScrollHelper.RELATIVE_UNSPECIFIED, (float) AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * GenVectorModul.DEFAULT_DENSITY;
            }
    ...
    public AutoScrollHelper(View target) {
        ...
        int maxVelocity = (int) ((1575.0f * metrics.density) + GenVectorModul.DEFAULT_DENSITY);
        int minVelocity = (int) ((315.0f * metrics.density) + GenVectorModul.DEFAULT_DENSITY);
