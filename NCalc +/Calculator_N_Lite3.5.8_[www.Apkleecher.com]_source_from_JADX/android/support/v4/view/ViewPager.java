...
public class ViewPager extends ViewGroup {
    ...
    static class C01811 implements Comparator<ItemInfo> {
        C01811() {
        }
    ...
    static class C01822 implements Interpolator {
        C01822() {
        }
    ...
    class C01844 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == StaticSettings.MAX_FILE_BUFFER_SIZE && ViewPager.this.mAdapter != null) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01851 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01851() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01851());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01811();
        sInterpolator = new C01822();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01833();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01844());
    }
