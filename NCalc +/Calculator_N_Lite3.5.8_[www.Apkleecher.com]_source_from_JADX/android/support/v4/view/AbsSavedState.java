...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C01691 extends AbsSavedState {
        C01691() {
            super();
        }
    }
    ...
    static class C01702 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C01702() {
        }
    ...
    static {
        EMPTY_STATE = new C01691();
        CREATOR = ParcelableCompat.newCreator(new C01702());
    }
