...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attrs) {
        ...
        this.mIndicatorHeight = (int) ((3.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        this.mMinPaddingBottom = (int) ((6.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        this.mMinTextSpacing = (int) (64.0f * density);
        this.mTabPadding = (int) ((16.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        this.mFullUnderlineHeight = (int) ((1.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        this.mMinStripHeight = (int) ((32.0f * density) + GenVectorModul.DEFAULT_DENSITY);
        this.mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        setPadding(getPaddingLeft(), getPaddingTop(), getPaddingRight(), getPaddingBottom());
        setTextSpacing(getTextSpacing());
        setWillNotDraw(false);
        this.mPrevText.setFocusable(true);
        this.mPrevText.setOnClickListener(new C01771());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C01782());
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        this.mTabAlpha = (int) ((Math.abs(positionOffset - GenVectorModul.DEFAULT_DENSITY) * 2.0f) * 255.0f);
