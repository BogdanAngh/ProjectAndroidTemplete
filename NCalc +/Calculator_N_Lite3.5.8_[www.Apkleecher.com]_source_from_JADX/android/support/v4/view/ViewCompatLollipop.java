...
class ViewCompatLollipop {
    ...
    static class C01801 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListenerBridge val$bridge;

        C01801(OnApplyWindowInsetsListenerBridge onApplyWindowInsetsListenerBridge) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListenerBridge bridge) {
        if (bridge == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C01801(bridge));
        }
    }
