...
class ViewPropertyAnimatorCompatICS {
    ...
    static class C01861 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C01861(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new C01861(listener, view));
        } else {
