...
public class PagerTitleStrip extends ViewGroup {
    ...
    private class PageListener extends DataSetObserver implements OnPageChangeListener, OnAdapterChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            if (positionOffset > GenVectorModul.DEFAULT_DENSITY) {
                position++;
            }
    ...
    void updateText(int currentItem, PagerAdapter adapter) {
        ...
        int childWidthSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) ((getWidth() - getPaddingLeft()) - getPaddingRight())) * 0.8f)), RtlSpacingHelper.UNDEFINED);
        int childHeightSpec = MeasureSpec.makeMeasureSpec(Math.max(0, (getHeight() - getPaddingTop()) - getPaddingBottom()), RtlSpacingHelper.UNDEFINED);
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        float currOffset = positionOffset + GenVectorModul.DEFAULT_DENSITY;
        if (currOffset > 1.0f) {
            currOffset -= 1.0f;
        }
