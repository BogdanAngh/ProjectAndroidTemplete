...
class FragmentTransitionCompat21 {
    ...
    static class C00871 extends EpicenterCallback {
    ...
    static class C00882 implements TransitionListener {
        final /* synthetic */ ArrayList val$exitingViews;
        final /* synthetic */ View val$fragmentView;

        C00882(View view, ArrayList arrayList) {
    ...
    static class C00893 implements OnPreDrawListener {
        ...
        C00893(View view, int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
    ...
    static class C00904 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ View val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00904(View view, ArrayList arrayList, Map map) {
            this.val$sceneRoot = view;
            this.val$sharedElementsIn = arrayList;
    ...
    static class C00915 implements TransitionListener {
        ...
        C00915(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
    ...
    static class C00926 extends EpicenterCallback {
        final /* synthetic */ Rect val$epicenter;
    ...
    static class C00937 implements OnPreDrawListener {
        final /* synthetic */ Map val$nameOverrides;
        final /* synthetic */ ViewGroup val$sceneRoot;
        final /* synthetic */ ArrayList val$sharedElementsIn;

        C00937(ViewGroup viewGroup, ArrayList arrayList, Map map) {
    ...
    public static void setEpicenter(Object transitionObj, View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback(new C00871(epicenter));
        }
    }
    ...
    public static void scheduleHideFragmentView(Object exitTransitionObj, View fragmentView, ArrayList<View> exitingViews) {
        ((Transition) exitTransitionObj).addListener(new C00882(fragmentView, exitingViews));
    }
    ...
    public static void setNameOverridesOptimized(View sceneRoot, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, ArrayList<String> inNames, Map<String, String> nameOverrides) {
        ...
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00893(sceneRoot, numSharedElements, sharedElementsIn, inNames, sharedElementsOut, outNames));
    }
    ...
    public static void setNameOverridesUnoptimized(View sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00904(sceneRoot, sharedElementsIn, nameOverrides));
    }
    ...
    public static void scheduleRemoveTargets(Object overallTransitionObj, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews, Object sharedElementTransition, ArrayList<View> sharedElementsIn) {
        ((Transition) overallTransitionObj).addListener(new C00915(enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementsIn));
    }
    ...
    public static void setEpicenter(Object transitionObj, Rect epicenter) {
        if (transitionObj != null) {
            ((Transition) transitionObj).setEpicenterCallback(new C00926(epicenter));
        }
    }

    public static void scheduleNameReset(ViewGroup sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00937(sceneRoot, sharedElementsIn, nameOverrides));
    }
}
