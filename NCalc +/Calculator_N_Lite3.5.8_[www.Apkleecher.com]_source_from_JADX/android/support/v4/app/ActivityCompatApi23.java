...
class ActivityCompatApi23 {
    ...
    private static class SharedElementCallbackImpl extends SharedElementCallback {
        ...
        class C00771 implements OnSharedElementsReadyListenerBridge {
            final /* synthetic */ OnSharedElementsReadyListener val$listener;

            C00771(OnSharedElementsReadyListener onSharedElementsReadyListener) {
        ...
        public void onSharedElementsArrived(List<String> sharedElementNames, List<View> sharedElements, OnSharedElementsReadyListener listener) {
            this.mCallback.onSharedElementsArrived(sharedElementNames, sharedElements, new C00771(listener));
        }
    }
