...
public class FragmentActivity extends BaseFragmentActivityJB implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    private static String viewToString(View view) {
        ...
        char c2 = 'F';
        char c3 = '.';
        StringBuilder out = new StringBuilder(IExpr.SYMBOLID);
        out.append(view.getClass().getName());
        out.append('{');
        out.append(Integer.toHexString(System.identityHashCode(view)));
        out.append(Letters.SPACE);
        ...
        out.append(Letters.COMMA);
        out.append(view.getTop());
        out.append(Constants.MINUS_UNICODE);
        ...
        out.append(VectorFormat.DEFAULT_SUFFIX);
        return out.toString();
    }
