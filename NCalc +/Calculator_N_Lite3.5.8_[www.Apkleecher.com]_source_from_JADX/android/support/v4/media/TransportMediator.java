...
public class TransportMediator extends TransportController {
    ...
    class C01331 implements TransportMediatorCallback {
        C01331() {
        }
    ...
    class C01342 implements Callback {
        C01342() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01331();
        this.mKeyEventCallback = new C01342();
