...
public final class MediaControllerCompat {
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        class C01431 extends ResultReceiver {
            C01431(Handler x0) {
                super(x0);
            }
        ...
        private class ExtraCallback extends Stub {
            ...
            class C01441 implements Runnable {
                ...
                C01441(String str, Bundle bundle) {
                    this.val$event = str;
            ...
            class C01452 implements Runnable {
                ...
                C01452(PlaybackStateCompat playbackStateCompat) {
            ...
            public void onEvent(String event, Bundle extras) throws RemoteException {
                this.mCallback.mHandler.post(new C01441(event, extras));
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat state) throws RemoteException {
                this.mCallback.mHandler.post(new C01452(state));
            }
        ...
        private void requestExtraBinder() {
            sendCommand(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER, null, new C01431(new Handler()));
        }
    }
