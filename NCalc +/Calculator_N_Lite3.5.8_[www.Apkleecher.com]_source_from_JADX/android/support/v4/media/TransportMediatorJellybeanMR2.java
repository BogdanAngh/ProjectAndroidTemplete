...
class TransportMediatorJellybeanMR2 {
    ...
    class C01351 implements OnWindowAttachListener {
        C01351() {
        }
    ...
    class C01362 implements OnWindowFocusChangeListener {
        C01362() {
        }
    ...
    class C01373 extends BroadcastReceiver {
        C01373() {
        }
    ...
    class C01384 implements OnAudioFocusChangeListener {
        C01384() {
        }
    ...
    class C01395 implements OnGetPlaybackPositionListener {
        C01395() {
        }
    ...
    class C01406 implements OnPlaybackPositionUpdateListener {
        C01406() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C01351();
        this.mWindowFocusListener = new C01362();
        this.mMediaButtonReceiver = new C01373();
        this.mAudioFocusChangeListener = new C01384();
        this.mGetPlaybackPositionListener = new C01395();
        this.mPlaybackPositionUpdateListener = new C01406();
        this.mPlayState = 0;
