...
class FadePort extends VisibilityPort {
    ...
    class C00651 extends TransitionListenerAdapter {
        boolean mCanceled;
        float mPausedAlpha;
    ...
    class C00662 extends AnimatorListenerAdapter {
        ...
        C00662(View view, View view2, int i, View view3, ViewGroup viewGroup) {
    ...
    class C00673 extends AnimatorListenerAdapter {
        boolean mCanceled;
        float mPausedAlpha;
        final /* synthetic */ View val$finalOverlayView;
        final /* synthetic */ ViewGroup val$finalSceneRoot;
        ...
        C00673(View view, View view2, int i, View view3, ViewGroup viewGroup) {
            this.val$finalView = view;
            this.val$finalViewToKeep = view2;
            this.val$finalVisibility = i;
            this.val$finalOverlayView = view3;
    ...
    public Animator onAppear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        addListener(new C00651(endView));
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (overlayView != null) {
            ...
            return createAnimation(view, 1.0f, 0.0f, new C00662(view, viewToKeep, finalVisibility, overlayView, sceneRoot));
        } else if (viewToKeep == null) {
            return null;
        } else {
            viewToKeep.setVisibility(0);
            return createAnimation(view, 1.0f, 0.0f, new C00673(view, viewToKeep, finalVisibility, overlayView, sceneRoot));
        }
    }
}
