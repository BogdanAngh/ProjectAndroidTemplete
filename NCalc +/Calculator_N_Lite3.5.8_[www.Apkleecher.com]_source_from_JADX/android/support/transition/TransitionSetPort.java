...
class TransitionSetPort extends TransitionPort {
    ...
    class C00721 extends TransitionListenerAdapter {
        final /* synthetic */ TransitionPort val$nextTransition;

        C00721(TransitionPort transitionPort) {
    ...
    protected void runAnimators() {
        ...
        for (int i = ORDERING_SEQUENTIAL; i < this.mTransitions.size(); i += ORDERING_SEQUENTIAL) {
            ((TransitionPort) this.mTransitions.get(i - 1)).addListener(new C00721((TransitionPort) this.mTransitions.get(i)));
        }
