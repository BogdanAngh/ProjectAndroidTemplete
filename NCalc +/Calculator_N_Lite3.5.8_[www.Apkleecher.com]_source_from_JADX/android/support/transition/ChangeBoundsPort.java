...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00611 extends TransitionListenerAdapter {
        boolean mCanceled;
    ...
    class C00622 extends TransitionListenerAdapter {
        boolean mCanceled;
    ...
    class C00633 extends AnimatorListenerAdapter {
        C00633() {
        }
    ...
    class C00644 extends AnimatorListenerAdapter {
        final /* synthetic */ BitmapDrawable val$drawable;
        final /* synthetic */ ViewGroup val$sceneRoot;
        final /* synthetic */ View val$view;

        C00644(ViewGroup viewGroup, BitmapDrawable bitmapDrawable, View view) {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
            ...
            if (numChanges > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (view.getParent() instanceof ViewGroup) {
                        ...
                        addListener(new C00622());
                    }
                    anim.addListener(new C00633());
                    return anim;
                }
                pvh = new PropertyValuesHolder[numChanges];
                if (startLeft != endLeft) {
        ...
        if (!(startX == endX && startY == endY)) {
            ...
            anim.addListener(new C00644(sceneRoot, drawable, view));
            return anim;
        }
        return null;
    }
