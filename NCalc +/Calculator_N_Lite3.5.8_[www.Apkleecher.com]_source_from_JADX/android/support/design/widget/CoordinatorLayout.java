...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00301 implements OnApplyWindowInsetsListener {
        C00301() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(C0000R.styleable.CoordinatorLayout_Layout_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = a.getResourceId(C0000R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0000R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.keyline = a.getInteger(C0000R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0000R.styleable.CoordinatorLayout_Layout_layout_insetEdge, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.dodgeInsetEdges = a.getInt(C0000R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, CoordinatorLayout.TYPE_ON_INTERCEPT);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00311());
        }
    }
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & R.styleable.AppCompatTheme_spinnerStyle;
        int anchorVgrav = absAnchorGravity & R.styleable.AppCompatTheme_spinnerStyle;
        ...
        for (int i = TYPE_ON_INTERCEPT; i < childCount; i += TYPE_ON_TOUCH) {
            ...
            if (type != 0 || child.getVisibility() != 8) {
                ...
                if (!(lp.insetEdge == 0 || drawRect.isEmpty())) {
                    ...
                    switch (absInsetEdge & R.styleable.AppCompatTheme_spinnerStyle) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C00301();
                }
