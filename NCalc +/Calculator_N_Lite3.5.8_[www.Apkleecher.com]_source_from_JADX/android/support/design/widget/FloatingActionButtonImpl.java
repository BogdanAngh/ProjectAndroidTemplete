...
abstract class FloatingActionButtonImpl {
    ...
    class C00371 implements OnPreDrawListener {
        C00371() {
        }
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(ContextCompat.getColor(context, C0000R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0000R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0000R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0000R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00371();
        }
    }
