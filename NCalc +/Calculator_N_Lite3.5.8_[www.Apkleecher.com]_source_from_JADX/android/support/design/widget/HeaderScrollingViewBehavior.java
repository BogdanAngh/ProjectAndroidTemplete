    ...
    public boolean onMeasureChild(CoordinatorLayout parent, View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
        ...
        if (childLpHeight == -1 || childLpHeight == -2) {
            ...
            if (header != null) {
                ...
                parent.onMeasureChild(child, parentWidthMeasureSpec, widthUsed, MeasureSpec.makeMeasureSpec((availableHeight - header.getMeasuredHeight()) + getScrollRange(header), childLpHeight == -1 ? Ints.MAX_POWER_OF_TWO : RtlSpacingHelper.UNDEFINED), heightUsed);
                return true;
            }
        }
        return false;
