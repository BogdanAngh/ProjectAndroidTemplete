...
public class TabLayout extends HorizontalScrollView {
    ...
    class C00441 implements AnimatorUpdateListener {
        C00441() {
        }
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C00451 implements AnimatorUpdateListener {
            ...
            C00451(int i, int i2, int i3, int i4) {
        ...
        class C00462 extends AnimatorListenerAdapter {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MeasureSpec.getMode(widthMeasureSpec) == Ints.MAX_POWER_OF_TWO && TabLayout.this.mMode == TabLayout.MODE_FIXED && TabLayout.this.mTabGravity == TabLayout.MODE_FIXED) {
                int i;
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.addUpdateListener(new C00451(startLeft, targetLeft, startRight, targetRight));
                animator.addListener(new C00462(position));
                animator.start();
            }
        }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabMaxWidth = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0248R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0248R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
            this.mTabTextColors = ta.getColorStateList(C0248R.styleable.TextAppearance_android_textColor);
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.addUpdateListener(new C00441());
                }
    ...
    private int calculateScrollXForTab(int position, float positionOffset) {
        ...
        return ((selectedChild.getLeft() + ((int) ((((float) (selectedWidth + nextWidth)) * positionOffset) * GenVectorModul.DEFAULT_DENSITY))) + (selectedChild.getWidth() / 2)) - (getWidth() / 2);
    }
