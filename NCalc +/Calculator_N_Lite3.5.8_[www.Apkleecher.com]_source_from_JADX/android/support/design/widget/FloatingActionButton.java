...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class C00321 implements InternalVisibilityChangedListener {
        final /* synthetic */ OnVisibilityChangedListener val$listener;

        C00321(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(C0000R.styleable.FloatingActionButton_backgroundTintMode, SIZE_AUTO), null);
        this.mRippleColor = a.getColor(C0000R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0000R.styleable.FloatingActionButton_fabSize, SIZE_AUTO);
