...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00252 extends AccessibilityDelegateCompat {
        C00252() {
        }
    ...
    class C00263 extends BottomSheetCallback {
        C00263() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C00263();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        coordinator.findViewById(C0000R.id.touch_outside).setOnClickListener(new C00241());
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C00252());
        return coordinator;
    }
