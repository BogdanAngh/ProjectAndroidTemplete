...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00281 implements OnApplyWindowInsetsListener {
        C00281() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0248R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00281());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00292());
