...
class ValueAnimatorCompatImplHoneycombMr1 extends Impl {
    ...
    class C00561 implements AnimatorUpdateListener {
        ...
        C00561(AnimatorUpdateListenerProxy animatorUpdateListenerProxy) {
    ...
    class C00572 extends AnimatorListenerAdapter {
        ...
        C00572(AnimatorListenerProxy animatorListenerProxy) {
    ...
    public void addUpdateListener(AnimatorUpdateListenerProxy updateListener) {
        this.mValueAnimator.addUpdateListener(new C00561(updateListener));
    }

    public void addListener(AnimatorListenerProxy listener) {
        this.mValueAnimator.addListener(new C00572(listener));
    }
