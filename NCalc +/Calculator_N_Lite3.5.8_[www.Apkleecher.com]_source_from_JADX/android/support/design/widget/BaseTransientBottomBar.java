...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static class C00101 implements Callback {
        C00101() {
        }
    ...
    class C00112 implements OnApplyWindowInsetsListener {
        C00112() {
        }
    ...
    class C00123 implements Callback {
        C00123() {
        }
    ...
    class C00134 implements OnDismissListener {
        C00134() {
        }
    ...
    class C00155 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C00141());
            }
        }
    }
    ...
    class C00166 implements OnLayoutChangeListener {
        C00166() {
        }
    ...
    class C00177 extends ViewPropertyAnimatorListenerAdapter {
        C00177() {
        }
    ...
    class C00188 implements AnimationListener {
        C00188() {
        }
    ...
    class C00199 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ int val$event;
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            if (a.hasValue(C0000R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C0000R.styleable.SnackbarLayout_elevation, BaseTransientBottomBar.LENGTH_LONG));
            }
            a.recycle();
            setClickable(true);
        }
    ...
    static {
        sHandler = new Handler(Looper.getMainLooper(), new C00101());
    }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        this.mManagerCallback = new C00123();
        if (parent == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0000R.layout.design_layout_snackbar, this.mTargetParent, false);
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C00112());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C00134());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C00155());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C00166());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C00177()).start();
            return;
        }
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0000R.anim.design_snackbar_in);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new C00188());
        this.mView.startAnimation(anim);
    }

    private void animateViewOut(int event) {
        if (VERSION.SDK_INT >= 14) {
            ViewCompat.animate(this.mView).translationY((float) this.mView.getHeight()).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C00199(event)).start();
            return;
        }
        Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0000R.anim.design_snackbar_out);
        anim.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        anim.setDuration(250);
        anim.setAnimationListener(new 10(event));
        this.mView.startAnimation(anim);
    }
