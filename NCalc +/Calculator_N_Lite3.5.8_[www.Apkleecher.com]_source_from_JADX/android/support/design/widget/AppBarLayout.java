...
public class AppBarLayout extends LinearLayout {
    ...
    class C00071 implements OnApplyWindowInsetsListener {
        C00071() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C00081 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C00081(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            static class C00091 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C00091() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C00091());
            }
        }
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            ...
            if (currentOffset != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.addUpdateListener(new C00081(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setBackground(this, a.getDrawable(C0000R.styleable.AppBarLayout_android_background));
        ...
        a.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00071());
    }
