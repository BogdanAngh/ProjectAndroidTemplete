...
class ValueAnimatorCompat {
    ...
    class C00531 implements AnimatorUpdateListenerProxy {
        final /* synthetic */ AnimatorUpdateListener val$updateListener;

        C00531(AnimatorUpdateListener animatorUpdateListener) {
    ...
    class C00542 implements AnimatorListenerProxy {
        final /* synthetic */ AnimatorListener val$listener;

        C00542(AnimatorListener animatorListener) {
    ...
    public void addUpdateListener(AnimatorUpdateListener updateListener) {
        if (updateListener != null) {
            this.mImpl.addUpdateListener(new C00531(updateListener));
        } else {
    ...
    public void addListener(AnimatorListener listener) {
        if (listener != null) {
            this.mImpl.addListener(new C00542(listener));
        } else {
