...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    class C00401 implements OnClickListener {
        ...
        C00401(OnClickListener onClickListener) {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence text, int duration) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(C0000R.layout.design_layout_snackbar_include, parent, false);
    ...
    public Snackbar setAction(CharSequence text, OnClickListener listener) {
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setText(text);
            tv.setOnClickListener(new C00401(listener));
        }
        return this;
    }
