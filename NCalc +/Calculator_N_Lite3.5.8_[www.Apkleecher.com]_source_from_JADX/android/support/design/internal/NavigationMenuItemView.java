...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C00021 extends AccessibilityDelegateCompat {
        C00021() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C00021();
        setOrientation(0);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0248R.attr.colorControlHighlight, value, true)) {
            return null;
        }
    ...
    public void setCheckable(boolean checkable) {
        ...
        if (this.mCheckable != checkable) {
            ...
            this.mAccessibilityDelegate.sendAccessibilityEvent(this.mTextView, IExpr.METHODSYMBOLID);
        }
    }
