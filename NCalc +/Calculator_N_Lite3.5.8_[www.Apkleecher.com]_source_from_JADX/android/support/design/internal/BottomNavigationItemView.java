...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0000R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0000R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0000R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0000R.layout.design_bottom_navigation_item, this, true);
        ...
        this.mSmallLabel = (TextView) findViewById(C0000R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0000R.id.largeLabel);
    }
    ...
    public void setChecked(boolean checked) {
        ...
        if (this.mShiftingMode) {
            if (checked) {
                ...
                ViewCompat.setScaleX(this.mLargeLabel, GenVectorModul.DEFAULT_DENSITY);
                ViewCompat.setScaleY(this.mLargeLabel, GenVectorModul.DEFAULT_DENSITY);
            }
