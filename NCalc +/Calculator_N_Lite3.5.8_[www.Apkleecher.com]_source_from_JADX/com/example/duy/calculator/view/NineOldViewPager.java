...
public class NineOldViewPager extends ViewGroup {
    ...
    private static final int MIN_DISTANCE_FOR_FLING = 16;
    ...
    class 3 implements Runnable {
        ...
        public void run() {
            NineOldViewPager.this.setScrollState(NineOldViewPager.SCROLL_STATE_IDLE);
            NineOldViewPager.this.populate();
        }
    }
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams() {
            super(NineOldViewPager.INVALID_POINTER, NineOldViewPager.INVALID_POINTER);
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.widthFactor = 0.0f;
            TypedArray a = context.obtainStyledAttributes(attrs, NineOldViewPager.LAYOUT_ATTRS);
            this.gravity = a.getInteger(NineOldViewPager.SCROLL_STATE_IDLE, 48);
            a.recycle();
        }
    }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == StaticSettings.MAX_FILE_BUFFER_SIZE && NineOldViewPager.this.mAdapter != null) {
                recordCompat.setItemCount(NineOldViewPager.this.mAdapter.getCount());
                recordCompat.setFromIndex(NineOldViewPager.this.mCurItem);
                recordCompat.setToIndex(NineOldViewPager.this.mCurItem);
            }
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (NineOldViewPager.this.canScrollHorizontally(NineOldViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction((int) StaticSettings.MAX_FILE_BUFFER_SIZE);
            }
            if (NineOldViewPager.this.canScrollHorizontally(NineOldViewPager.INVALID_POINTER)) {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            if (super.performAccessibilityAction(host, action, args)) {
                return NineOldViewPager.USE_CACHE;
            }
            switch (action) {
                case StaticSettings.MAX_FILE_BUFFER_SIZE /*4096*/:
                    if (!NineOldViewPager.this.canScrollHorizontally(NineOldViewPager.SCROLL_STATE_DRAGGING)) {
                        return NineOldViewPager.DEBUG;
                    }
                    NineOldViewPager.this.setCurrentItem(NineOldViewPager.this.mCurItem + NineOldViewPager.SCROLL_STATE_DRAGGING);
                    return NineOldViewPager.USE_CACHE;
                case AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD /*8192*/:
                    if (!NineOldViewPager.this.canScrollHorizontally(NineOldViewPager.INVALID_POINTER)) {
                        return NineOldViewPager.DEBUG;
                    }
                    NineOldViewPager.this.setCurrentItem(NineOldViewPager.this.mCurItem + NineOldViewPager.INVALID_POINTER);
                    return NineOldViewPager.USE_CACHE;
                default:
                    return NineOldViewPager.DEBUG;
            }
        ...
        private boolean canScroll() {
            return (NineOldViewPager.this.mAdapter == null || NineOldViewPager.this.mAdapter.getCount() <= NineOldViewPager.SCROLL_STATE_DRAGGING) ? NineOldViewPager.DEBUG : NineOldViewPager.USE_CACHE;
        }
    }
    ...
    private class PagerObserver extends DataSetObserver {
        ...
        public void onChanged() {
            NineOldViewPager.this.dataSetChanged();
        }
    ...
    static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View lhs, View rhs) {
            ...
            if (llp.isDecor != rlp.isDecor) {
                return llp.isDecor ? NineOldViewPager.SCROLL_STATE_DRAGGING : NineOldViewPager.INVALID_POINTER;
            } else {
    ...
    void initViewPager() {
        ...
        this.mFlingDistance = (int) (16.0f * density);
    ...
    private void setScrollState(int newState) {
        if (this.mScrollState != newState) {
            ...
            if (this.mPageTransformer != null) {
                enableLayers(newState != 0 ? USE_CACHE : DEBUG);
            }
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        if (this.mAdapter != null) {
            ...
            if (this.mRestoredCurItem >= 0) {
                ...
                setCurrentItemInternal(this.mRestoredCurItem, DEBUG, USE_CACHE);
                this.mRestoredCurItem = INVALID_POINTER;
                this.mRestoredAdapterState = null;
                this.mRestoredClassLoader = null;
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        boolean dispatchSelected = USE_CACHE;
        if (this.mAdapter == null || this.mAdapter.getCount() <= 0) {
            ...
            if (item > this.mCurItem + pageLimit || item < this.mCurItem - pageLimit) {
                for (int i = SCROLL_STATE_IDLE; i < this.mItems.size(); i += SCROLL_STATE_DRAGGING) {
                    ((ItemInfo) this.mItems.get(i)).scrolling = USE_CACHE;
                }
            }
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        ...
        if (transformer != null) {
            hasTransformer = USE_CACHE;
        } else {
            hasTransformer = DEBUG;
        }
        if (this.mPageTransformer != null) {
        ...
        boolean needsPopulate = hasTransformer != z ? USE_CACHE : DEBUG;
    ...
    public void setPageMarginDrawable(Drawable d) {
        ...
        setWillNotDraw(d == null ? USE_CACHE : DEBUG);
        invalidate();
    }
    ...
    protected boolean verifyDrawable(Drawable who) {
        return (super.verifyDrawable(who) || who == this.mMarginDrawable) ? USE_CACHE : DEBUG;
    }
    ...
    float distanceInfluenceForSnapDuration(float f) {
        return (float) Math.sin((double) ((float) (((double) (f - GenVectorModul.DEFAULT_DENSITY)) * 0.4712389167638204d)));
    }
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        int duration;
        setScrollingCacheEnabled(USE_CACHE);
    ...
    void dataSetChanged() {
        ...
        if (needPopulate) {
            ...
            setCurrentItemInternal(newCurrItem, DEBUG, USE_CACHE);
            requestLayout();
        }
    }
    ...
    L_0x0117:
        ...
        r0 = r27;
        r17 = r0.get(r8);
        r17 = (com.example.duy.calculator.view.NineOldViewPager.ItemInfo) r17;
        r0 = r17;
        r0 = r0.position;
        r27 = r0;
        r0 = r30;
    ...
    L_0x0164:
        ...
        r1 = r18;
        r27 = r0.get(r1);
        r27 = (com.example.duy.calculator.view.NineOldViewPager.ItemInfo) r27;
        r17 = r27;
    L_0x0176:
    ...
    L_0x0215:
        ...
        r20 = (com.example.duy.calculator.view.NineOldViewPager.LayoutParams) r20;
        r0 = r16;
        r1 = r20;
        r1.childIndex = r0;
        r0 = r20;
    ...
    L_0x048c:
        ...
        goto L_0x0441;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.example.duy.calculator.view.NineOldViewPager.populate(int):void");
    }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        if (state instanceof SavedState) {
            ...
            if (this.mAdapter != null) {
                ...
                setCurrentItemInternal(ss.position, DEBUG, USE_CACHE);
                return;
            }
    ...
    public void addView(View child, int index, android.view.ViewGroup.LayoutParams params) {
        ...
        if (child.getVisibility() != 8) {
            ...
            child.setDrawingCacheEnabled(DEBUG);
        }
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    com.example.duy.calculator.view.NineOldViewPager.ItemInfo infoForAnyChild(android.view.View r3) {
        /*
        r2 = this;
    L_0x0000:
        r0 = r3.getParent();
    ...
    L_0x0012:
        ...
        goto L_0x000d;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.example.duy.calculator.view.NineOldViewPager.infoForAnyChild(android.view.View):com.example.duy.calculator.view.NineOldViewPager$ItemInfo");
    }
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    boolean consumeVertical = (vgrav == 48 || vgrav == 80) ? USE_CACHE : DEBUG;
                    boolean consumeHorizontal = (hgrav == 3 || hgrav == 5) ? USE_CACHE : DEBUG;
                    if (consumeVertical) {
        ...
        for (i = SCROLL_STATE_IDLE; i < count; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case MIN_DISTANCE_FOR_FLING /*16*/:
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), Ints.MAX_POWER_OF_TWO);
                            child.measure(widthSpec, MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
    ...
    private boolean isGutterDrag(float x, float dx) {
        return ((x >= ((float) this.mGutterSize) || dx <= 0.0f) && (x <= ((float) (getWidth() - this.mGutterSize)) || dx >= 0.0f)) ? DEBUG : USE_CACHE;
    }
        ...
        switch (action) {
            case SCROLL_STATE_IDLE /*0*/:
                ...
                if (this.mScrollState == SCROLL_STATE_SETTLING && Math.abs(this.mScroller.getFinalX() - this.mScroller.getCurrX()) > this.mCloseEnough) {
                    ...
                    this.mPopulatePending = DEBUG;
                    populate();
                    this.mIsBeingDragged = USE_CACHE;
                    requestParentDisallowInterceptTouchEvent(USE_CACHE);
            ...
            case SCROLL_STATE_SETTLING /*2*/:
                ...
                if (activePointerId != INVALID_POINTER) {
                    ...
                    if (dx == 0.0f || isGutterDrag(this.mLastMotionX, dx) || !canScroll(this, DEBUG, (int) dx, (int) x2, (int) y)) {
                        if (xDiff > ((float) this.mTouchSlop) && GenVectorModul.DEFAULT_DENSITY * xDiff > yDiff) {
                            this.mIsBeingDragged = USE_CACHE;
                            requestParentDisallowInterceptTouchEvent(USE_CACHE);
                            setScrollState(SCROLL_STATE_DRAGGING);
                            ...
                            this.mIsUnableToDrag = USE_CACHE;
                        }
                ...
                switch (action & MotionEventCompat.ACTION_MASK) {
                    ...
                    case SCROLL_STATE_DRAGGING /*1*/:
                        if (this.mIsBeingDragged) {
                            ...
                            velocityTracker.computeCurrentVelocity(EmpiricalDistribution.DEFAULT_BIN_COUNT, (float) this.mMaximumVelocity);
                            int initialVelocity = (int) VelocityTrackerCompat.getXVelocity(velocityTracker, this.mActivePointerId);
                            this.mPopulatePending = USE_CACHE;
                            int width = getClientWidth();
                            int scrollX = getScrollX();
                            ItemInfo ii = infoForCurrentScrollPosition();
                            int currentPage = ii.position;
                            ...
                            setCurrentItemInternal(determineTargetPage(currentPage, pageOffset, initialVelocity, (int) (MotionEventCompat.getX(ev, activePointerIndex) - this.mInitialMotionX)), USE_CACHE, USE_CACHE, initialVelocity);
                            this.mActivePointerId = INVALID_POINTER;
                            endDrag();
                    ...
                    case SCROLL_STATE_SETTLING /*2*/:
                        if (!this.mIsBeingDragged) {
                            ...
                            if (xDiff > ((float) this.mTouchSlop) && xDiff > yDiff) {
                                ...
                                if (parent != null) {
                                    parent.requestDisallowInterceptTouchEvent(USE_CACHE);
                                }
                            }
                        }
                        if (this.mIsBeingDragged) {
                    ...
                    case ValueServer.EXPONENTIAL_MODE /*3*/:
                        if (this.mIsBeingDragged) {
                            scrollToItem(this.mCurItem, USE_CACHE, SCROLL_STATE_IDLE, DEBUG);
                            this.mActivePointerId = INVALID_POINTER;
                            endDrag();
                            needsInvalidate = this.mLeftEdge.onRelease() | this.mRightEdge.onRelease();
                            break;
    ...
    private boolean performDrag(float x) {
        ...
        boolean leftAbsolute = USE_CACHE;
        boolean rightAbsolute = USE_CACHE;
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (((float) this.mPageMargin) + drawAt > ((float) scrollX)) {
                    this.mMarginDrawable.setBounds((int) drawAt, this.mTopPageBounds, (int) ((((float) this.mPageMargin) + drawAt) + GenVectorModul.DEFAULT_DENSITY), this.mBottomPageBounds);
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            ...
            int scrollX = getScrollX();
            ItemInfo ii = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(ii.position, ((((float) scrollX) / ((float) width)) - ii.offset) / ii.widthFactor, initialVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), USE_CACHE, USE_CACHE, initialVelocity);
            endDrag();
    ...
    private void setScrollingCacheEnabled(boolean enabled) {
        if (this.mScrollingCacheEnabled != enabled) {
            ...
            int size = getChildCount();
            for (int i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
                View child = getChildAt(i);
                if (child.getVisibility() != 8) {
        ...
        if (v instanceof ViewGroup) {
            ...
            for (int i = group.getChildCount() + INVALID_POINTER; i >= 0; i += INVALID_POINTER) {
                ...
                if (x + scrollX >= child.getLeft() && x + scrollX < child.getRight() && y + scrollY >= child.getTop() && y + scrollY < child.getBottom()) {
                    if (canScroll(child, USE_CACHE, dx, (x + scrollX) - child.getLeft(), (y + scrollY) - child.getTop())) {
                        return USE_CACHE;
                    }
                }
            }
        }
        return (checkV && ViewCompat.canScrollHorizontally(v, -dx)) ? USE_CACHE : DEBUG;
    }

    public boolean dispatchKeyEvent(KeyEvent event) {
        return (super.dispatchKeyEvent(event) || executeKeyEvent(event)) ? USE_CACHE : DEBUG;
    }
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case io.github.kexanie.library.R.styleable.ActionBar_contentInsetEnd /*21*/:
                return arrowScroll(17);
            case io.github.kexanie.library.R.styleable.Toolbar_collapseIcon /*22*/:
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (currentFocused == this) {
            ...
            for (NineOldViewPager parent = currentFocused.getParent(); parent instanceof ViewGroup; parent = parent.getParent()) {
                if (parent == this) {
                    isChild = USE_CACHE;
                    break;
                }
    ...
    boolean pageLeft() {
        ...
        setCurrentItem(this.mCurItem + INVALID_POINTER, USE_CACHE);
        return USE_CACHE;
    }
    ...
    boolean pageRight() {
        ...
        setCurrentItem(this.mCurItem + SCROLL_STATE_DRAGGING, USE_CACHE);
        return USE_CACHE;
    }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == StaticSettings.MAX_FILE_BUFFER_SIZE) {
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return ((p instanceof LayoutParams) && super.checkLayoutParams(p)) ? USE_CACHE : DEBUG;
    }
