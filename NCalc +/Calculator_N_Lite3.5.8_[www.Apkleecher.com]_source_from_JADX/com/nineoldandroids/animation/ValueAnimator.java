...
public class ValueAnimator extends Animator {
    ...
    static class 1 extends ThreadLocal<ArrayList<ValueAnimator>> {
        1() {
        }
    ...
    static class 2 extends ThreadLocal<ArrayList<ValueAnimator>> {
        2() {
        }
    ...
    static class 3 extends ThreadLocal<ArrayList<ValueAnimator>> {
        3() {
        }
    ...
    static class 4 extends ThreadLocal<ArrayList<ValueAnimator>> {
        4() {
        }
    ...
    static class 5 extends ThreadLocal<ArrayList<ValueAnimator>> {
        5() {
        }
    ...
    public void setIntValues(int... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                ...
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofInt(BuildConfig.FLAVOR, values);
    ...
    public void setFloatValues(float... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofFloat(BuildConfig.FLAVOR, values);
                setValues(propertyValuesHolderArr);
            } else {
    ...
    public void setObjectValues(Object... values) {
        if (values != null && values.length != 0) {
            if (this.mValues == null || this.mValues.length == 0) {
                PropertyValuesHolder[] propertyValuesHolderArr = new PropertyValuesHolder[RUNNING];
                propertyValuesHolderArr[ANIMATION_START] = PropertyValuesHolder.ofObject(BuildConfig.FLAVOR, (TypeEvaluator) null, values);
                setValues(propertyValuesHolderArr);
            } else {
