...
public class FirebaseInstanceId {
    ...
    static String zza(KeyPair keyPair) {
        try {
            ...
            digest[0] = (byte) (((digest[0] & 15) + R.styleable.AppCompatTheme_spinnerStyle) & MotionEventCompat.ACTION_MASK);
    ...
    @Nullable
    zza zzaad() {
        return this.zzciS.zzaag().zzq(BuildConfig.FLAVOR, this.zzciT, "*");
    }
