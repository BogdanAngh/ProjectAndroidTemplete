...
public class FirebaseInstanceIdService extends zzb {
    ...
    private void zzpS(int i) {
        ((AlarmManager) getSystemService(NotificationCompatApi24.CATEGORY_ALARM)).set(3, SystemClock.elapsedRealtime() + ((long) (i * EmpiricalDistribution.DEFAULT_BIN_COUNT)), zzg.zza(this, 0, zzpR(i * 2), 134217728));
    }
