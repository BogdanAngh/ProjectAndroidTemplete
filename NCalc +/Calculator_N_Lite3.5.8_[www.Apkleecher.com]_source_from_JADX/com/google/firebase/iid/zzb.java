...
public abstract class zzb extends Service {
    ...
    class 2 implements Runnable {
        ...
        2(zzb com_google_firebase_iid_zzb, Intent intent, Intent intent2) {
            this.zzciN = com_google_firebase_iid_zzb;
    ...
    public zzb() {
        this.zzbhh = new MessengerCompat(new 1(this, Looper.getMainLooper()));
    ...
    public final int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (zzF == null) {
            ...
            this.zzbFy.execute(new 2(this, zzF, intent));
            return 3;
        }
    }
