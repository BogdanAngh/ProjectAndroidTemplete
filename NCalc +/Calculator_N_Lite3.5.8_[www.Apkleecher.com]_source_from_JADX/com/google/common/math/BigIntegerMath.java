...
public final class BigIntegerMath {
    ...
    public static int log2(BigInteger x, RoundingMode mode) {
        MathPreconditions.checkPositive(UnivPowerSeriesRing.DEFAULT_NAME, (BigInteger) Preconditions.checkNotNull(x));
    ...
    static {
        ...
        LN_10 = Math.log(BOBYQAOptimizer.DEFAULT_INITIAL_RADIUS);
        LN_2 = Math.log(2.0d);
    }
