...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> {
    ...
    private static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        class 1 extends AbstractIterator<Entry<Cut<C>, Range<C>>> {
            ...
            1(Cut cut, PeekingIterator peekingIterator) {
        ...
        class 2 extends AbstractIterator<Entry<Cut<C>, Range<C>>> {
            Cut<C> nextComplementRangeUpperBound;
            final /* synthetic */ Cut val$firstComplementRangeUpperBound;
            final /* synthetic */ PeekingIterator val$positiveItr;

            2(Cut cut, PeekingIterator peekingIterator) {
        ...
        Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new 1(firstComplementRangeLowerBound, positiveItr);
        }
        ...
        Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new 2((Cut) Objects.firstNonNull(cut, Cut.aboveAll()), positiveItr);
        }
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        class 2 extends AbstractIterator<Entry<Cut<C>, Range<C>>> {
            ...
            2(PeekingIterator peekingIterator) {
    ...
    private static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        Iterator<Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            return new 1(completeRangeItr, (Cut) Ordering.natural().min(this.lowerBoundWindow.upperBound, Cut.belowValue(this.restriction.upperBound)));
        }
        ...
        Iterator<Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            return new 2(this.rangesByLowerBound.headMap(upperBoundOnLowerBounds.endpoint(), upperBoundOnLowerBounds.typeAsUpperBound() == BoundType.CLOSED).descendingMap().values().iterator());
        }
