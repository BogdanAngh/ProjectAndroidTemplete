...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> {
    ...
    public static final class Builder<B> {
        ...
        private Builder(Comparator<B> comparator) {
            this.expectedSize = UNSET_EXPECTED_SIZE;
            this.maximumSize = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
        ...
        public <T extends B> MinMaxPriorityQueue<T> create(Iterable<? extends T> initialContents) {
            MinMaxPriorityQueue<T> queue = new MinMaxPriorityQueue(MinMaxPriorityQueue.initialQueueSize(this.expectedSize, this.maximumSize, initialContents), null);
    ...
    public static Builder<Comparable> expectedSize(int expectedSize) {
        return new Builder(null).expectedSize(expectedSize);
    }

    public static Builder<Comparable> maximumSize(int maximumSize) {
        return new Builder(null).maximumSize(maximumSize);
    }
