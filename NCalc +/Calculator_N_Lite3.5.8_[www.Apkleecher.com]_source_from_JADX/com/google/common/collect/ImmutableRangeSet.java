...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    class 1 extends ImmutableList<Range<C>> {
        final /* synthetic */ int val$fromIndex;
        final /* synthetic */ int val$length;
        final /* synthetic */ Range val$range;

        1(int i, int i2, Range range) {
            this.val$length = i;
        ...
        public Range<C> get(int index) {
            ...
            if (index == 0 || index == this.val$length - 1) {
                return ((Range) ImmutableRangeSet.this.ranges.get(this.val$fromIndex + index)).intersection(this.val$range);
            }
            return (Range) ImmutableRangeSet.this.ranges.get(this.val$fromIndex + index);
        }
    ...
    private final class AsSet extends ImmutableSortedSet<C> {
        ...
        class 1 extends AbstractIterator<C> {
            Iterator<C> elemItr;
        ...
        class 2 extends AbstractIterator<C> {
            Iterator<C> elemItr;
            final Iterator<Range<C>> rangeItr;
    ...
    private ImmutableList<Range<C>> intersectRanges(Range<C> range) {
        ...
        return new 1(length, fromIndex, range);
    }
