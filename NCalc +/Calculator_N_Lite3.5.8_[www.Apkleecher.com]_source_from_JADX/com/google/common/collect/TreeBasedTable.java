...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class 1 implements Function<Map<C, V>, Iterator<C>> {
        1() {
        }
    ...
    class 2 extends AbstractIterator<C> {
        ...
        2(Iterator it, Comparator comparator) {
            this.val$merged = it;
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        return new 2(Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new 1()), comparator), comparator);
    }
}
