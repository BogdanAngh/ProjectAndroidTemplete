...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    private static final class MapViewOfValuesAsSingletonSets<K, V> extends ImmutableMap<K, ImmutableSet<V>> {
        ...
        class 1 extends ImmutableMapEntrySet<K, ImmutableSet<V>> {

            class 1 extends UnmodifiableIterator<Entry<K, ImmutableSet<V>>> {
                final /* synthetic */ Iterator val$backingIterator;

                class 1 extends AbstractMapEntry<K, ImmutableSet<V>> {
                ...
                public Entry<K, ImmutableSet<V>> next() {
                    return new 1((Entry) this.val$backingIterator.next());
                }
            }
            ...
            public UnmodifiableIterator<Entry<K, ImmutableSet<V>>> iterator() {
                return new 1(MapViewOfValuesAsSingletonSets.this.delegate.entrySet().iterator());
            }
        }
