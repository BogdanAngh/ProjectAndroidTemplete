...
final class Synchronized {
        ...
        class 1 extends ForwardingIterator<Entry<K, Collection<V>>> {
            ...
            class 1 extends ForwardingMapEntry<K, Collection<V>> {
                ...
                public Collection<V> getValue() {
                    return Synchronized.typePreservingCollection((Collection) this.val$entry.getValue(), SynchronizedAsMapEntries.this.mutex);
                }
            }
    ...
    private static <E> Collection<E> collection(Collection<E> collection, @Nullable Object mutex) {
        return new SynchronizedCollection(mutex, null);
    }
    ...
    static <K, V> BiMap<K, V> biMap(BiMap<K, V> bimap, @Nullable Object mutex) {
        return ((bimap instanceof SynchronizedBiMap) || (bimap instanceof ImmutableBiMap)) ? bimap : new SynchronizedBiMap(mutex, null, null);
    }
