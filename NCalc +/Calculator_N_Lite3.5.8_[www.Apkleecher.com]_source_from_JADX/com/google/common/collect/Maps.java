...
public final class Maps {
    ...
    static class 10 extends AbstractMapEntry<K, V2> {
        final /* synthetic */ Entry val$entry;
        final /* synthetic */ EntryTransformer val$transformer;

        10(Entry entry, EntryTransformer entryTransformer) {
    ...
    static class 11 implements Function<Entry<K, V1>, Entry<K, V2>> {
        final /* synthetic */ EntryTransformer val$transformer;

        11(EntryTransformer entryTransformer) {
            this.val$transformer = entryTransformer;
        }
    ...
    static class 1 extends UnmodifiableIterator<V> {
        final /* synthetic */ UnmodifiableIterator val$entryIterator;

        1(UnmodifiableIterator unmodifiableIterator) {
    ...
    static class 2 extends TransformedIterator<K, Entry<K, V>> {
        final /* synthetic */ Function val$function;

        2(Iterator x0, Function function) {
    ...
    static class 3 extends ForwardingSet<E> {
    ...
    static class 4 extends ForwardingSortedSet<E> {
        final /* synthetic */ SortedSet val$set;

        4(SortedSet sortedSet) {
    ...
    static class 5 extends ForwardingNavigableSet<E> {
        final /* synthetic */ NavigableSet val$set;

        5(NavigableSet navigableSet) {
    ...
    static class 6 extends AbstractMapEntry<K, V> {
        final /* synthetic */ Entry val$entry;
    ...
    static class 7 implements EntryTransformer<K, V1, V2> {
        final /* synthetic */ Function val$function;
    ...
    static class 8 implements Function<V1, V2> {
        final /* synthetic */ Object val$key;
        final /* synthetic */ EntryTransformer val$transformer;

        8(EntryTransformer entryTransformer, Object obj) {
            this.val$transformer = entryTransformer;
            this.val$key = obj;
        }
    ...
    static class 9 implements Function<Entry<K, V1>, V2> {
        final /* synthetic */ EntryTransformer val$transformer;

        9(EntryTransformer entryTransformer) {
            this.val$transformer = entryTransformer;
        }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Entry<K, V>> {
            ...
            class 1 extends TransformedIterator<Entry<K, V>, Entry<K, V>> {
            ...
            public Iterator<Entry<K, V>> iterator() {
                return new 1(FilteredEntryMap.this.filteredEntrySet.iterator());
            }
        }
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        static class 1 implements Predicate<Entry<V, K>> {
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V> {
        ...
        class 1 extends NavigableKeySet<K, V> {
            1(NavigableMap x0) {
                super(x0);
            }
