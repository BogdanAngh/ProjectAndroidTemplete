...
public final class Tables {
    ...
    static class 1 implements Function<Map<Object, Object>, Map<Object, Object>> {
        1() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class 1 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            1() {
            }
        ...
        class 2 implements Function<Map<C, V1>, Map<C, V2>> {
            2() {
            }
        ...
        class 3 implements Function<Map<R, V1>, Map<R, V2>> {
            3() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new 2());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new 3());
        }
    }
    ...
    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        static class 1 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            1() {
            }
