...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    class 1 extends AbstractIndexedListIterator<Cell<R, C, V>> {

        class 1 extends AbstractCell<R, C, V> {
    ...
    private static abstract class ArrayMap<K, V> extends ImprovedAbstractMap<K, V> {
        ...
        class 1 extends EntrySet<K, V> {
            ...
            class 1 extends AbstractIndexedListIterator<Entry<K, V>> {
                ...
                class 1 extends AbstractMapEntry<K, V> {
                    ...
                    public K getKey() {
                        return ArrayMap.this.getKey(this.val$index);
                    }

                    public V getValue() {
                        return ArrayMap.this.getValue(this.val$index);
                    }

                    public V setValue(V value) {
                        return ArrayMap.this.setValue(this.val$index, value);
                    }
                }
