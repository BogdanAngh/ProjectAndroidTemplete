...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
    ...
    static class 1 implements Function<Range, Cut> {
        1() {
        }
    ...
    static class 2 implements Function<Range, Cut> {
        2() {
        }
    ...
    static class 3 extends Ordering<Range<?>> {
        3() {
        }
    ...
    static {
        LOWER_BOUND_FN = new 1();
        UPPER_BOUND_FN = new 2();
        RANGE_LEX_ORDERING = new 3();
    ...
    public static <C extends Comparable<?>> Range<C> upTo(C endpoint, BoundType boundType) {
        switch (4.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()]) {
