...
public final class Multisets {
    ...
    static abstract class ElementSet<E> extends ImprovedAbstractSet<E> {
        ...
        class 1 extends TransformedIterator<Entry<E>, E> {
            1(Iterator x0) {
                super(x0);
            }
        ...
        public Iterator<E> iterator() {
            return new 1(multiset().entrySet().iterator());
        }
    ...
    static class 1 extends AbstractMultiset<E> {
        ...
        class 1 extends AbstractIterator<Entry<E>> {
            ...
            protected Entry<E> computeNext() {
                if (this.val$iterator1.hasNext()) {
                    Entry<? extends E> entry1 = (Entry) this.val$iterator1.next();
                    E element = entry1.getElement();
                    return Multisets.immutableEntry(element, Math.max(entry1.getCount(), 1.this.val$multiset2.count(element)));
                }
                while (this.val$iterator2.hasNext()) {
                    Entry<? extends E> entry2 = (Entry) this.val$iterator2.next();
                    element = entry2.getElement();
                    if (!1.this.val$multiset1.contains(element)) {
        ...
        1(Multiset multiset, Multiset multiset2) {
        ...
        Iterator<Entry<E>> entryIterator() {
            return new 1(this.val$multiset1.entrySet().iterator(), this.val$multiset2.entrySet().iterator());
        }
    ...
    static class 2 extends AbstractMultiset<E> {
        ...
        class 1 extends AbstractIterator<Entry<E>> {
            ...
            protected Entry<E> computeNext() {
                while (this.val$iterator1.hasNext()) {
                    ...
                    E element = entry1.getElement();
                    int count = Math.min(entry1.getCount(), 2.this.val$multiset2.count(element));
                    if (count > 0) {
        ...
        2(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
        ...
        Iterator<Entry<E>> entryIterator() {
            return new 1(this.val$multiset1.entrySet().iterator());
        }
    ...
    static class 3 extends AbstractMultiset<E> {
        final /* synthetic */ Multiset val$multiset1;
        final /* synthetic */ Multiset val$multiset2;
        ...
        class 1 extends AbstractIterator<Entry<E>> {
            ...
            protected Entry<E> computeNext() {
                if (this.val$iterator1.hasNext()) {
                    Entry<? extends E> entry1 = (Entry) this.val$iterator1.next();
                    E element = entry1.getElement();
                    return Multisets.immutableEntry(element, entry1.getCount() + 3.this.val$multiset2.count(element));
                }
                while (this.val$iterator2.hasNext()) {
                    Entry<? extends E> entry2 = (Entry) this.val$iterator2.next();
                    element = entry2.getElement();
                    if (!3.this.val$multiset1.contains(element)) {
                        return Multisets.immutableEntry(element, entry2.getCount());
                    }
                }
                return (Entry) endOfData();
        ...
        3(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
    ...
    static class 4 extends AbstractMultiset<E> {
        final /* synthetic */ Multiset val$multiset1;
        final /* synthetic */ Multiset val$multiset2;
        ...
        class 1 extends AbstractIterator<Entry<E>> {
            ...
            protected Entry<E> computeNext() {
                while (this.val$iterator1.hasNext()) {
                    Entry<E> entry1 = (Entry) this.val$iterator1.next();
                    E element = entry1.getElement();
                    int count = entry1.getCount() - 4.this.val$multiset2.count(element);
                    if (count > 0) {
                        return Multisets.immutableEntry(element, count);
                    }
                }
        ...
        4(Multiset multiset, Multiset multiset2) {
            this.val$multiset1 = multiset;
            this.val$multiset2 = multiset2;
        }
    ...
    static class 5 extends Ordering<Entry<?>> {
        5() {
        }
    ...
    private static final class FilteredMultiset<E> extends AbstractMultiset<E> {
        ...
        class 1 implements Predicate<Entry<E>> {
            1() {
            }
        ...
        Set<Entry<E>> createEntrySet() {
            return Sets.filter(this.unfiltered.entrySet(), new 1());
        }
    ...
    static {
        DECREASING_COUNT_ORDERING = new 5();
    }
