...
public final class Multimaps {
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        class 1 extends TransformedIterator<Entry<K, Collection<V>>, Multiset.Entry<K>> {

            class 1 extends AbstractEntry<K> {
            ...
            Multiset.Entry<K> transform(Entry<K, Collection<V>> backingEntry) {
                return new 1(backingEntry);
            }
        }
    ...
    static final class AsMap<K, V> extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends EntrySet<K, Collection<V>> {
            ...
            class 1 implements Function<K, Collection<V>> {
                1() {
                }
            ...
            public Iterator<Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new 1());
            }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        class 1 extends ImprovedAbstractSet<V> {
            ...
            class 1 implements Iterator<V> {
                ...
                public boolean hasNext() {
                    return this.i == 0 && MapMultimap.this.map.containsKey(1.this.val$key);
                }

                public V next() {
                    if (hasNext()) {
                        this.i++;
                        return MapMultimap.this.map.get(1.this.val$key);
                    }
                ...
                public void remove() {
                    ...
                    this.i = -1;
                    MapMultimap.this.map.remove(1.this.val$key);
                }
            }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        class 1 implements EntryTransformer<K, Collection<V1>, Collection<V2>> {
            1() {
            }
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new 1());
        }
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        class 1 implements Function<Collection<V>, Collection<V>> {
            1() {
            }
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            result = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new 1()));
            this.map = result;
            return result;
        }
