...
public final class Lists {
    ...
    static class 1 extends RandomAccessListWrapper<E> {
    ...
    static class 2 extends AbstractListWrapper<E> {
        private static final long serialVersionUID = 0;
    ...
    private static class ReverseList<T> extends AbstractList<T> {
        ...
        public ListIterator<T> listIterator(int index) {
            return new 1(this.forwardList.listIterator(reversePosition(index)));
        }
    }
    ...
    private static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        class 1 extends TransformedListIterator<F, T> {
            1(ListIterator x0) {
                super(x0);
            }
        ...
        public ListIterator<T> listIterator(int index) {
            return new 1(this.fromList.listIterator(index));
        }
