...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V> {
    ...
    class AsMap extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        class 1 extends KeySet<K, Collection<V>> {
            1(Map x0) {
                super(x0);
            }
        ...
        class 2 extends EntrySet<K, Collection<V>> {

            class 1 extends AbstractIterator<Entry<K, Collection<V>>> {
        ...
        class 3 extends Values<K, Collection<V>> {
            3(Map x0) {
                super(x0);
            }
    ...
    class Keys extends Keys<K, V> {
        ...
        class 1 extends EntrySet<K> {

            class 1 implements Predicate<Entry<K, Collection<V>>> {
            ...
            private boolean removeEntriesIf(Predicate<? super Multiset.Entry<K>> predicate) {
                return FilteredEntryMultimap.this.removeEntriesIf(new 1(predicate));
            }
