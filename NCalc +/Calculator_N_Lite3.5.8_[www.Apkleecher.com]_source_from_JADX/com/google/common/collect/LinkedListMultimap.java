...
public class LinkedListMultimap<K, V> extends AbstractMultimap<K, V> implements ListMultimap<K, V>, Serializable {
    ...
    class 1 extends AbstractSequentialList<V> {
        ...
        public int size() {
            KeyList<K, V> keyList = (KeyList) LinkedListMultimap.this.keyToKeyList.get(this.val$key);
    ...
    class 2 extends ImprovedAbstractSet<K> {
        2() {
        }
    ...
    class 3 extends AbstractSequentialList<V> {

        class 1 extends TransformedListIterator<Entry<K, V>, V> {
            final /* synthetic */ NodeIterator val$nodeItr;

            1(ListIterator x0, NodeIterator nodeIterator) {
        ...
        public ListIterator<V> listIterator(int index) {
            ...
            return new 1(nodeItr, nodeItr);
        }
    }

    class 4 extends AbstractSequentialList<Entry<K, V>> {
        4() {
        }
