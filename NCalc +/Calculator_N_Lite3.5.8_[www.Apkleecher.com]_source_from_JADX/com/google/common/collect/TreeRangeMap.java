...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    static class 1 implements RangeMap {
        1() {
        }
    ...
    private final class AsMapOfRanges extends AbstractMap<Range<K>, V> {
        ...
        class 1 extends AbstractSet<Entry<Range<K>, V>> {
            1() {
            }
    ...
    private class SubRangeMap implements RangeMap<K, V> {
        ...
        class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            class 1 extends KeySet<Range<K>, V> {
                1(Map x0) {
                    super(x0);
                }
            ...
            class 2 extends EntrySet<Range<K>, V> {

                class 1 extends AbstractIterator<Entry<Range<K>, V>> {
                    ...
                    protected Entry<Range<K>, V> computeNext() {
                        while (this.val$backingItr.hasNext()) {
                            RangeMapEntry<K, V> entry = (RangeMapEntry) this.val$backingItr.next();
                ...
                public Iterator<Entry<Range<K>, V>> iterator() {
                    ...
                    return new 1(TreeRangeMap.this.entriesByLowerBound.tailMap((Cut) Objects.firstNonNull(TreeRangeMap.this.entriesByLowerBound.floorKey(SubRangeMap.this.subRange.lowerBound), SubRangeMap.this.subRange.lowerBound), true).values().iterator());
                }
            ...
            class 3 extends Values<Range<K>, V> {
                3(Map x0) {
                    super(x0);
                }
