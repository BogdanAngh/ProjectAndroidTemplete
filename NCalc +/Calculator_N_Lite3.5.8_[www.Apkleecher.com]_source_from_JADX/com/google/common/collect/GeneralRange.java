...
final class GeneralRange<T> implements Serializable {
    ...
    public String toString() {
        return this.comparator + ":" + (this.lowerBoundType == BoundType.CLOSED ? '[' : Constants.LEFT_PAREN) + (this.hasLowerBound ? this.lowerEndpoint : "-\u221e") + Letters.COMMA + (this.hasUpperBound ? this.upperEndpoint : "\u221e") + (this.upperBoundType == BoundType.CLOSED ? ']' : Constants.RIGHT_PAREN);
    }
