...
final class RegularContiguousSet<C extends Comparable> extends ContiguousSet<C> {
    ...
    class 1 extends AbstractSequentialIterator<C> {
        final C last;
    ...
    class 2 extends AbstractSequentialIterator<C> {
        final C first;
    ...
    public int size() {
        ...
        return distance >= 2147483647L ? BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT : ((int) distance) + 1;
    }
