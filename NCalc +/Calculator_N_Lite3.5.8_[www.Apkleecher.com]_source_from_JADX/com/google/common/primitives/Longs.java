...
public final class Longs {
    ...
    public static long fromByteArray(byte[] bytes) {
        ...
        Preconditions.checkArgument(z, "array too small: %s < %s", Integer.valueOf(bytes.length), Integer.valueOf(BYTES));
        return fromBytes(bytes[0], bytes[1], bytes[2], bytes[3], bytes[4], bytes[5], bytes[6], bytes[7]);
    }

    public static long fromBytes(byte b1, byte b2, byte b3, byte b4, byte b5, byte b6, byte b7, byte b8) {
        return ((((((((((long) b1) & 255) << 56) | ((((long) b2) & 255) << 48)) | ((((long) b3) & 255) << 40)) | ((((long) b4) & 255) << 32)) | ((((long) b5) & 255) << 24)) | ((((long) b6) & 255) << 16)) | ((((long) b7) & 255) << BYTES)) | (((long) b8) & 255);
    }
    ...
    public static Long tryParse(String string) {
        ...
        boolean negative;
        if (string.charAt(0) == Constants.MINUS_UNICODE) {
            negative = true;
        } else {
            negative = false;
        }
