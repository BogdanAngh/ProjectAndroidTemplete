...
public final class DynamiteModule {
    ...
    class 9 extends PathClassLoader {
        9(String str, ClassLoader classLoader) {
            ...
            if (DynamiteLoaderClassLoader.sClassLoader != null) {
                ...
                synchronized (loadClass) {
                    ...
                    if (DynamiteLoaderClassLoader.sClassLoader != null) {
                        ...
                        DynamiteLoaderClassLoader.sClassLoader = new 9(str, ClassLoader.getSystemClassLoader());
    ...
    public static DynamiteModule zza(Context context, zzb com_google_android_gms_dynamite_DynamiteModule_zzb, String str) throws zza {
        if (com.google.android.gms.common.zze.GOOGLE_PLAY_SERVICES_PACKAGE.equals(context.getApplicationContext().getPackageName())) {
        ...
        if (zza.zzaQF == 0 || ((zza.zzaQF == -1 && zza.zzaQD == 0) || (zza.zzaQF == 1 && zza.zzaQE == 0))) {
            ...
            if (zza.zzaQF == 1) {
                try {
                    ...
                    Log.w(str2, valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3));
                    if (zza.zzaQD != 0 && com_google_android_gms_dynamite_DynamiteModule_zzb.zza(context, str, new 8(zza.zzaQD)).zzaQF == -1) {
                        return zzC(context, str);
                    }
    ...
    private static zza zzaU(Context context) {
        synchronized (DynamiteModule.class) {
            ...
            if (zzaQr != null) {
                ...
                try {
                    com_google_android_gms_dynamite_zza = com.google.android.gms.dynamite.zza.zza.zzce((IBinder) context.createPackageContext(com.google.android.gms.common.zze.GOOGLE_PLAY_SERVICES_PACKAGE, 3).getClassLoader().loadClass("com.google.android.gms.chimera.container.DynamiteLoaderImpl").newInstance());
