...
public final class zzatd {
    ...
    static {
        ...
        zzbrc = zza.zzB("measurement.upload.max_batch_size", AccessibilityNodeInfoCompat.ACTION_CUT);
        zzbrd = zza.zzB("measurement.upload.max_bundle_size", AccessibilityNodeInfoCompat.ACTION_CUT);
        zzbre = zza.zzB("measurement.upload.max_events_per_bundle", EmpiricalDistribution.DEFAULT_BIN_COUNT);
        zzbrf = zza.zzB("measurement.upload.max_events_per_day", 100000);
        zzbrg = zza.zzB("measurement.upload.max_error_events_per_day", EmpiricalDistribution.DEFAULT_BIN_COUNT);
        ...
        zzbrz = zza.zzB("measurement.audience.filter_result_max_count", AnimationUtil.DEFAULT_SHRINK_GROW_DURATION);
