...
public final class zzbum {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(R.styleable.AppCompatTheme_ratingBarStyle).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    private static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i3 < length) {
            ...
            if (charAt2 < '\u0080' && i5 < i4) {
                ...
                i6 = r6 + 1;
                bArr[r6] = (byte) ((charAt2 & 63) | IExpr.SYMBOLID);
            } else if ((charAt2 < '\ud800' || '\udfff' < charAt2) && i5 <= i4 - 3) {
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 >>> 12) | 480);
                i5 = i6 + 1;
                bArr[i6] = (byte) (((charAt2 >>> 6) & 63) | IExpr.SYMBOLID);
                i6 = i5 + 1;
                bArr[i5] = (byte) ((charAt2 & 63) | IExpr.SYMBOLID);
            } else if (i5 <= i4 - 4) {
                if (i3 + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt2, charAt)) {
                        ...
                        i5 = i6 + 1;
                        bArr[i6] = (byte) (((toCodePoint >>> 12) & 63) | IExpr.SYMBOLID);
                        r6 = i5 + 1;
                        bArr[i5] = (byte) (((toCodePoint >>> 6) & 63) | IExpr.SYMBOLID);
                        i6 = r6 + 1;
                        bArr[r6] = (byte) ((toCodePoint & 63) | IExpr.SYMBOLID);
                    }
                }
    ...
    private static void zzb(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        while (i < length) {
            ...
            if (charAt < '\u0080') {
                ...
                byteBuffer.put((byte) ((charAt & 63) | IExpr.SYMBOLID));
            } else if (charAt < '\ud800' || '\udfff' < charAt) {
                byteBuffer.put((byte) ((charAt >>> 12) | 480));
                byteBuffer.put((byte) (((charAt >>> 6) & 63) | IExpr.SYMBOLID));
                byteBuffer.put((byte) ((charAt & 63) | IExpr.SYMBOLID));
            } else {
                if (i + 1 != charSequence.length()) {
                    ...
                    if (Character.isSurrogatePair(charAt, charAt2)) {
                        ...
                        byteBuffer.put((byte) (((toCodePoint >>> 12) & 63) | IExpr.SYMBOLID));
                        byteBuffer.put((byte) (((toCodePoint >>> 6) & 63) | IExpr.SYMBOLID));
                        byteBuffer.put((byte) ((toCodePoint & 63) | IExpr.SYMBOLID));
                    }
                }
    ...
    public static int zzbe(long j) {
        return (-128 & j) == 0 ? 1 : (ExpVectorShort.minShort & j) == 0 ? 2 : (-2097152 & j) == 0 ? 3 : (-268435456 & j) == 0 ? 4 : (-34359738368L & j) == 0 ? 5 : (-4398046511104L & j) == 0 ? 6 : (-562949953421312L & j) == 0 ? 7 : (-72057594037927936L & j) == 0 ? 8 : (Long.MIN_VALUE & j) == 0 ? 9 : 10;
    }
    ...
    public void zzbd(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzqr((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | IExpr.SYMBOLID);
            j >>>= 7;
        }
        zzqr((int) j);
    }
    ...
    public void zzqt(int i) throws IOException {
        while ((i & -128) != 0) {
            zzqr((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | IExpr.SYMBOLID);
            i >>>= 7;
        }
        zzqr(i);
    }
