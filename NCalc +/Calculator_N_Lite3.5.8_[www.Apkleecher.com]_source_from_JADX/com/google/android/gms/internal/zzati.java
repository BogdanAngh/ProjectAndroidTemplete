...
public class zzati extends zzats {
    ...
    class 1 implements Runnable {
        ...
        1(zzati com_google_android_gms_internal_zzati, String str) {
    ...
    static String zzc(boolean z, Object obj) {
        ...
        if (valueOf instanceof Long) {
            ...
            String str = String.valueOf(valueOf).charAt(0) == Constants.MINUS_UNICODE ? "-" : BuildConfig.FLAVOR;
            String valueOf2 = String.valueOf(Math.abs(((Long) valueOf).longValue()));
            return new StringBuilder((String.valueOf(str).length() + 43) + String.valueOf(str).length()).append(str).append(Math.round(Math.pow(BOBYQAOptimizer.DEFAULT_INITIAL_RADIUS, (double) (valueOf2.length() - 1)))).append("...").append(str).append(Math.round(Math.pow(BOBYQAOptimizer.DEFAULT_INITIAL_RADIUS, (double) valueOf2.length()) - 1.0d)).toString();
    ...
    public void zzb(int i, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzLv == null) {
            ...
            if (valueOf.length() > IExpr.ASTID) {
                valueOf = str.substring(0, IExpr.ASTID);
            }
            zzLv.zzm(new 1(this, valueOf));
        } else {
