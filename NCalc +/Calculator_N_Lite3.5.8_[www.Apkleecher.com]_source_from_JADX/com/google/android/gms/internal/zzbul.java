...
public final class zzbul {
    ...
    private zzbul(byte[] bArr, int i, int i2) {
        this.zzcrS = BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT;
        this.zzcrU = 64;
        this.zzcrV = 67108864;
        this.buffer = bArr;
        this.zzcrN = i;
    ...
    public int zzacI() {
        if (this.zzcrS == BaseAbstractUnivariateIntegrator.DEFAULT_MAX_ITERATIONS_COUNT) {
            return -1;
        }
