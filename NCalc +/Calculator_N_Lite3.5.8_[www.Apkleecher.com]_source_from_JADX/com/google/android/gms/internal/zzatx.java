...
public final class zzatx {
    ...
    class 1 implements Runnable {
        ...
        1(zzatx com_google_android_gms_internal_zzatx, zzatp com_google_android_gms_internal_zzatp, int i, zzati com_google_android_gms_internal_zzati) {
        ...
        public void run() {
            this.zzbsD.zzLL();
            this.zzbsD.zzLG();
            this.zzbuR.mHandler.post(new 1(this));
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (intent == null) {
            ...
            if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
                zzbu.zzJs().zzm(new 1(this, zzbu, i2, zzJt));
            }
        }
        return 2;
    }
