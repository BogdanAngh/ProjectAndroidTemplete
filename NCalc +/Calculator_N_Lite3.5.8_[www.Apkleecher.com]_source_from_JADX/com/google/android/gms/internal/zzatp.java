...
public class zzatp {
    ...
    class 1 implements Runnable {
        ...
        1(zzatp com_google_android_gms_internal_zzatp) {
    ...
    class 2 implements Callable<String> {
        ...
        2(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
    ...
    class 3 implements Callable<String> {
        final /* synthetic */ String zzbky;
        final /* synthetic */ zzatp zzbtH;

        3(zzatp com_google_android_gms_internal_zzatp, String str) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
            this.zzbky = str;
        }
    ...
    class 4 implements zza {
        ...
        4(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
    ...
    class 5 implements zza {
        ...
        5(zzatp com_google_android_gms_internal_zzatp) {
            this.zzbtH = com_google_android_gms_internal_zzatp;
        }
        ...
        if (zzLn == null) {
            ...
            if (!zzn.isEmpty()) {
                ...
                try {
                    ...
                    Object obj2 = LogicEvaluator.ERROR_INDEX_STRING;
                    ...
                    zzLy().zza(zzKG, url, zza, null, new 4(this));
    ...
    protected void zza(int i, Throwable th, byte[] bArr) {
        ...
        this.zzbtD = null;
        if ((i == AnimationUtil.DEFAULT_SHRINK_GROW_DURATION || i == 204) && th == null) {
            zzJu().zzbsg.set(zznq().currentTimeMillis());
            zzJu().zzbsh.set(0);
            zzLI();
    ...
    void zzb(zzasp com_google_android_gms_internal_zzasp) {
        ...
        try {
            ...
            zzLy().zza(com_google_android_gms_internal_zzasp.zzjI(), url, map, new 5(this));
        } catch (MalformedURLException e) {
    ...
    void zzb(zzasq com_google_android_gms_internal_zzasq, long j) {
        ...
        if (getContext().getPackageManager() == null) {
            ...
            if (applicationInfo != null) {
                ...
                if ((applicationInfo.flags & IExpr.SYMBOLID) != 0) {
            ...
            try {
                ...
                if ("_iap".equals(com_google_android_gms_internal_zzatb.name) || Event.ECOMMERCE_PURCHASE.equals(com_google_android_gms_internal_zzatb.name)) {
                    ...
                    if (Event.ECOMMERCE_PURCHASE.equals(com_google_android_gms_internal_zzatb.name)) {
                        double d = zzKY.getDouble(ObjectTable.VALUE) * 1000000.0d;
                        if (d == 0.0d) {
                            d = ((double) zzKY.getLong(ObjectTable.VALUE)) * 1000000.0d;
                        }
                        ...
                        round = zzKY.getLong(ObjectTable.VALUE);
                    }
    ...
    void zzb(String str, int i, Throwable th, byte[] bArr, Map<String, List<String>> map) {
        ...
        try {
            zzasp zzfy = zzJo().zzfy(str);
            int i3 = ((i == AnimationUtil.DEFAULT_SHRINK_GROW_DURATION || i == 204 || i == 304) && th == null) ? 1 : 0;
            if (zzfy == null) {
