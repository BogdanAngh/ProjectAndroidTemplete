...
public final class zzatm {
    ...
    class 1 implements Runnable {
        ...
        1(zzatm com_google_android_gms_internal_zzatm, zzatp com_google_android_gms_internal_zzatp, long j, Bundle bundle, Context context, zzati com_google_android_gms_internal_zzati) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            ...
            zzbu.zzJs().zzm(new 1(this, zzbu, longExtra, zzu, context, zzJt));
        }
    }
}
