...
class zzasu extends zzats {
    ...
    public zzaud zzR(String str, String str2) {
        ...
        zznA();
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"set_timestamp", ObjectTable.VALUE}, "app_id=? and name=?", new String[]{str, str2}, null, null, null);
            try {
                if (query.moveToFirst()) {
    ...
    public boolean zza(zzaud com_google_android_gms_internal_zzaud) {
        ...
        zza(contentValues, ObjectTable.VALUE, com_google_android_gms_internal_zzaud.zzYe);
        try {
    ...
    public List<zzaud> zzfx(String str) {
        ...
        try {
            Cursor query = getWritableDatabase().query("user_attributes", new String[]{"name", "set_timestamp", ObjectTable.VALUE}, "app_id=?", new String[]{str}, null, null, "rowid", String.valueOf(zzJv().zzKf()));
            try {
                if (query.moveToFirst()) {
                    do {
