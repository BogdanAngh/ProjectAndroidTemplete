...
class PseudoReducer<C extends GcdRingElem<C>> implements Runnable {
    ...
    static {
        logger = Logger.getLogger(PseudoReducer.class);
    }
    ...
    L_0x01b4:
        ...
        throw r8;
        */
        throw new UnsupportedOperationException("Method not decompiled: edu.jas.gbufd.PseudoReducer.run():void");
    }
}
