...
public abstract class AbstractRealMatrix extends RealLinearOperator implements RealMatrix {
    ...
    class 1 implements RealMatrixPreservingVisitor {
    ...
    class 2 implements RealMatrixPreservingVisitor {
        private double sum;
    ...
    class 3 extends DefaultRealMatrixChangingVisitor {
        private final /* synthetic */ int[] val$selectedColumns;
        private final /* synthetic */ int[] val$selectedRows;

        3(int[] iArr, int[] iArr2) {
            this.val$selectedRows = iArr;
            this.val$selectedColumns = iArr2;
        }

        public double visit(int row, int column, double value) {
            return AbstractRealMatrix.this.getEntry(this.val$selectedRows[row], this.val$selectedColumns[column]);
        }
    }

    class 4 extends DefaultRealMatrixPreservingVisitor {
        private int startColumn;
        private int startRow;
        private final /* synthetic */ double[][] val$destination;

        4(double[][] dArr) {
            this.val$destination = dArr;
        }
    ...
    class 5 extends DefaultRealMatrixPreservingVisitor {
        private final /* synthetic */ RealMatrix val$out;

        5(RealMatrix realMatrix) {
            this.val$out = realMatrix;
        }
    ...
    public RealMatrix power(int p) throws NotPositiveException, NonSquareMatrixException {
        if (p < 0) {
            ...
            while (it.hasNext()) {
                result = result.multiply(results[((Integer) it.next()).intValue()]);
            }
            return result;
        }
    }
    ...
    public double getNorm() {
        return walkInColumnOrder(new 1());
    }

    public double getFrobeniusNorm() {
        return walkInOptimizedOrder(new 2());
    }
    ...
    public RealMatrix getSubMatrix(int[] selectedRows, int[] selectedColumns) throws NullArgumentException, NoDataException, OutOfRangeException {
        ...
        subMatrix.walkInOptimizedOrder(new 3(selectedRows, selectedColumns));
        return subMatrix;
    }
    ...
    public void copySubMatrix(int startRow, int endRow, int startColumn, int endColumn, double[][] destination) throws OutOfRangeException, NumberIsTooSmallException, MatrixDimensionMismatchException {
        ...
        walkInOptimizedOrder(new 4(destination), startRow, endRow, startColumn, endColumn);
    }
    ...
    public RealMatrix transpose() {
        RealMatrix out = createMatrix(getColumnDimension(), getRowDimension());
        walkInOptimizedOrder(new 5(out));
        return out;
    }
