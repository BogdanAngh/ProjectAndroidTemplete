...
public class Array2DRowRealMatrix extends AbstractRealMatrix implements Serializable {
    ...
    public Array2DRowRealMatrix(int rowDimension, int columnDimension) throws NotStrictlyPositiveException {
        ...
        this.data = (double[][]) Array.newInstance(Double.TYPE, new int[]{rowDimension, columnDimension});
    }
    ...
    public Array2DRowRealMatrix(double[] v) {
        int nRows = v.length;
        this.data = (double[][]) Array.newInstance(Double.TYPE, new int[]{nRows, 1});
    ...
    public Array2DRowRealMatrix add(Array2DRowRealMatrix m) throws MatrixDimensionMismatchException {
        ...
        double[][] outData = (double[][]) Array.newInstance(Double.TYPE, new int[]{rowCount, columnCount});
    ...
    public Array2DRowRealMatrix multiply(Array2DRowRealMatrix m) throws DimensionMismatchException {
        ...
        int[] iArr = new int[]{nRows, nCols};
        double[][] outData = (double[][]) Array.newInstance(Double.TYPE, iArr);
    ...
    public void setSubMatrix(double[][] subMatrix, int row, int column) throws NoDataException, OutOfRangeException, DimensionMismatchException, NullArgumentException {
        if (this.data != null) {
            ...
            this.data = (double[][]) Array.newInstance(Double.TYPE, new int[]{subMatrix.length, nCols});
    ...
    private double[][] copyOut() {
        int nRows = getRowDimension();
        double[][] out = (double[][]) Array.newInstance(Double.TYPE, new int[]{nRows, getColumnDimension()});
        for (int i = 0; i < nRows; i++) {
