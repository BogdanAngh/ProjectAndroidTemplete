...
public abstract class AbstractSimplex implements OptimizationData {
    ...
    protected AbstractSimplex(double[] steps) {
        if (steps == null) {
            ...
            this.startConfiguration = (double[][]) Array.newInstance(Double.TYPE, new int[]{this.dimension, this.dimension});
    ...
    public PointValuePair getPoint(int index) {
        ...
        throw new OutOfRangeException(Integer.valueOf(index), Integer.valueOf(0), Integer.valueOf(this.simplex.length - 1));
    }
