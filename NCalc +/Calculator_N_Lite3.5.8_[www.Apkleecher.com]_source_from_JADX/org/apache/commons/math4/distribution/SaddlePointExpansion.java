...
final class SaddlePointExpansion {
    ...
    static double getStirlingError(double z) {
        ...
        z2 = z * z;
        return (0.08333333333333333d - ((0.002777777777777778d - ((7.936507936507937E-4d - ((5.952380952380953E-4d - (8.417508417508417E-4d / z2)) / z2)) / z2)) / z2)) / z;
    }
    ...
    static double logBinomialProbability(int x, int n, double p, double q) {
        if (x == 0) {
            ...
            return ((((getStirlingError((double) n) - getStirlingError((double) x)) - getStirlingError((double) (n - x))) - getDeviancePart((double) x, ((double) n) * p)) - getDeviancePart((double) (n - x), ((double) n) * q)) + (-0.5d * FastMath.log(((Angle2D.M_2PI * ((double) x)) * ((double) (n - x))) / ((double) n)));
        } else {
            if (q < 0.1d) {
