...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VPathRenderer {
        ...
        public VPathRenderer() {
            ...
            this.mRootAlpha = NalUnitUtil.EXTENDED_SAR;
            this.mRootName = null;
    ...
    private static class VectorDrawableCompatState extends ConstantState {
        ...
        public boolean hasTranslucentRoot() {
            return this.mVPathRenderer.getRootAlpha() < NalUnitUtil.EXTENDED_SAR ? true : VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
        }
