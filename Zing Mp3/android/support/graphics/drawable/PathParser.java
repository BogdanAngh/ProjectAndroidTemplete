...
class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                case C1569R.styleable.AppCompatTheme_imageButtonStyle /*65*/:
                case C1569R.styleable.AppCompatTheme_textColorAlertDialogListItem /*97*/:
                    incr = 7;
                    break;
                case C1569R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*67*/:
                case C1569R.styleable.AppCompatTheme_buttonBarNegativeButtonStyle /*99*/:
                    incr = 6;
                    break;
                ...
                case 'v':
                    incr = 1;
                    break;
                case C1569R.styleable.AppCompatTheme_listPopupWindowStyle /*76*/:
                case C1569R.styleable.AppCompatTheme_textAppearanceListItem /*77*/:
                case C1569R.styleable.AppCompatTheme_colorPrimaryDark /*84*/:
                case C1569R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                case C1569R.styleable.AppCompatTheme_ratingBarStyleIndicator /*109*/:
                case 't':
                    incr = 2;
                    break;
                case C1569R.styleable.AppCompatTheme_panelMenuListTheme /*81*/:
                case C1569R.styleable.AppCompatTheme_colorPrimary /*83*/:
                case C1569R.styleable.AppCompatTheme_switchStyle /*113*/:
                case 's':
                    incr = 4;
                    break;
        ...
        for (currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case C1569R.styleable.AppCompatTheme_actionDropDownStyle /*46*/:
                    ...
                    result.mEndWithNegOrDot = true;
                    break;
                case C1569R.styleable.AppCompatTheme_searchViewStyle /*69*/:
                case C1569R.styleable.AppCompatTheme_autoCompleteTextViewStyle /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
