...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C00081 extends AccessibilityDelegateCompat {
        C00081() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mAccessibilityDelegate = new C00081();
        setOrientation(0);
        ...
        this.mTextView = (CheckedTextView) findViewById(C0007R.id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0007R.id.design_menu_item_action_area_stub)).inflate();
            }
            this.mActionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0228R.attr.colorControlHighlight, value, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0007R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
