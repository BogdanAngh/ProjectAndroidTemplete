...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00321());
        }
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundDrawable(a.getDrawable(C0007R.styleable.NavigationView_android_background));
        ...
        if (a.hasValue(C0007R.styleable.NavigationView_itemTextColor)) {
            itemTextColor = a.getColorStateList(C0007R.styleable.NavigationView_itemTextColor);
        }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        switch (MeasureSpec.getMode(widthSpec)) {
            case Cue.TYPE_UNSET /*-2147483648*/:
                widthSpec = MeasureSpec.makeMeasureSpec(Math.min(MeasureSpec.getSize(widthSpec), this.mMaxWidth), C0989C.ENCODING_PCM_32BIT);
                break;
            case C1569R.styleable.com_facebook_login_view_com_facebook_confirm_logout /*0*/:
                widthSpec = MeasureSpec.makeMeasureSpec(this.mMaxWidth, C0989C.ENCODING_PCM_32BIT);
                break;
        }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0228R.attr.colorPrimary, value, true)) {
            return null;
        }
