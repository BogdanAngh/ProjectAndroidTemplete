...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class C00131 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C00131(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            ...
            if (currentOffset != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.addUpdateListener(new C00131(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        setBackgroundDrawable(a.getDrawable(C0007R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0007R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0007R.styleable.AppBarLayout_expanded, false));
        }
        if (VERSION.SDK_INT >= 21 && a.hasValue(C0007R.styleable.AppBarLayout_elevation)) {
    ...
    protected int[] onCreateDrawableState(int extraSpace) {
        ...
        int i = (this.mCollapsible && this.mCollapsed) ? C0007R.attr.state_collapsed : -C0007R.attr.state_collapsed;
