...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00231 implements OnApplyWindowInsetsListener {
        C00231() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_android_layout_gravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.mAnchorId = a.getResourceId(C0007R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.keyline = a.getInteger(C0007R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = a.getInt(C0007R.styleable.CoordinatorLayout_Layout_layout_insetEdge, CoordinatorLayout.TYPE_ON_INTERCEPT);
            this.dodgeInsetEdges = a.getInt(C0007R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, CoordinatorLayout.TYPE_ON_INTERCEPT);
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C00241 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00241() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00241());
        }
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int keylineArrayRes = a.getResourceId(C0007R.styleable.CoordinatorLayout_keylines, TYPE_ON_INTERCEPT);
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
        int anchorVgrav = absAnchorGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (lp.mBehavior != null) {
            ...
            if (scrimAlpha > 0.0f) {
                ...
                this.mScrimPaint.setAlpha(MathUtils.constrain(Math.round(255.0f * scrimAlpha), (int) TYPE_ON_INTERCEPT, (int) NalUnitUtil.EXTENDED_SAR));
    ...
    final void onChildViewsChanged(int type) {
        ...
        for (int i = TYPE_ON_INTERCEPT; i < childCount; i += TYPE_ON_TOUCH) {
            ...
            if (!(lp.insetEdge == 0 || drawRect.isEmpty())) {
                ...
                switch (absInsetEdge & C1569R.styleable.AppCompatTheme_spinnerStyle) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C00231();
                }
