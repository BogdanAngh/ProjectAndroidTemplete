...
abstract class FloatingActionButtonImpl {
    ...
    class C00301 implements OnPreDrawListener {
        C00301() {
        }
    ...
    CircularBorderDrawable createBorderDrawable(int borderWidth, ColorStateList backgroundTint) {
        ...
        borderDrawable.setGradientColors(resources.getColor(C0007R.color.design_fab_stroke_top_outer_color), resources.getColor(C0007R.color.design_fab_stroke_top_inner_color), resources.getColor(C0007R.color.design_fab_stroke_end_inner_color), resources.getColor(C0007R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00301();
        }
    }
