...
class FloatingActionButtonGingerbread extends FloatingActionButtonImpl {
    ...
    class C00261 extends AnimationListenerAdapter {
        final /* synthetic */ boolean val$fromUser;
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C00261(boolean z, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$fromUser = z;
    ...
    class C00272 extends AnimationListenerAdapter {
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C00272(InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$listener = internalVisibilityChangedListener;
        }
    ...
    void hide(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeHidden()) {
            this.mAnimState = 1;
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0007R.anim.design_fab_out);
            anim.setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR);
            anim.setDuration(200);
            anim.setAnimationListener(new C00261(fromUser, listener));
    ...
    void show(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!isOrWillBeShown()) {
            ...
            Animation anim = AnimationUtils.loadAnimation(this.mView.getContext(), C0007R.anim.design_fab_in);
            anim.setDuration(200);
            anim.setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR);
            anim.setAnimationListener(new C00272(listener));
            this.mView.startAnimation(anim);
        }
    }
