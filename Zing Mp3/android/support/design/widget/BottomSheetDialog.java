...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C00192 extends BottomSheetCallback {
        C00192() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C00192();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        CoordinatorLayout coordinator = (CoordinatorLayout) View.inflate(getContext(), C0007R.layout.design_bottom_sheet_dialog, null);
        if (layoutResId != 0 && view == null) {
            view = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0007R.id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0007R.id.touch_outside).setOnClickListener(new C00181());
        return coordinator;
    }
