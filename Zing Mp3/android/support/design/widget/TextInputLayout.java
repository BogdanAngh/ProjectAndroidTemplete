...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.getResourceId(C0007R.styleable.TextInputLayout_hintTextAppearance, INVALID_MAX_LENGTH) != INVALID_MAX_LENGTH) {
        ...
        setCounterMaxLength(a.getInt(C0007R.styleable.TextInputLayout_counterMaxLength, INVALID_MAX_LENGTH));
        ...
        this.mPasswordToggleEnabled = a.getBoolean(C0007R.styleable.TextInputLayout_passwordToggleEnabled, true);
        ...
        if (a.hasValue(C0007R.styleable.TextInputLayout_passwordToggleTintMode)) {
            ...
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(a.getInt(C0007R.styleable.TextInputLayout_passwordToggleTintMode, INVALID_MAX_LENGTH), null);
        }
        a.recycle();
    ...
    public void setErrorEnabled(boolean enabled) {
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                if (useDefaultColor) {
                    this.mErrorView.setTextAppearance(getContext(), C0228R.style.TextAppearance_AppCompat_Caption);
    ...
    private void setError(@Nullable CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00512()).start();
            } else {
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0228R.style.TextAppearance_AppCompat_Caption);
