...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable content, float radius, float shadowSize, float maxShadowSize) {
        ...
        this.mShadowStartColor = resources.getColor(C0007R.color.design_fab_shadow_start_color);
        this.mShadowMiddleColor = resources.getColor(C0007R.color.design_fab_shadow_mid_color);
        this.mShadowEndColor = resources.getColor(C0007R.color.design_fab_shadow_end_color);
