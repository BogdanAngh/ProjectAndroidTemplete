...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00211 implements OnApplyWindowInsetsListener {
        C00211() {
        }
    ...
    class C00222 implements AnimatorUpdateListener {
        C00222() {
        }
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            this.mCollapseMode = a.getInt(C0007R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, COLLAPSE_MODE_OFF);
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0228R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00211());
    }
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper offsetHelper = (ViewOffsetHelper) view.getTag(C0007R.id.view_offset_helper);
        if (offsetHelper != null) {
            return offsetHelper;
        }
        offsetHelper = new ViewOffsetHelper(view);
        view.setTag(C0007R.id.view_offset_helper, offsetHelper);
        return offsetHelper;
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00222());
