...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MeasureSpec.getMode(widthMeasureSpec) == C0989C.ENCODING_PCM_32BIT && TabLayout.this.mMode == TabLayout.MODE_FIXED && TabLayout.this.mTabGravity == TabLayout.MODE_FIXED) {
                int i;
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (maxWidth <= 0 || (specWidthMode != 0 && specWidthSize <= maxWidth)) {
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, Cue.TYPE_UNSET);
            }
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            if (this.mTextView != null) {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mTabStrip.setSelectedIndicatorHeight(a.getDimensionPixelSize(C0007R.styleable.TabLayout_tabIndicatorHeight, MODE_SCROLLABLE));
        this.mTabStrip.setSelectedIndicatorColor(a.getColor(C0007R.styleable.TabLayout_tabIndicatorColor, MODE_SCROLLABLE));
        int dimensionPixelSize = a.getDimensionPixelSize(C0007R.styleable.TabLayout_tabPadding, MODE_SCROLLABLE);
        ...
        TypedArray ta = context.obtainStyledAttributes(this.mTabTextAppearance, C0228R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) ta.getDimensionPixelSize(C0228R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
            this.mTabTextColors = ta.getColorStateList(C0228R.styleable.TextAppearance_android_textColor);
            ...
            if (a.hasValue(C0007R.styleable.TabLayout_tabSelectedTextColor)) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), a.getColor(C0007R.styleable.TabLayout_tabSelectedTextColor, MODE_SCROLLABLE));
            }
            this.mRequestedTabMinWidth = a.getDimensionPixelSize(C0007R.styleable.TabLayout_tabMinWidth, INVALID_WIDTH);
            this.mRequestedTabMaxWidth = a.getDimensionPixelSize(C0007R.styleable.TabLayout_tabMaxWidth, INVALID_WIDTH);
            this.mTabBackgroundResId = a.getResourceId(C0007R.styleable.TabLayout_tabBackground, MODE_SCROLLABLE);
            this.mContentInsetStart = a.getDimensionPixelSize(C0007R.styleable.TabLayout_tabContentStart, MODE_SCROLLABLE);
            this.mMode = a.getInt(C0007R.styleable.TabLayout_tabMode, MODE_FIXED);
            this.mTabGravity = a.getInt(C0007R.styleable.TabLayout_tabGravity, MODE_SCROLLABLE);
            a.recycle();
            Resources res = getResources();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        switch (MeasureSpec.getMode(heightMeasureSpec)) {
            case Cue.TYPE_UNSET /*-2147483648*/:
                heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(idealHeight, MeasureSpec.getSize(heightMeasureSpec)), C0989C.ENCODING_PCM_32BIT);
                break;
            case MODE_SCROLLABLE /*0*/:
                heightMeasureSpec = MeasureSpec.makeMeasureSpec(idealHeight, C0989C.ENCODING_PCM_32BIT);
                break;
        }
        ...
        if (getChildCount() == MODE_FIXED) {
            ...
            if (remeasure) {
                child.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C0989C.ENCODING_PCM_32BIT), getChildMeasureSpec(heightMeasureSpec, getPaddingTop() + getPaddingBottom(), child.getLayoutParams().height));
            }
        }
    }
