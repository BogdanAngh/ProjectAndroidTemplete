...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C03142 extends ViewPropertyAnimatorListenerAdapter {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C0228R.string.abc_action_bar_up_description, C0228R.drawable.abc_ic_ab_back_material);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(toolbar.getContext(), null, C0228R.styleable.ActionBar, C0228R.attr.actionBarStyle, 0);
        ...
        this.mToolbar.setNavigationOnClickListener(new C03131());
    }
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? 1.0f : 0.0f).setDuration(duration).setListener(new C03142(visibility));
    }
