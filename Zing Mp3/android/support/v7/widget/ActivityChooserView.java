...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02531 extends DataSetObserver {
        C02531() {
        }
    ...
    class C02542 implements OnGlobalLayoutListener {
        C02542() {
        }
    ...
    class C02553 extends ForwardingListener {
        C02553(View src) {
            super(src);
        }
    ...
    class C02564 extends DataSetObserver {
        C02564() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            switch (getItemViewType(position)) {
                case ITEM_VIEW_TYPE_ACTIVITY /*0*/:
                    if (convertView == null || convertView.getId() != C0228R.id.list_item) {
                    ...
                    ((ImageView) convertView.findViewById(C0228R.id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                    ((TextView) convertView.findViewById(C0228R.id.title)).setText(activity.loadLabel(packageManager));
                ...
                case ITEM_VIEW_TYPE_FOOTER /*1*/:
                    if (convertView == null || convertView.getId() != ITEM_VIEW_TYPE_FOOTER) {
                        ...
                        ((TextView) convertView.findViewById(C0228R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0228R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C02531();
        this.mOnGlobalLayoutListener = new C02542();
        ...
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0228R.id.activity_chooser_view_content);
        ...
        FrameLayout expandButton = (FrameLayout) findViewById(C0228R.id.expand_activities_button);
        expandButton.setOnClickListener(this.mCallbacks);
        expandButton.setOnTouchListener(new C02553(expandButton));
        this.mExpandActivityOverflowButton = expandButton;
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0228R.id.image);
        ...
        this.mAdapter.registerDataSetObserver(new C02564());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec), C0989C.ENCODING_PCM_32BIT);
        }
