...
class AppCompatCompoundButtonHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            if (a.hasValue(C0228R.styleable.CompoundButton_android_button)) {
                int resourceId = a.getResourceId(C0228R.styleable.CompoundButton_android_button, 0);
                if (resourceId != 0) {
            ...
            if (a.hasValue(C0228R.styleable.CompoundButton_buttonTintMode)) {
                CompoundButtonCompat.setButtonTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0228R.styleable.CompoundButton_buttonTintMode, -1), null));
            }
            a.recycle();
        } catch (Throwable th) {
            a.recycle();
