...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02751 implements Creator<SavedState> {
            C02751() {
            }
    ...
    boolean shouldMeasureTwice() {
        return (getHeightMode() == C0989C.ENCODING_PCM_32BIT || getWidthMode() == C0989C.ENCODING_PCM_32BIT || !hasFlexibleChildInBothOrientations()) ? DEBUG : true;
    }
