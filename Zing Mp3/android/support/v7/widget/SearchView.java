...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02964 implements OnFocusChangeListener {
        C02964() {
        }
    ...
    class C02975 implements OnLayoutChangeListener {
        C02975() {
        }
    ...
    class C02986 implements OnGlobalLayoutListener {
        C02986() {
        }
    ...
    class C02997 implements OnClickListener {
        C02997() {
        }
    ...
    class C03008 implements OnKeyListener {
        C03008() {
        }
    ...
    class C03019 implements OnEditorActionListener {
        C03019() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C02931();
        this.mUpdateDrawableStateRunnable = new C02942();
        this.mReleaseCursorRunnable = new C02953();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02997();
        this.mTextKeyListener = new C03008();
        this.mOnEditorActionListener = new C03019();
        ...
        LayoutInflater.from(context).inflate(a.getResourceId(C0228R.styleable.SearchView_layout, C0228R.layout.abc_search_view), this, true);
        ...
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0228R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0228R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0228R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0228R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0228R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0228R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0228R.styleable.SearchView_searchIcon));
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02964());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02975());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02986());
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, C0989C.ENCODING_PCM_32BIT);
