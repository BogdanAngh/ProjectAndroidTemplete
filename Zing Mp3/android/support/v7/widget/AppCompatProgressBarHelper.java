...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = 0; i < N; i++) {
            ...
            frame.setLevel(AdaptiveEvaluator.DEFAULT_MIN_DURATION_FOR_QUALITY_INCREASE_MS);
            newBg.addFrame(frame, background.getDuration(i));
        }
        newBg.setLevel(AdaptiveEvaluator.DEFAULT_MIN_DURATION_FOR_QUALITY_INCREASE_MS);
        return newBg;
    }
