...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0228R.styleable.LinearLayoutCompat, defStyleAttr, SHOW_DIVIDER_NONE);
        int index = a.getInt(C0228R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }
        index = a.getInt(C0228R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (index >= 0) {
            setGravity(index);
        }
        ...
        this.mShowDividers = a.getInt(C0228R.styleable.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = a.getDimensionPixelSize(C0228R.styleable.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        a.recycle();
    }
    ...
    public int getBaseline() {
        ...
        if (childBaseline != -1) {
            ...
            if (this.mOrientation == VERTICAL) {
                int majorGravity = this.mGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
                if (majorGravity != 48) {
                    switch (majorGravity) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.height == 0 && heightMode == 1073741824) {
                            ...
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(share, C0989C.ENCODING_PCM_32BIT));
                        } else {
                            childHeight = child.getMeasuredHeight() + share;
                            if (childHeight < 0) {
                                childHeight = SHOW_DIVIDER_NONE;
                            }
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(childHeight, C0989C.ENCODING_PCM_32BIT));
                        }
                ...
                for (i = SHOW_DIVIDER_NONE; i < count; i += VERTICAL) {
                    ...
                    if (!(child == null || child.getVisibility() == 8)) {
                        if (((LayoutParams) child.getLayoutParams()).weight > 0.0f) {
                            child.measure(MeasureSpec.makeMeasureSpec(child.getMeasuredWidth(), C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(largestChildHeight, C0989C.ENCODING_PCM_32BIT));
                        }
                    }
                }
            }
    ...
    private void forceUniformWidth(int count, int heightMeasureSpec) {
        int uniformMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C0989C.ENCODING_PCM_32BIT);
            ...
            if (child == null) {
                ...
                if (baselineAligned) {
                    ...
                    if (childBaseline != -1) {
                        ...
                        int index = (((i2 & C1569R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.width == 0 && widthMode == 1073741824) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec(share, C0989C.ENCODING_PCM_32BIT), childHeightMeasureSpec);
                        } else {
                            childWidth = child.getMeasuredWidth() + share;
                            if (childWidth < 0) {
                                childWidth = SHOW_DIVIDER_NONE;
                            }
                            child.measure(MeasureSpec.makeMeasureSpec(childWidth, C0989C.ENCODING_PCM_32BIT), childHeightMeasureSpec);
                        }
                    ...
                    if (baselineAligned) {
                        ...
                        if (childBaseline != -1) {
                            ...
                            index = (((i2 & C1569R.styleable.AppCompatTheme_spinnerStyle) >> VERTICAL_GRAVITY_COUNT) & -2) >> VERTICAL;
                            maxAscent[index] = Math.max(maxAscent[index], childBaseline);
                            maxDescent[index] = Math.max(maxDescent[index], childHeight - childBaseline);
                        }
                    }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (i = SHOW_DIVIDER_NONE; i < count; i += VERTICAL) {
                    ...
                    if (!(child == null || child.getVisibility() == 8)) {
                        if (((LayoutParams) child.getLayoutParams()).weight > 0.0f) {
                            child.measure(MeasureSpec.makeMeasureSpec(largestChildWidth, C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), C0989C.ENCODING_PCM_32BIT));
                        }
                    }
                }
            }
    ...
    private void forceUniformHeight(int count, int widthMeasureSpec) {
        int uniformMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0989C.ENCODING_PCM_32BIT);
        for (int i = SHOW_DIVIDER_NONE; i < count; i += VERTICAL) {
            View child = getVirtualChildAt(i);
            if (child.getVisibility() != 8) {
                LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        switch (this.mGravity & C1569R.styleable.AppCompatTheme_spinnerStyle) {
            case C1569R.styleable.Toolbar_titleMarginEnd /*16*/:
    ...
    void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int minorGravity = this.mGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
        boolean baselineAligned = this.mBaselineAligned;
        int[] maxAscent = this.mMaxAscent;
        int[] maxDescent = this.mMaxDescent;
        ...
        while (i < count) {
            ...
            if (child == null) {
                ...
                switch (gravity & C1569R.styleable.AppCompatTheme_spinnerStyle) {
                    case C1569R.styleable.Toolbar_titleMarginEnd /*16*/:
    ...
    public void setGravity(int gravity) {
        if (this.mGravity != gravity) {
            ...
            if ((gravity & C1569R.styleable.AppCompatTheme_spinnerStyle) == 0) {
                gravity |= 48;
            }
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
        if ((this.mGravity & C1569R.styleable.AppCompatTheme_spinnerStyle) != gravity) {
