    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tvw == null || tvw.type == 0)) {
                ...
                if (w > 0) {
                    widthMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(widthMeasureSpec)), C0989C.ENCODING_PCM_32BIT);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (!(tvh == null || tvh.type == 0)) {
                ...
                if (h > 0) {
                    heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(heightMeasureSpec)), C0989C.ENCODING_PCM_32BIT);
                }
            }
        }
        ...
        widthMeasureSpec = MeasureSpec.makeMeasureSpec(width, C0989C.ENCODING_PCM_32BIT);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tv == null || tv.type == 0)) {
                ...
                if (width < min) {
                    widthMeasureSpec = MeasureSpec.makeMeasureSpec(min, C0989C.ENCODING_PCM_32BIT);
                    measure = true;
                }
            }
        }
