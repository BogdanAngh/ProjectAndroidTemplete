...
import android.support.v7.recyclerview.C0230R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(RecyclerView recyclerView) {
            ...
            this.mWidthMode = C0989C.ENCODING_PCM_32BIT;
            this.mHeightMode = C0989C.ENCODING_PCM_32BIT;
        }
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int maxX = Cue.TYPE_UNSET;
            int maxY = Cue.TYPE_UNSET;
            for (int i = RecyclerView.TOUCH_SLOP_DEFAULT; i < count; i += RecyclerView.VERTICAL) {
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                if (childDimension >= 0) {
                    ...
                    resultMode = C0989C.ENCODING_PCM_32BIT;
                } else {
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (childDimension >= 0) {
                ...
                resultSize = size;
                resultMode = (parentMode == Cue.TYPE_UNSET || parentMode == C0989C.ENCODING_PCM_32BIT) ? Cue.TYPE_UNSET : RecyclerView.TOUCH_SLOP_DEFAULT;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0230R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0230R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0230R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0230R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0230R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), C0989C.ENCODING_PCM_32BIT));
        }
    ...
    static class C02863 implements Interpolator {
        C02863() {
        }
    ...
    class C02874 implements ProcessCallback {
        C02874() {
        }
    ...
    class C02885 implements Callback {
        C02885() {
        }
    ...
    class C02896 implements Callback {
        C02896() {
        }
    ...
    public final class Recycler {
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (fromScrap && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(Utility.DEFAULT_STREAM_BUFFER_SIZE)) {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02901 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02901() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C02901());
        }
    }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, Cue.TYPE_UNSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Cue.TYPE_UNSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
            postOnAnimation();
        }
    ...
    static {
        ...
        sQuinticInterpolator = new C02863();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02841();
        ...
        this.mItemAnimatorRunner = new C02852();
        this.mViewInfoProcessCallback = new C02874();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0230R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0230R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0230R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == NO_POSITION) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02885());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02896());
    }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (this.mLayout == null) {
            ...
            if (widthMode == C0989C.ENCODING_PCM_32BIT && heightMode == C0989C.ENCODING_PCM_32BIT) {
                skipMeasure = true;
            }
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), C0989C.ENCODING_PCM_32BIT));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
