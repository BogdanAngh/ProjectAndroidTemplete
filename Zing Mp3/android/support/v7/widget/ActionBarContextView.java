...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(C0228R.id.action_mode_close_button).setOnClickListener(new C02471(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mCustomView != null) {
                ...
                int i = lp2.width;
                int customWidthMode = r0 != -2 ? C0989C.ENCODING_PCM_32BIT : Cue.TYPE_UNSET;
                if (lp2.width >= 0) {
                ...
                i = lp2.height;
                int customHeightMode = r0 != -2 ? C0989C.ENCODING_PCM_32BIT : Cue.TYPE_UNSET;
                if (lp2.height >= 0) {
