...
public class SwitchCompat extends CompoundButton {
    ...
    class C03081 implements AnimationListener {
    ...
    public SwitchCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mThumbDrawable = a.getDrawable(C0228R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = a.getDrawable(C0228R.styleable.SwitchCompat_track);
        ...
        Mode thumbTintMode = DrawableUtils.parseTintMode(a.getInt(C0228R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        Mode trackTintMode = DrawableUtils.parseTintMode(a.getInt(C0228R.styleable.SwitchCompat_trackTintMode, -1), null);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        this.mPositionAnimator.setAnimationListener(new C03081(newCheckedState));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        switch (getGravity() & C1569R.styleable.AppCompatTheme_spinnerStyle) {
