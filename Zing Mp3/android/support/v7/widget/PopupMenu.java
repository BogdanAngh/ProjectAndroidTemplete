...
public class PopupMenu {
    ...
    class C02811 implements Callback {
        C02811() {
        }
    ...
    class C02822 implements android.widget.PopupWindow.OnDismissListener {
        C02822() {
        }
    ...
    class C02833 extends ForwardingListener {
        C02833(View src) {
            super(src);
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C02811());
        ...
        this.mPopup.setOnDismissListener(new C02822());
    }
    ...
    public OnTouchListener getDragToOpenListener() {
        if (this.mDragListener == null) {
            this.mDragListener = new C02833(this.mAnchor);
        }
