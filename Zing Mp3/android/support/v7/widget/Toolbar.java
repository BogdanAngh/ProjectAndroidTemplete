...
public class Toolbar extends ViewGroup {
    ...
    class C03091 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C03091() {
        }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (Toolbar.this.mExpandedActionView.getParent() != Toolbar.this) {
                ...
                lp.gravity = GravityCompat.START | (Toolbar.this.mButtonGravity & C1569R.styleable.AppCompatTheme_spinnerStyle);
                lp.mViewType = 2;
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C03091();
        this.mShowOverflowMenuRunnable = new C03102();
        ...
        if (a.hasValue(C0228R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0228R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        int contentInsetStart = a.getDimensionPixelOffset(C0228R.styleable.Toolbar_contentInsetStart, Cue.TYPE_UNSET);
        int contentInsetEnd = a.getDimensionPixelOffset(C0228R.styleable.Toolbar_contentInsetEnd, Cue.TYPE_UNSET);
        ...
        this.mContentInsetStartWithNavigation = a.getDimensionPixelOffset(C0228R.styleable.Toolbar_contentInsetStartWithNavigation, Cue.TYPE_UNSET);
        this.mContentInsetEndWithActions = a.getDimensionPixelOffset(C0228R.styleable.Toolbar_contentInsetEndWithActions, Cue.TYPE_UNSET);
        ...
        if (a.hasValue(C0228R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0228R.styleable.Toolbar_subtitleTextColor, -1));
        }
        a.recycle();
    }
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = GravityCompat.END | (this.mButtonGravity & C1569R.styleable.AppCompatTheme_spinnerStyle);
    ...
    public int getContentInsetStartWithNavigation() {
        if (this.mContentInsetStartWithNavigation != Cue.TYPE_UNSET) {
    ...
    public void setContentInsetStartWithNavigation(int insetStartWithNavigation) {
        if (insetStartWithNavigation < 0) {
            insetStartWithNavigation = Cue.TYPE_UNSET;
        }
    ...
    public int getContentInsetEndWithActions() {
        if (this.mContentInsetEndWithActions != Cue.TYPE_UNSET) {
    ...
    public void setContentInsetEndWithActions(int insetEndWithActions) {
        if (insetEndWithActions < 0) {
            insetEndWithActions = Cue.TYPE_UNSET;
        }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = GravityCompat.START | (this.mButtonGravity & C1569R.styleable.AppCompatTheme_spinnerStyle);
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C03113());
        }
    }
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        ...
        if (childHeightMode != C0989C.ENCODING_PCM_32BIT && heightConstraint >= 0) {
            childHeightSpec = MeasureSpec.makeMeasureSpec(childHeightMode != 0 ? Math.min(MeasureSpec.getSize(childHeightSpec), heightConstraint) : heightConstraint, C0989C.ENCODING_PCM_32BIT);
        }
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
        switch (vgrav) {
            ...
            case C1569R.styleable.AppCompatTheme_panelMenuListWidth /*80*/:
                return vgrav;
            default:
                return this.mGravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
        }
    }
