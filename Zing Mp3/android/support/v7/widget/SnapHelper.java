...
public abstract class SnapHelper extends OnFlingListener {
    ...
    class C03031 extends OnScrollListener {
        boolean mScrolled;
    ...
    class C03042 extends LinearSmoothScroller {
        C03042(Context context) {
            super(context);
        }
    ...
    public SnapHelper() {
        this.mScrollListener = new C03031();
    }
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, Cue.TYPE_UNSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, Cue.TYPE_UNSET, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    ...
    private LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        if (layoutManager instanceof ScrollVectorProvider) {
            return new C03042(this.mRecyclerView.getContext());
        }
        return null;
    }
}
