...
public abstract class OrientationHelper {
    ...
    static class C02791 extends OrientationHelper {
        C02791(LayoutManager layoutManager) {
            super(null);
        }
    ...
    static class C02802 extends OrientationHelper {
        C02802(LayoutManager layoutManager) {
            super(null);
        }
