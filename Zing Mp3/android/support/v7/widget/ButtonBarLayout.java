...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        this.mAllowStacking = ta.getBoolean(C0228R.styleable.ButtonBarLayout_allowStacking, allowStackingDefault);
        ta.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isStacked() || MeasureSpec.getMode(widthMeasureSpec) != C0989C.ENCODING_PCM_32BIT) {
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0228R.id.spacer);
        if (spacer != null) {
