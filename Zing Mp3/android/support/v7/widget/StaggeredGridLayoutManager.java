...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            static class C03061 implements Creator<FullSpanItem> {
                C03061() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C03071 implements Creator<SavedState> {
            C03071() {
            }
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mCheckForGapsRunnable = new C03051();
    ...
    private void repositionToWrapContentIfNecessary() {
        if (this.mSecondaryOrientation.getMode() != C0989C.ENCODING_PCM_32BIT) {
            int i;
            View child;
            float maxSize = 0.0f;
    ...
    private int updateSpecWithExtra(int spec, int startInset, int endInset) {
        ...
        if (mode == INVALID_OFFSET || mode == C0989C.ENCODING_PCM_32BIT) {
