...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean forList) {
            ...
            this.mTab = tab;
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0228R.attr.actionBarTabStyle, 0);
            if (a.hasValue(0)) {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, C0989C.ENCODING_PCM_32BIT), heightMeasureSpec);
            }
        }
        ...
        public void update() {
            ...
            if (hasText) {
                if (this.mTextView == null) {
                    TextView textView = new AppCompatTextView(getContext(), null, C0228R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == C0989C.ENCODING_PCM_32BIT) {
            lockedExpanded = true;
        } else {
        ...
        if (childCount <= 1 || !(widthMode == C0989C.ENCODING_PCM_32BIT || widthMode == Cue.TYPE_UNSET)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
        ...
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(this.mContentHeight, C0989C.ENCODING_PCM_32BIT);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat tabLayout = new LinearLayoutCompat(getContext(), null, C0228R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner spinner = new AppCompatSpinner(getContext(), null, C0228R.attr.actionDropDownStyle);
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new C02921(tabView);
