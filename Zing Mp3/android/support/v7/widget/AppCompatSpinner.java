...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class C02581 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        C02581(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C02591 implements OnItemClickListener {
            final /* synthetic */ AppCompatSpinner val$this$0;

            C02591(AppCompatSpinner appCompatSpinner) {
        ...
        class C02602 implements OnGlobalLayoutListener {
            C02602() {
            }
        ...
        class C02613 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            C02613(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setOnItemClickListener(new C02591(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            if (!wasShowing) {
                ViewTreeObserver vto = AppCompatSpinner.this.getViewTreeObserver();
                if (vto != null) {
                    OnGlobalLayoutListener layoutListener = new C02602();
                    vto.addOnGlobalLayoutListener(layoutListener);
                    setOnDismissListener(new C02613(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, int mode) {
        this(context, null, C0228R.attr.spinnerStyle, mode);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0228R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (popupTheme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, popupTheme);
        } else {
            int popupThemeResId = a.getResourceId(C0228R.styleable.Spinner_popupTheme, MODE_DIALOG);
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == MODE_DROPDOWN) {
                ...
                TintTypedArray pa = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attrs, C0228R.styleable.Spinner, defStyleAttr, MODE_DIALOG);
                this.mDropDownWidth = pa.getLayoutDimension(C0228R.styleable.Spinner_android_dropDownWidth, -2);
                popup.setBackgroundDrawable(pa.getDrawable(C0228R.styleable.Spinner_android_popupBackground));
                popup.setPromptText(a.getString(C0228R.styleable.Spinner_android_prompt));
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new C02581(this, popup);
            }
        }
        CharSequence[] entries = a.getTextArray(C0228R.styleable.Spinner_android_entries);
        if (entries != null) {
            SpinnerAdapter adapter = new ArrayAdapter(context, 17367048, entries);
            adapter.setDropDownViewResource(C0228R.layout.support_simple_spinner_dropdown_item);
            setAdapter(adapter);
        }
        a.recycle();
        this.mPopupSet = true;
