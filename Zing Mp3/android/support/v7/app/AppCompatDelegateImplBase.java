...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class C02111 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        C02111(UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray a = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null, new int[]{C0228R.attr.homeAsUpIndicator});
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new C02111(Thread.getDefaultUncaughtExceptionHandler()));
