...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C02131 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & MpegAudioHeader.MAX_FRAME_SIZE_BYTES) != 0) {
                AppCompatDelegateImplV9.this.doInvalidatePanelMenu(C1569R.styleable.AppCompatTheme_ratingBarStyle);
            }
    ...
    class C02142 implements OnApplyWindowInsetsListener {
        C02142() {
        }
    ...
    class C02153 implements OnFitSystemWindowsListener {
        C02153() {
        }
    ...
    class C02164 implements OnAttachListener {
        C02164() {
        }
    ...
    class C02185 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02171());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C02196 extends ViewPropertyAnimatorListenerAdapter {
        C02196() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C1569R.styleable.AppCompatTheme_ratingBarStyle, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02201());
            }
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback callback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new C02131();
    }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C1569R.styleable.AppCompatTheme_ratingBarStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0228R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0228R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (a.getBoolean(C0228R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(C1569R.styleable.AppCompatTheme_ratingBarStyle);
            }
            if (a.getBoolean(C0228R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C1569R.styleable.AppCompatTheme_ratingBarStyleIndicator);
            }
            if (a.getBoolean(C0228R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = a.getBoolean(C0228R.styleable.AppCompatTheme_android_windowIsFloating, false);
            a.recycle();
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = (ViewGroup) inflater.inflate(C0228R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = (ViewGroup) inflater.inflate(C0228R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02142());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02153());
                }
            } else if (this.mIsFloating) {
                subDecor = (ViewGroup) inflater.inflate(C0228R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context themedContext;
                TypedValue outValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0228R.attr.actionBarTheme, outValue, true);
                if (outValue.resourceId != 0) {
                    themedContext = new ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    themedContext = this.mContext;
                }
                subDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0228R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(C0228R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C1569R.styleable.AppCompatTheme_ratingBarStyleIndicator);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) subDecor.findViewById(C0228R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(subDecor);
            ContentFrameLayout contentView = (ContentFrameLayout) subDecor.findViewById(C0228R.id.action_bar_activity_content);
            ...
            contentView.setAttachListener(new C02164());
            return subDecor;
        }
        a.recycle();
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C1569R.styleable.AppCompatTheme_ratingBarStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case C1569R.styleable.Toolbar_contentInsetEndWithActions /*10*/:
                ...
                return true;
            case C1569R.styleable.AppCompatTheme_ratingBarStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C1569R.styleable.AppCompatTheme_ratingBarStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, null, C0228R.attr.actionModePopupWindowStyle);
                    ...
                    this.mShowActionModePopup = new C02185();
                } else {
                    ViewStubCompat stub = (ViewStubCompat) this.mSubDecor.findViewById(C0228R.id.action_mode_bar_stub);
                    if (stub != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C02196());
                    } else {
    ...
    boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            case C1569R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position /*4*/:
                if ((event.getFlags() & AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) == 0) {
                    z = false;
                }
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    ...
                    st.isHandled = false;
                    WindowManager.LayoutParams lp2 = new WindowManager.LayoutParams(width, -2, st.f7x, st.f8y, AdError.LOAD_TOO_FREQUENTLY_ERROR_CODE, 8519680, -3);
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C1569R.styleable.AppCompatTheme_ratingBarStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C1569R.styleable.AppCompatTheme_ratingBarStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C1569R.styleable.AppCompatTheme_ratingBarStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C1569R.styleable.AppCompatTheme_ratingBarStyle) {
    ...
    void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C1569R.styleable.AppCompatTheme_ratingBarStyle, menu);
            }
    ...
    void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C1569R.styleable.AppCompatTheme_ratingBarStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C1569R.styleable.AppCompatTheme_ratingBarStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C1569R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
    }
