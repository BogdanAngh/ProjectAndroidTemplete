...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02262 extends ViewPropertyAnimatorListenerAdapter {
        C02262() {
        }
    ...
    class C02273 implements ViewPropertyAnimatorUpdateListener {
        C02273() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02251();
        this.mShowListener = new C02262();
        this.mUpdateListener = new C02273();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0228R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0228R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0228R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0228R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0228R.styleable.ActionBar, C0228R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0228R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
