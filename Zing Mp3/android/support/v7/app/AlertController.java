...
class AlertController {
    ...
    class C02032 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02032(View view, View view2) {
            this.val$top = view;
    ...
    class C02054 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02054(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C02065 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C02065(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class C02071 extends ArrayAdapter<CharSequence> {
            final /* synthetic */ ListView val$listView;

            C02071(Context x0, int x1, int x2, CharSequence[] x3, ListView listView) {
        ...
        class C02082 extends CursorAdapter {
            private final int mIsCheckedIndex;
            private final int mLabelIndex;
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02082(Context x0, Cursor x1, boolean x2, ListView listView, AlertController alertController) {
                this.val$listView = listView;
        ...
        class C02093 implements OnItemClickListener {
            ...
            C02093(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class C02104 implements OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ ListView val$listView;

            C02104(ListView listView, AlertController alertController) {
                this.val$listView = listView;
                this.val$dialog = alertController;
            }
        ...
        private void createListView(AlertController dialog) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                adapter = new C02071(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
            } else {
                ListAdapter c02082 = new C02082(this.mContext, this.mCursor, false, listView, dialog);
            }
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new C02093(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new C02104(listView, dialog));
            }
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        this.mButtonHandler = new C02021();
        this.mContext = context;
        this.mDialog = di;
        this.mWindow = window;
        this.mHandler = new ButtonHandler(di);
        TypedArray a = context.obtainStyledAttributes(null, C0228R.styleable.AlertDialog, C0228R.attr.alertDialogStyle, 0);
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0228R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0228R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0228R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0228R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0228R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0228R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0228R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0228R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0228R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0228R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0228R.id.scrollIndicatorDown);
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new C02032(top, bottom));
                this.mScrollView.post(new C02043(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new C02054(top, bottom));
                this.mListView.post(new C02065(top, bottom));
            } else {
                if (top != null) {
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0228R.id.custom);
