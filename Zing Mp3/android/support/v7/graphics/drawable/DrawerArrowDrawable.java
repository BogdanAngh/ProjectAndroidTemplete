...
public class DrawerArrowDrawable extends Drawable {
    ...
    public DrawerArrowDrawable(Context context) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(null, C0228R.styleable.DrawerArrowToggle, C0228R.attr.drawerArrowStyle, C0228R.style.Base_Widget_AppCompat_DrawerArrowToggle);
        setColor(a.getColor(C0228R.styleable.DrawerArrowToggle_color, ARROW_DIRECTION_LEFT));
        ...
        this.mSize = a.getDimensionPixelSize(C0228R.styleable.DrawerArrowToggle_drawableSize, ARROW_DIRECTION_LEFT);
