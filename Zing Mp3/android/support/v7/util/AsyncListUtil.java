...
public class AsyncListUtil<T> {
    ...
    class C02311 implements MainThreadCallback<T> {
        C02311() {
        }
    ...
    class C02322 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C02311();
        this.mBackgroundCallback = new C02322();
        this.mTClass = klass;
