...
public class DiffUtil {
    ...
    static class C02331 implements Comparator<Snake> {
        C02331() {
        }
    ...
    public static class DiffResult {
        ...
        class C02341 implements ListUpdateCallback {
            final /* synthetic */ Adapter val$adapter;

            C02341(Adapter adapter) {
        ...
        public void dispatchUpdatesTo(Adapter adapter) {
            dispatchUpdatesTo(new C02341(adapter));
        }
