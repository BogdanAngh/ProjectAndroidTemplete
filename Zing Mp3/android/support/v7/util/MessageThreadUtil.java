...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C02361 implements MainThreadCallback<T> {
        ...
        class C02351 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C02361.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C02361.UPDATE_ITEM_COUNT /*1*/:
                            C02361.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C02361.ADD_TILE /*2*/:
                            C02361.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C02361.REMOVE_TILE /*3*/:
                            C02361.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C02361.this.mQueue.next();
                }
            }
        }

        C02361(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C02351();
        }
    ...
    class C02382 implements BackgroundCallback<T> {
        ...
        class C02371 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C02382.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C02382.REFRESH /*1*/:
                                C02382.this.mQueue.removeMessages(C02382.REFRESH);
                                C02382.this.val$callback.refresh(msg.arg1);
                                break;
                            case C02382.UPDATE_RANGE /*2*/:
                                C02382.this.mQueue.removeMessages(C02382.UPDATE_RANGE);
                                C02382.this.mQueue.removeMessages(C02382.LOAD_TILE);
                                C02382.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C02382.LOAD_TILE /*3*/:
                                C02382.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C02382.RECYCLE_TILE /*4*/:
                                C02382.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C02382.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C02382(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C02371();
        }
