...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    class C02401 implements OnGlobalLayoutListener {
        C02401() {
        }
    ...
    class C02422 implements MenuItemHoverListener {
        ...
        class C02411 implements Runnable {
            ...
            C02411(CascadingMenuInfo cascadingMenuInfo, MenuItem menuItem, MenuBuilder menuBuilder) {
        ...
        public void onItemHoverEnter(@NonNull MenuBuilder menu, @NonNull MenuItem item) {
            ...
            if (menuIndex != -1) {
                ...
                CascadingMenuPopup.this.mSubMenuHoverHandler.postAtTime(new C02411(nextInfo, item, menu), menu, SystemClock.uptimeMillis() + 200);
            }
        }
    }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mGlobalLayoutListener = new C02401();
        this.mMenuItemHoverListener = new C02422();
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            ...
            View titleItemView = (FrameLayout) inflater.inflate(C0228R.layout.abc_popup_menu_header_item_layout, listView, false);
