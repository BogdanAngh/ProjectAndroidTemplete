...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            ...
            this.groupId = a.getResourceId(C0228R.styleable.MenuGroup_android_id, defaultItemOrder);
            this.groupCategory = a.getInt(C0228R.styleable.MenuGroup_android_menuCategory, defaultItemOrder);
            this.groupOrder = a.getInt(C0228R.styleable.MenuGroup_android_orderInCategory, defaultItemOrder);
            this.groupCheckable = a.getInt(C0228R.styleable.MenuGroup_android_checkableBehavior, defaultItemOrder);
            this.groupVisible = a.getBoolean(C0228R.styleable.MenuGroup_android_visible, defaultItemVisible);
            this.groupEnabled = a.getBoolean(C0228R.styleable.MenuGroup_android_enabled, defaultItemVisible);
            a.recycle();
        }

        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0228R.styleable.MenuItem);
            this.itemId = a.getResourceId(C0228R.styleable.MenuItem_android_id, defaultItemOrder);
            this.itemCategoryOrder = (SupportMenu.CATEGORY_MASK & a.getInt(C0228R.styleable.MenuItem_android_menuCategory, this.groupCategory)) | (SupportMenu.USER_MASK & a.getInt(C0228R.styleable.MenuItem_android_orderInCategory, this.groupOrder));
            ...
            this.itemIconResId = a.getResourceId(C0228R.styleable.MenuItem_android_icon, defaultItemOrder);
            ...
            if (a.hasValue(C0228R.styleable.MenuItem_android_checkable)) {
                int i;
                if (a.getBoolean(C0228R.styleable.MenuItem_android_checkable, defaultItemChecked)) {
                    i = 1;
                } else {
                    i = defaultItemOrder;
                }
            ...
            this.itemChecked = a.getBoolean(C0228R.styleable.MenuItem_android_checked, defaultItemChecked);
            ...
            this.itemActionViewLayout = a.getResourceId(C0228R.styleable.MenuItem_actionLayout, defaultItemOrder);
            this.itemActionViewClassName = a.getString(C0228R.styleable.MenuItem_actionViewClass);
            this.itemActionProviderClassName = a.getString(C0228R.styleable.MenuItem_actionProviderClass);
