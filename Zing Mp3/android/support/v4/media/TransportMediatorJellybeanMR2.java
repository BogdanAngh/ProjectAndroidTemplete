...
class TransportMediatorJellybeanMR2 {
    ...
    class C01201 implements OnWindowAttachListener {
        C01201() {
        }
    ...
    class C01212 implements OnWindowFocusChangeListener {
        C01212() {
        }
    ...
    class C01223 extends BroadcastReceiver {
        C01223() {
        }
    ...
    class C01234 implements OnAudioFocusChangeListener {
        C01234() {
        }
    ...
    class C01245 implements OnGetPlaybackPositionListener {
        C01245() {
        }
    ...
    class C01256 implements OnPlaybackPositionUpdateListener {
        C01256() {
        }
    ...
    public TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
        this.mWindowAttachListener = new C01201();
        this.mWindowFocusListener = new C01212();
        this.mMediaButtonReceiver = new C01223();
        this.mAudioFocusChangeListener = new C01234();
        this.mGetPlaybackPositionListener = new C01245();
        this.mPlaybackPositionUpdateListener = new C01256();
        this.mPlayState = 0;
