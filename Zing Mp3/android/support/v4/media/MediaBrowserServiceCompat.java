...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class C01001 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C01001(Object debug, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C01012 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C01012(Object debug, ResultReceiver resultReceiver) {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, ServiceCompatProxy {
        ...
        class C01021 implements Runnable {
            ...
            C01021(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        class C01032 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C01032(Object debug, ResultWrapper resultWrapper) {
        ...
        public void notifyChildrenChanged(String parentId, Bundle options) {
            if (this.mMessenger == null) {
                ...
                MediaBrowserServiceCompat.this.mHandler.post(new C01021(parentId, options));
            }
        }
        ...
        public void onLoadChildren(String parentId, ResultWrapper<List<Parcel>> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C01032(parentId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 implements MediaBrowserServiceCompatApi23.ServiceCompatProxy {
        ...
        class C01041 extends Result<MediaItem> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C01041(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadItem(String itemId, ResultWrapper<Parcel> resultWrapper) {
            MediaBrowserServiceCompat.this.onLoadItem(itemId, new C01041(itemId, resultWrapper));
        }
    }
    ...
    class MediaBrowserServiceImplApi24 extends MediaBrowserServiceImplApi23 implements MediaBrowserServiceCompatApi24.ServiceCompatProxy {
        ...
        class C01051 extends Result<List<MediaItem>> {
            final /* synthetic */ ResultWrapper val$resultWrapper;

            C01051(Object debug, ResultWrapper resultWrapper) {
                this.val$resultWrapper = resultWrapper;
                super(debug);
            }
        ...
        public void onLoadChildren(String parentId, ResultWrapper resultWrapper, Bundle options) {
            MediaBrowserServiceCompat.this.onLoadChildren(parentId, new C01051(parentId, resultWrapper), options);
        }
    ...
    class MediaBrowserServiceImplBase implements MediaBrowserServiceImpl {
        ...
        class C01072 implements Runnable {
            ...
            C01072(String str, Bundle bundle) {
                this.val$parentId = str;
                this.val$options = bundle;
            }
        ...
        public void setSessionToken(Token token) {
            MediaBrowserServiceCompat.this.mHandler.post(new C01061(token));
        }

        public void notifyChildrenChanged(@NonNull String parentId, Bundle options) {
            MediaBrowserServiceCompat.this.mHandler.post(new C01072(parentId, options));
        }
    ...
    private class ServiceBinderImpl {
        ...
        class C01081 implements Runnable {
            ...
            C01081(ServiceCallbacks serviceCallbacks, String str, Bundle bundle, int i) {
        ...
        class C01092 implements Runnable {
            ...
            C01092(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        class C01103 implements Runnable {
            ...
            C01103(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
        ...
        class C01114 implements Runnable {
            ...
            C01114(ServiceCallbacks serviceCallbacks, String str, IBinder iBinder) {
                this.val$callbacks = serviceCallbacks;
                this.val$id = str;
                this.val$token = iBinder;
            }
        ...
        class C01125 implements Runnable {
            ...
            C01125(ServiceCallbacks serviceCallbacks, String str, ResultReceiver resultReceiver) {
                this.val$callbacks = serviceCallbacks;
        ...
        class C01136 implements Runnable {
            ...
            C01136(ServiceCallbacks serviceCallbacks, Bundle bundle) {
                this.val$callbacks = serviceCallbacks;
                this.val$rootHints = bundle;
            }
        ...
        class C01147 implements Runnable {
            final /* synthetic */ ServiceCallbacks val$callbacks;

            C01147(ServiceCallbacks serviceCallbacks) {
                this.val$callbacks = serviceCallbacks;
            }
        ...
        public void connect(String pkg, int uid, Bundle rootHints, ServiceCallbacks callbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(pkg, uid)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01081(callbacks, pkg, rootHints, uid));
                return;
            }
        ...
        public void disconnect(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01092(callbacks));
        }

        public void addSubscription(String id, IBinder token, Bundle options, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01103(callbacks, id, token, options));
        }

        public void removeSubscription(String id, IBinder token, ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01114(callbacks, id, token));
        }

        public void getMediaItem(String mediaId, ResultReceiver receiver, ServiceCallbacks callbacks) {
            if (!TextUtils.isEmpty(mediaId) && receiver != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01125(callbacks, mediaId, receiver));
            }
        }

        public void registerCallbacks(ServiceCallbacks callbacks, Bundle rootHints) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01136(callbacks, rootHints));
        }

        public void unregisterCallbacks(ServiceCallbacks callbacks) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new C01147(callbacks));
        }
    }
    ...
    void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C01001(parentId, connection, parentId, options);
    ...
    void performLoadItem(String itemId, ConnectionRecord connection, ResultReceiver receiver) {
        Result<MediaItem> result = new C01012(itemId, receiver);
        this.mCurConnection = connection;
