...
class FragmentTransitionCompat21 {
    ...
    static class C00751 extends EpicenterCallback {
    ...
    static class C00762 implements OnPreDrawListener {
        ...
        C00762(View view, Transition transition, View view2, ViewRetriever viewRetriever, Map map, Map map2, ArrayList arrayList, Transition transition2) {
    ...
    static class C00773 extends EpicenterCallback {
        private Rect mEpicenter;
        final /* synthetic */ EpicenterView val$epicenterView;

        C00773(EpicenterView epicenterView) {
    ...
    static class C00784 implements OnPreDrawListener {
        final /* synthetic */ Transition val$enterTransition;
        final /* synthetic */ ArrayList val$enteringViews;
        final /* synthetic */ Transition val$exitTransition;
        ...
        C00784(View view, Transition transition, ArrayList arrayList, Transition transition2, ArrayList arrayList2, Transition transition3, ArrayList arrayList3, Map map, ArrayList arrayList4, Transition transition4, View view2) {
    ...
    public static void setEpicenter(Object transitionObject, View view) {
        ((Transition) transitionObject).setEpicenterCallback(new C00751(getBoundsOnScreen(view)));
    }
    ...
    public static void addTransitionTargets(Object enterTransitionObject, Object sharedElementTransitionObject, Object exitTransitionObject, View container, ViewRetriever inFragment, View nonExistentView, EpicenterView epicenterView, Map<String, String> nameOverrides, ArrayList<View> enteringViews, ArrayList<View> exitingViews, Map<String, View> namedViews, Map<String, View> renamedViews, ArrayList<View> sharedElementTargets) {
        ...
        if (enterTransitionObject != null || sharedElementTransitionObject != null) {
            ...
            container.getViewTreeObserver().addOnPreDrawListener(new C00762(container, enterTransition, nonExistentView, inFragment, nameOverrides, renamedViews, enteringViews, exitTransition));
    ...
    private static void setSharedElementEpicenter(Transition transition, EpicenterView epicenterView) {
        if (transition != null) {
            transition.setEpicenterCallback(new C00773(epicenterView));
        }
    }
    ...
    public static void cleanupTransitions(View sceneRoot, View nonExistentView, Object enterTransitionObject, ArrayList<View> enteringViews, Object exitTransitionObject, ArrayList<View> exitingViews, Object sharedElementTransitionObject, ArrayList<View> sharedElementTargets, Object overallTransitionObject, ArrayList<View> hiddenViews, Map<String, View> renamedViews) {
        ...
        if (overallTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00784(sceneRoot, enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementTargets, renamedViews, hiddenViews, overallTransition, nonExistentView));
        }
    }
