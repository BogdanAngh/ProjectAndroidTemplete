...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    class C00681 implements ViewRetriever {
        final /* synthetic */ Fragment val$inFragment;

        C00681(Fragment fragment) {
    ...
    class C00692 implements OnPreDrawListener {
        ...
        C00692(View view, Object obj, ArrayList arrayList, TransitionState transitionState, Object obj2, Object obj3, boolean z, Fragment fragment, Fragment fragment2) {
    ...
    class C00703 implements OnPreDrawListener {
        ...
        C00703(View view, TransitionState transitionState, int i, Object obj) {
            this.val$sceneRoot = view;
            this.val$state = transitionState;
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        ViewRetriever c00681 = new C00681(inFragment);
        ...
        if (transition != null) {
            FragmentTransitionCompat21.addTransitionTargets(enterTransition, sharedElementTransition, exitTransition, sceneRoot, c00681, state.nonExistentView, state.enteringEpicenterView, state.nameOverrides, enteringViews, exitingViews, namedViews, renamedViews, sharedElementTargets);
    ...
    private void prepareSharedElementTransition(TransitionState state, View sceneRoot, Object sharedElementTransition, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayList<View> sharedElementTargets, Object enterTransition, Object exitTransition) {
        if (sharedElementTransition != null) {
            sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00692(sceneRoot, sharedElementTransition, sharedElementTargets, state, enterTransition, exitTransition, isBack, inFragment, outFragment));
        }
    }
    ...
    private void excludeHiddenFragmentsAfterEnter(View sceneRoot, TransitionState state, int containerId, Object transition) {
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new C00703(sceneRoot, state, containerId, transition));
    }
