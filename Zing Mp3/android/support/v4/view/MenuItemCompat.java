...
public final class MenuItemCompat {
    ...
    static class IcsMenuVersionImpl extends HoneycombMenuVersionImpl {
        ...
        class C01561 implements SupportActionExpandProxy {
            final /* synthetic */ OnActionExpandListener val$listener;

            C01561(OnActionExpandListener onActionExpandListener) {
        ...
        public MenuItem setOnActionExpandListener(MenuItem item, OnActionExpandListener listener) {
            ...
            return MenuItemCompatIcs.setOnActionExpandListener(item, new C01561(listener));
        }
    }
