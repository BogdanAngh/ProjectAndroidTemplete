...
class ViewPropertyAnimatorCompatJB {
    ...
    static class C01671 extends AnimatorListenerAdapter {
        final /* synthetic */ ViewPropertyAnimatorListener val$listener;
        final /* synthetic */ View val$view;

        C01671(ViewPropertyAnimatorListener viewPropertyAnimatorListener, View view) {
    ...
    public static void setListener(View view, ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new C01671(listener, view));
        } else {
