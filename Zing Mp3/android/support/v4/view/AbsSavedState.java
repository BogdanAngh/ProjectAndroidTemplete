...
public abstract class AbsSavedState implements Parcelable {
    ...
    static class C01491 extends AbsSavedState {
        C01491() {
            super();
        }
    }
    ...
    static class C01502 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C01502() {
        }
    ...
    static {
        EMPTY_STATE = new C01491();
        CREATOR = ParcelableCompat.newCreator(new C01502());
    }
