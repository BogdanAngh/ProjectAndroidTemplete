...
class ViewCompatLollipop {
    ...
    static class C01601 implements OnApplyWindowInsetsListener {
        final /* synthetic */ OnApplyWindowInsetsListenerBridge val$bridge;

        C01601(OnApplyWindowInsetsListenerBridge onApplyWindowInsetsListenerBridge) {
    ...
    public static void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListenerBridge bridge) {
        if (bridge == null) {
            ...
            view.setOnApplyWindowInsetsListener(new C01601(bridge));
        }
    }
