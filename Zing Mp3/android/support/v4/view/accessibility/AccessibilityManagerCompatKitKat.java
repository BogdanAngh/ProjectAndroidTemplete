...
class AccessibilityManagerCompatKitKat {
    ...
    static class C01711 implements TouchExplorationStateChangeListener {
        final /* synthetic */ TouchExplorationStateChangeListenerBridge val$bridge;

        C01711(TouchExplorationStateChangeListenerBridge touchExplorationStateChangeListenerBridge) {
