...
public class ViewPager extends ViewGroup {
    ...
    static class C01611 implements Comparator<ItemInfo> {
        C01611() {
        }
    ...
    static class C01622 implements Interpolator {
        C01622() {
        }
    ...
    class C01644 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C01651 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01651() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01651());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C01611();
        sInterpolator = new C01622();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C01633();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01644());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & C1569R.styleable.AppCompatTheme_spinnerStyle;
                    ...
                    if (consumeVertical) {
                        widthMode = C0989C.ENCODING_PCM_32BIT;
                    } else if (consumeHorizontal) {
                        heightMode = C0989C.ENCODING_PCM_32BIT;
                    }
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, C0989C.ENCODING_PCM_32BIT);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, C0989C.ENCODING_PCM_32BIT);
        this.mInLayout = true;
        populate();
        ...
        for (i = SCROLL_STATE_IDLE; i < size; i += SCROLL_STATE_DRAGGING) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), C0989C.ENCODING_PCM_32BIT), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            int makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), C0989C.ENCODING_PCM_32BIT);
                            child.measure(widthSpec, MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, C0989C.ENCODING_PCM_32BIT));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
