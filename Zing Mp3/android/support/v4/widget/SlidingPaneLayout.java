...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C01901 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01901() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C01901());
        }
    }
        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (r0 == -2) {
                    ...
                    i2 = lp.width;
                    if (r0 == -1) {
                        childWidthSpec = MeasureSpec.makeMeasureSpec(widthAvailable - horizontalMargin, C0989C.ENCODING_PCM_32BIT);
                    } else {
                        childWidthSpec = MeasureSpec.makeMeasureSpec(lp.width, C0989C.ENCODING_PCM_32BIT);
                    }
                }
                i2 = lp.height;
                if (r0 == -2) {
                    ...
                    i2 = lp.height;
                    if (r0 == -1) {
                        childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, C0989C.ENCODING_PCM_32BIT);
                    } else {
                        childHeightSpec = MeasureSpec.makeMeasureSpec(lp.height, C0989C.ENCODING_PCM_32BIT);
                    }
                }
                                ...
                                if (canSlide) {
                                    ...
                                    if (child != r0) {
                                        if (lp.width >= 0) {
                                            ...
                                            if (skippedFirstPass) {
                                                childHeightSpec = MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), C0989C.ENCODING_PCM_32BIT);
                                            } else {
                                                i2 = lp.height;
                                                if (r0 != -2) {
                                                    childHeightSpec = MeasureSpec.makeMeasureSpec(maxLayoutHeight, Cue.TYPE_UNSET);
                                            ...
                                            child.measure(MeasureSpec.makeMeasureSpec(fixedPanelWidthLimit, C0989C.ENCODING_PCM_32BIT), childHeightSpec);
                                        }
                                    }
                                }
                                if (lp.weight <= 0.0f) {
                                    ...
                                    if (canSlide) {
                                        child.measure(MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), C0989C.ENCODING_PCM_32BIT), childHeightSpec);
                                    } else {
                                        newWidth = widthAvailable - (lp.leftMargin + lp.rightMargin);
                                        childWidthSpec = MeasureSpec.makeMeasureSpec(newWidth, C0989C.ENCODING_PCM_32BIT);
