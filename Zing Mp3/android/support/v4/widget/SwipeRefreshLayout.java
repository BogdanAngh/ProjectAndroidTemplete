...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C01922 extends Animation {
        C01922() {
        }
    ...
    class C01933 extends Animation {
        C01933() {
        }
    ...
    class C01944 extends Animation {
    ...
    class C01955 implements AnimationListener {
        C01955() {
        }
    ...
    class C01966 extends Animation {
        C01966() {
        }
    ...
    class C01977 extends Animation {
        C01977() {
        }
    ...
    class C01988 extends Animation {
        C01988() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mRefreshListener = new C01911();
        this.mAnimateToCorrectPosition = new C01966();
        this.mAnimateToStartPosition = new C01977();
    ...
    private void startScaleUpAnimation(AnimationListener listener) {
        ...
        this.mScaleAnimation = new C01922();
    ...
    void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new C01933();
    ...
    private Animation startAlphaAnimation(int startingAlpha, int endingAlpha) {
        ...
        Animation alpha = new C01944(startingAlpha, endingAlpha);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            this.mTarget.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), C0989C.ENCODING_PCM_32BIT));
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleDiameter, C0989C.ENCODING_PCM_32BIT), MeasureSpec.makeMeasureSpec(this.mCircleDiameter, C0989C.ENCODING_PCM_32BIT));
            this.mCircleViewIndex = INVALID_POINTER;
    ...
    private void startScaleDownReturnToStartAnimation(int from, AnimationListener listener) {
        ...
        this.mScaleDownToStartAnimation = new C01988();
