...
class SearchViewCompatHoneycomb {
    ...
    static class C01881 implements OnQueryTextListener {
        final /* synthetic */ OnQueryTextListenerCompatBridge val$listener;

        C01881(OnQueryTextListenerCompatBridge onQueryTextListenerCompatBridge) {
    ...
    static class C01892 implements OnCloseListener {
        final /* synthetic */ OnCloseListenerCompatBridge val$listener;

        C01892(OnCloseListenerCompatBridge onCloseListenerCompatBridge) {
