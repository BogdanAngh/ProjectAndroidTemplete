...
public class FileProvider extends ContentProvider {
    ...
    private static PathStrategy parsePathStrategy(Context context, String authority) throws IOException, XmlPullParserException {
        ...
        XmlResourceParser in = context.getPackageManager().resolveContentProvider(authority, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS).loadXmlMetaData(context.getPackageManager(), META_DATA_FILE_PROVIDER_PATHS);
        if (in == null) {
