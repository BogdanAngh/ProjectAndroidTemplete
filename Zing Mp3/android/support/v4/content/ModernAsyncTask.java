...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static class C00851 implements ThreadFactory {
    ...
    class C00862 extends WorkerRunnable<Params, Result> {
        C00862() {
        }
    ...
    class C00873 extends FutureTask<Result> {
        C00873(Callable x0) {
            super(x0);
        }
    ...
    public ModernAsyncTask() {
        ...
        this.mWorker = new C00862();
        this.mFuture = new C00873(this.mWorker);
    }
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, Params... params) {
        if (this.mStatus != Status.PENDING) {
            switch (C00884.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()]) {
