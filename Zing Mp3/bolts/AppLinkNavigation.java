...
public class AppLinkNavigation {
    ...
    static class C03241 implements Continuation<AppLink, NavigationResult> {
        final /* synthetic */ Context val$context;

        C03241(Context context) {
    ...
    public static Task<NavigationResult> navigateInBackground(Context context, Uri destination, AppLinkResolver resolver) {
        return resolver.getAppLinkFromUrlInBackground(destination).onSuccess(new C03241(context), Task.UI_THREAD_EXECUTOR);
    }
