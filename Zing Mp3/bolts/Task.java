...
public class Task<TResult> {
    ...
    static class AnonymousClass15 implements Runnable {
        ...
        class C03271 implements Continuation<TContinuationResult, Void> {
            C03271() {
            }
            ...
            if (this.val$ct == null || !this.val$ct.isCancellationRequested()) {
                try {
                    ...
                    if (result == null) {
                        ...
                        result.continueWith(new C03271());
                        return;
                    }
                } catch (CancellationException e) {
                    this.val$tcs.setCancelled();
    ...
    static class C03281 implements Runnable {
        final /* synthetic */ TaskCompletionSource val$tcs;

        C03281(TaskCompletionSource taskCompletionSource) {
            this.val$tcs = taskCompletionSource;
        }
    ...
    static class C03292 implements Runnable {
        final /* synthetic */ ScheduledFuture val$scheduled;
        final /* synthetic */ TaskCompletionSource val$tcs;

        C03292(ScheduledFuture scheduledFuture, TaskCompletionSource taskCompletionSource) {
    ...
    class C03303 implements Continuation<TResult, Task<Void>> {
        C03303() {
        }
    ...
    static class C03314 implements Runnable {
        final /* synthetic */ Callable val$callable;
        final /* synthetic */ CancellationToken val$ct;
        final /* synthetic */ TaskCompletionSource val$tcs;

        C03314(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Callable callable) {
            this.val$ct = cancellationToken;
            this.val$tcs = taskCompletionSource;
    ...
    static class C03325 implements Continuation<TResult, Void> {
        final /* synthetic */ TaskCompletionSource val$firstCompleted;
        final /* synthetic */ AtomicBoolean val$isAnyTaskComplete;

        C03325(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource) {
    ...
    static class C03336 implements Continuation<Object, Void> {
        final /* synthetic */ TaskCompletionSource val$firstCompleted;
        final /* synthetic */ AtomicBoolean val$isAnyTaskComplete;

        C03336(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource) {
            this.val$isAnyTaskComplete = atomicBoolean;
            this.val$firstCompleted = taskCompletionSource;
        }
    ...
    static class C03347 implements Continuation<Void, List<TResult>> {
        final /* synthetic */ Collection val$tasks;

        C03347(Collection collection) {
    ...
    static class C03358 implements Continuation<Object, Void> {
        ...
        C03358(Object obj, ArrayList arrayList, AtomicBoolean atomicBoolean, AtomicInteger atomicInteger, TaskCompletionSource taskCompletionSource) {
    ...
    class C03369 implements Continuation<Void, Task<Void>> {
        final /* synthetic */ Continuation val$continuation;
        final /* synthetic */ CancellationToken val$ct;
        final /* synthetic */ Executor val$executor;
        ...
        C03369(CancellationToken cancellationToken, Callable callable, Continuation continuation, Executor executor, Capture capture) {
            this.val$ct = cancellationToken;
    ...
    static Task<Void> delay(long delay, ScheduledExecutorService executor, CancellationToken cancellationToken) {
        ...
        ScheduledFuture<?> scheduled = executor.schedule(new C03281(tcs), delay, TimeUnit.MILLISECONDS);
        if (cancellationToken != null) {
            cancellationToken.register(new C03292(scheduled, tcs));
        }
        return tcs.getTask();
    }
    ...
    public Task<Void> makeVoid() {
        return continueWithTask(new C03303());
    }
    ...
    public static <TResult> Task<TResult> call(Callable<TResult> callable, Executor executor, CancellationToken ct) {
        TaskCompletionSource<TResult> tcs = new TaskCompletionSource();
        try {
            executor.execute(new C03314(ct, tcs, callable));
        } catch (Exception e) {
    ...
    public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
        ...
        for (Task<TResult> task : tasks) {
            task.continueWith(new C03325(isAnyTaskComplete, firstCompleted));
        }
    ...
    public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
        ...
        AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
        for (Task<?> task : tasks) {
            task.continueWith(new C03336(isAnyTaskComplete, firstCompleted));
        }
        return firstCompleted.getTask();
    }

    public static <TResult> Task<List<TResult>> whenAllResult(Collection<? extends Task<TResult>> tasks) {
        return whenAll(tasks).onSuccess(new C03347(tasks));
    }
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
        ...
        for (Task<Object> t : tasks) {
            t.continueWith(new C03358(errorLock, causes, isCancelled, count, allFinished));
        }
    ...
    public Task<Void> continueWhile(Callable<Boolean> predicate, Continuation<Void, Task<Void>> continuation, Executor executor, CancellationToken ct) {
        ...
        predicateContinuation.set(new C03369(ct, predicate, continuation, executor, predicateContinuation));
