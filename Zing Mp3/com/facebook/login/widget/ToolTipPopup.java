...
public class ToolTipPopup {
    ...
    class C09061 implements OnScrollChangedListener {
        C09061() {
        }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C0369R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C0369R.id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C0369R.id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C0369R.id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C0369R.id.com_facebook_button_xout);
        }
    ...
    public ToolTipPopup(String text, View anchor) {
        ...
        this.mScrollListener = new C09061();
        this.mText = text;
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C0369R.id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0369R.drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C0369R.drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0369R.drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C0369R.drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C0369R.drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C0369R.drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C0369R.drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C0369R.drawable.com_facebook_tooltip_black_xout);
            }
            ...
            if (this.mNuxDisplayTime > 0) {
                this.mPopupContent.postDelayed(new C09072(), this.mNuxDisplayTime);
            }
            this.mPopupWindow.setTouchable(true);
            this.mPopupContent.setOnClickListener(new C09083());
        }
    }
