...
public class LoginFragment extends Fragment {
    ...
    class C08921 implements OnCompletedListener {
        C08921() {
        }
    ...
    class C08932 implements BackgroundProcessingListener {
        ...
        public void onBackgroundProcessingStarted() {
            this.val$view.findViewById(C0369R.id.com_facebook_login_activity_progress_bar).setVisibility(0);
        }

        public void onBackgroundProcessingStopped() {
            this.val$view.findViewById(C0369R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.loginClient.setOnCompletedListener(new C08921());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(C0369R.layout.com_facebook_login_fragment, container, false);
        this.loginClient.setBackgroundProcessingListener(new C08932(view));
        return view;
    }
    ...
    public void onPause() {
        super.onPause();
        getActivity().findViewById(C0369R.id.com_facebook_login_activity_progress_bar).setVisibility(8);
    }
