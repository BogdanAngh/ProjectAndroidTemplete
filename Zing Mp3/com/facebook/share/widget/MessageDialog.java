...
public final class MessageDialog extends FacebookDialogBase<ShareContent, Result> implements Sharer {
    ...
    private class NativeHandler extends ModeHandler {
        ...
        class C09841 implements ParameterProvider {
            ...
            C09841(AppCall appCall, ShareContent shareContent, boolean z) {
        ...
        public AppCall createAppCall(ShareContent content) {
            ...
            DialogPresenter.setupAppCallForNativeDialog(appCall, new C09841(appCall, content, MessageDialog.this.getShouldFailOnDataError()), MessageDialog.getFeature(content.getClass()));
            return appCall;
        }
    }
