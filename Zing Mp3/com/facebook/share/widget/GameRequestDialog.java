...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    class C09771 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09771(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    class C09782 implements Callback {
        final /* synthetic */ ResultProcessor val$resultProcessor;

        C09782(ResultProcessor resultProcessor) {
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, FacebookCallback<Result> callback) {
        ...
        if (callback == null) {
            ...
            resultProcessor = new C09771(callback, callback);
        }
        callbackManager.registerCallback(getRequestCode(), new C09782(resultProcessor));
    }
