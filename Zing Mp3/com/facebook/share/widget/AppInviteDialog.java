...
public class AppInviteDialog extends FacebookDialogBase<AppInviteContent, Result> {
    ...
    class C09711 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09711(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    class C09722 implements Callback {
        final /* synthetic */ ResultProcessor val$resultProcessor;

        C09722(ResultProcessor resultProcessor) {
    ...
    private class NativeHandler extends ModeHandler {
        ...
        class C09731 implements ParameterProvider {
            final /* synthetic */ AppInviteContent val$content;

            C09731(AppInviteContent appInviteContent) {
        ...
        public AppCall createAppCall(AppInviteContent content) {
            ...
            DialogPresenter.setupAppCallForNativeDialog(appCall, new C09731(content), AppInviteDialog.getFeature());
            return appCall;
        }
    }
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, FacebookCallback<Result> callback) {
        ...
        if (callback == null) {
            ...
            resultProcessor = new C09711(callback, callback);
        }
        callbackManager.registerCallback(getRequestCode(), new C09722(resultProcessor));
    }
