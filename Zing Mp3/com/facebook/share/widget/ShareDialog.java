...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Result> implements Sharer {
    ...
    private class NativeHandler extends ModeHandler {
        ...
        class C09871 implements ParameterProvider {
            ...
            C09871(AppCall appCall, ShareContent shareContent, boolean z) {
        ...
        public AppCall createAppCall(ShareContent content) {
            ...
            AppCall appCall = ShareDialog.this.createBaseAppCall();
            DialogPresenter.setupAppCallForNativeDialog(appCall, new C09871(appCall, content, ShareDialog.this.getShouldFailOnDataError()), ShareDialog.getFeature(content.getClass()));
            return appCall;
        }
    }
    ...
    private void logDialogShare(Context context, ShareContent content, Mode mode) {
        ...
        switch (C09861.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()]) {
