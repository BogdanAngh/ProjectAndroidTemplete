...
public class JoinAppGroupDialog extends FacebookDialogBase<String, Result> {
    ...
    class C09791 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09791(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    class C09802 implements Callback {
        ...
        C09802(ResultProcessor resultProcessor) {
    ...
    private class WebHandler extends ModeHandler {
        ...
        public AppCall createAppCall(String content) {
            ...
            params.putString(TtmlNode.ATTR_ID, content);
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, FacebookCallback<Result> callback) {
        callbackManager.registerCallback(getRequestCode(), new C09802(callback == null ? null : new C09791(callback, callback)));
    }
