...
public class CreateAppGroupDialog extends FacebookDialogBase<AppGroupCreationContent, Result> {
    ...
    class C09741 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09741(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    class C09752 implements Callback {
        final /* synthetic */ ResultProcessor val$resultProcessor;

        C09752(ResultProcessor resultProcessor) {
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, FacebookCallback<Result> callback) {
        callbackManager.registerCallback(getRequestCode(), new C09752(callback == null ? null : new C09741(callback, callback)));
    }
