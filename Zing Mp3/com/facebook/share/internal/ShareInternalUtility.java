...
public final class ShareInternalUtility {
    ...
    static class C09431 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09431(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    static class C09442 implements Callback {
    ...
    static class C09453 implements Callback {
        final /* synthetic */ FacebookCallback val$callback;
        final /* synthetic */ int val$requestCode;

        C09453(int i, FacebookCallback facebookCallback) {
            this.val$requestCode = i;
            this.val$callback = facebookCallback;
        }
    ...
    static class C09464 implements Mapper<SharePhoto, Attachment> {
    ...
    static class C09475 implements Mapper<Attachment, String> {
        C09475() {
        }
    ...
    static class C09486 implements Mapper<ShareMedia, Bundle> {
        final /* synthetic */ UUID val$appCallId;
        final /* synthetic */ List val$attachments;

        C09486(UUID uuid, List list) {
            this.val$appCallId = uuid;
    ...
    static class C09497 implements PhotoJSONProcessor {
        final /* synthetic */ ArrayList val$attachments;
        final /* synthetic */ UUID val$callId;

        C09497(UUID uuid, ArrayList arrayList) {
    ...
    static class C09508 implements PhotoJSONProcessor {
        C09508() {
        }
    ...
    public static ResultProcessor getShareResultProcessor(FacebookCallback<Result> callback) {
        return new C09431(callback, callback);
    }
    ...
    public static void registerStaticShareCallback(int requestCode) {
        CallbackManagerImpl.registerStaticCallback(requestCode, new C09442(requestCode));
    }
    ...
    public static void registerSharerCallback(int requestCode, CallbackManager callbackManager, FacebookCallback<Result> callback) {
        if (callbackManager instanceof CallbackManagerImpl) {
            ((CallbackManagerImpl) callbackManager).registerCallback(requestCode, new C09453(requestCode, callback));
            return;
        }
    ...
    public static List<String> getPhotoUrls(SharePhotoContent photoContent, UUID appCallId) {
        if (photoContent != null) {
            ...
            if (photos != null) {
                List<Attachment> attachments = Utility.map(photos, new C09464(appCallId));
                List<String> attachmentUrls = Utility.map(attachments, new C09475());
    ...
    public static List<Bundle> getMediaInfos(ShareMediaContent mediaContent, UUID appCallId) {
        if (mediaContent != null) {
            ...
            if (media != null) {
                ...
                List<Bundle> mediaInfos = Utility.map(media, new C09486(appCallId, attachments));
                NativeAppCallAttachmentStore.addAttachments(attachments);
                return mediaInfos;
            }
        }
    ...
    public static JSONObject toJSONObjectForCall(UUID callId, ShareOpenGraphContent content) throws JSONException {
        ...
        JSONObject actionJSON = OpenGraphJSONUtility.toJSONObject(action, new C09497(callId, attachments));
        NativeAppCallAttachmentStore.addAttachments(attachments);
    ...
    public static JSONObject toJSONObjectForWeb(ShareOpenGraphContent shareOpenGraphContent) throws JSONException {
        return OpenGraphJSONUtility.toJSONObject(shareOpenGraphContent.getAction(), new C09508());
    }
