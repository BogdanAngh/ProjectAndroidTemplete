...
public class LikeDialog extends FacebookDialogBase<LikeContent, Result> {
    ...
    class C09381 extends ResultProcessor {
        final /* synthetic */ FacebookCallback val$callback;

        C09381(FacebookCallback x0, FacebookCallback facebookCallback) {
    ...
    class C09392 implements Callback {
        final /* synthetic */ ResultProcessor val$resultProcessor;

        C09392(ResultProcessor resultProcessor) {
    ...
    private class NativeHandler extends ModeHandler {
        ...
        class C09401 implements ParameterProvider {
            final /* synthetic */ LikeContent val$content;

            C09401(LikeContent likeContent) {
        ...
        public AppCall createAppCall(LikeContent content) {
            ...
            DialogPresenter.setupAppCallForNativeDialog(appCall, new C09401(content), LikeDialog.getFeature());
            return appCall;
        }
    }
    ...
    protected void registerCallbackImpl(CallbackManagerImpl callbackManager, FacebookCallback<Result> callback) {
        callbackManager.registerCallback(getRequestCode(), new C09392(callback == null ? null : new C09381(callback, callback)));
    }
