...
public class LikeActionController {
    ...
    class AnonymousClass11 implements Callback {
        ...
        public void onBatchCompleted(GraphRequestBatch batch) {
            ...
            if (Utility.isNullOrEmpty(LikeActionController.this.verifiedObjectId)) {
                ...
                LikeActionController.this.logAppEventForError("get_verified_id", this.val$pageIdRequest.getError() != null ? this.val$pageIdRequest.getError() : this.val$objectIdRequest.getError());
            }
    ...
    static class C09241 implements CreationCallback {
        final /* synthetic */ Intent val$data;
        final /* synthetic */ int val$requestCode;
        final /* synthetic */ int val$resultCode;

        C09241(int i, int i2, Intent intent) {
    ...
    static class C09252 implements Runnable {
        final /* synthetic */ LikeActionController val$controllerToRefresh;

        C09252(LikeActionController likeActionController) {
    ...
    static class C09263 implements CallbackManagerImpl.Callback {
        C09263() {
        }
    ...
    static class C09274 implements Runnable {
        ...
        C09274(CreationCallback creationCallback, LikeActionController likeActionController, FacebookException facebookException) {
    ...
    static class C09285 extends AccessTokenTracker {
        C09285() {
        }
    ...
    class C09296 extends ResultProcessor {
        final /* synthetic */ Bundle val$analyticsParameters;

        C09296(FacebookCallback x0, Bundle bundle) {
        ...
        public void onSuccess(AppCall appCall, Bundle data) {
            if (data != null && data.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY)) {
                ...
                String unlikeToken = data.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY) ? data.getString(LikeActionController.LIKE_DIALOG_RESPONSE_UNLIKE_TOKEN_KEY) : LikeActionController.this.unlikeToken;
    ...
    class C09317 implements RequestCompletionCallback {
        final /* synthetic */ Bundle val$analyticsParameters;

        /* renamed from: com.facebook.share.internal.LikeActionController.7.1 */
        class C09301 implements Callback {
            final /* synthetic */ PublishLikeRequestWrapper val$likeRequest;

            C09301(PublishLikeRequestWrapper publishLikeRequestWrapper) {
            ...
            public void onBatchCompleted(GraphRequestBatch batch) {
                ...
                LikeActionController.this.getAppEventsLogger().logSdkEvent(AnalyticsEvents.EVENT_LIKE_VIEW_DID_LIKE, null, C09317.this.val$analyticsParameters);
                LikeActionController.this.publishAgainIfNeeded(C09317.this.val$analyticsParameters);
            }
        }

        C09317(Bundle bundle) {
            this.val$analyticsParameters = bundle;
        }
        ...
        public void onComplete() {
            ...
            requestBatch.addCallback(new C09301(likeRequest));
            requestBatch.executeAsync();
        }
    }

    /* renamed from: com.facebook.share.internal.LikeActionController.8 */
    class C09328 implements Callback {
        final /* synthetic */ Bundle val$analyticsParameters;
        final /* synthetic */ PublishUnlikeRequestWrapper val$unlikeRequest;

        C09328(PublishUnlikeRequestWrapper publishUnlikeRequestWrapper, Bundle bundle) {
    ...
    class C09349 implements RequestCompletionCallback {

        /* renamed from: com.facebook.share.internal.LikeActionController.9.1 */
        class C09331 implements Callback {
            ...
            C09331(LikeRequestWrapper likeRequestWrapper, GetEngagementRequestWrapper getEngagementRequestWrapper) {
        ...
        public void onComplete() {
            ...
            requestBatch.addCallback(new C09331(likeRequestWrapper, engagementRequest));
            requestBatch.executeAsync();
        }
    }
    ...
    private abstract class AbstractRequestWrapper implements RequestWrapper {
        ...
        class C09351 implements GraphRequest.Callback {
            C09351() {
            }
        ...
        protected void setRequest(GraphRequest request) {
            ...
            request.setCallback(new C09351());
        }
    ...
    private class GetOGObjectIdRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(GraphResponse response) {
            ...
            if (results != null) {
                ...
                if (ogObject != null) {
                    this.verifiedObjectId = ogObject.optString(TtmlNode.ATTR_ID);
                }
            }
        }
    }
            ...
            if (dataSet != null) {
                for (int i = 0; i < dataSet.length(); i++) {
                    ...
                    if (data != null) {
                        ...
                        if (!(appData == null || accessToken == null || !Utility.areObjectsEqual(accessToken.getApplicationId(), appData.optString(TtmlNode.ATTR_ID)))) {
                            this.unlikeToken = data.optString(TtmlNode.ATTR_ID);
                        }
                    }
                }
            }
    ...
    private class GetPageIdRequestWrapper extends AbstractRequestWrapper {
        ...
        GetPageIdRequestWrapper(String objectId, ObjectType objectType) {
            ...
            pageIdRequestParams.putString(GraphRequest.FIELDS_PARAM, TtmlNode.ATTR_ID);
        ...
        protected void processSuccess(GraphResponse response) {
            JSONObject results = Utility.tryGetJSONObjectFromResponse(response.getJSONObject(), this.objectId);
            if (results != null) {
                this.verifiedObjectId = results.optString(TtmlNode.ATTR_ID);
    ...
    private class GetPageLikesRequestWrapper extends AbstractRequestWrapper implements LikeRequestWrapper {
        ...
        GetPageLikesRequestWrapper(String pageId) {
            ...
            this.pageId = pageId;
            Bundle requestParams = new Bundle();
            requestParams.putString(GraphRequest.FIELDS_PARAM, TtmlNode.ATTR_ID);
    ...
    private class PublishLikeRequestWrapper extends AbstractRequestWrapper {
        ...
        protected void processSuccess(GraphResponse response) {
            this.unlikeToken = Utility.safeGetStringFromResponse(response.getJSONObject(), TtmlNode.ATTR_ID);
        }
    ...
    public static boolean handleOnActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        getControllerForObjectId(objectIdForPendingController, ObjectType.UNKNOWN, new C09241(requestCode, resultCode, data));
        return true;
    }
    ...
    private static void createControllerForObjectIdAndType(String objectId, ObjectType objectType, CreationCallback callback) {
        ...
        handler.post(new C09252(controllerToRefresh));
    ...
    private static synchronized void performFirstInitialize() {
        synchronized (LikeActionController.class) {
            if (!isInitialized) {
                ...
                CallbackManagerImpl.registerStaticCallback(RequestCodeOffset.Like.toRequestCode(), new C09263());
                isInitialized = true;
            }
        }
    }
    ...
    private static void invokeCallbackWithController(CreationCallback callback, LikeActionController controller, FacebookException error) {
        if (callback != null) {
            handler.post(new C09274(callback, controller, error));
        }
    }

    private static void registerAccessTokenTracker() {
        accessTokenTracker = new C09285();
    }
    ...
    private ResultProcessor getResultProcessor(Bundle analyticsParameters) {
        return new C09296(null, analyticsParameters);
    }
    ...
    private void publishLikeAsync(Bundle analyticsParameters) {
        ...
        fetchVerifiedObjectId(new C09317(analyticsParameters));
    }
    ...
    private void publishUnlikeAsync(Bundle analyticsParameters) {
        ...
        requestBatch.addCallback(new C09328(unlikeRequest, analyticsParameters));
        requestBatch.executeAsync();
    }
    ...
    private void refreshStatusAsync() {
        if (AccessToken.getCurrentAccessToken() == null) {
            ...
            fetchVerifiedObjectId(new C09349());
        }
    }
