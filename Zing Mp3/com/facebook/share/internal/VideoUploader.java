...
public class VideoUploader {
    ...
    static class C09511 extends AccessTokenTracker {
        C09511() {
        }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        class C09562 implements Runnable {
            final /* synthetic */ FacebookException val$error;
            final /* synthetic */ String val$videoId;

            C09562(FacebookException facebookException, String str) {
        ...
        private boolean attemptRetry(int errorCode) {
            ...
            VideoUploader.getHandler().postDelayed(new C09551(), (long) (((int) Math.pow(3.0d, (double) this.completedRetries)) * VideoUploader.RETRY_DELAY_UNIT_MS));
            return true;
        }
        ...
        protected void issueResponseOnMainThread(FacebookException error, String videoId) {
            VideoUploader.getHandler().post(new C09562(error, videoId));
        }
    }
    ...
    private static class FinishUploadWorkItem extends UploadWorkItemBase {
        ...
        static class C09521 extends HashSet<Integer> {
            C09521() {
        ...
        static {
            transientErrorCodes = new C09521();
        }
    ...
    private static class StartUploadWorkItem extends UploadWorkItemBase {
        ...
        static class C09531 extends HashSet<Integer> {
            C09531() {
        ...
        static {
            transientErrorCodes = new C09531();
        }
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        static class C09541 extends HashSet<Integer> {
            C09541() {
        ...
        static {
            transientErrorCodes = new C09541();
        }
