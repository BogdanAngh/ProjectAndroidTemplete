...
public final class ShareApi {
    ...
    class AnonymousClass10 implements Callback {
        ...
        public void onCompleted(GraphResponse response) {
            ...
            String stagedObjectId = data.optString(TtmlNode.ATTR_ID);
    ...
    class C09101 implements Callback {
        final /* synthetic */ FacebookCallback val$callback;

        C09101(FacebookCallback facebookCallback) {
            this.val$callback = facebookCallback;
        }

        public void onCompleted(GraphResponse response) {
            JSONObject data = response.getJSONObject();
            ShareInternalUtility.invokeCallbackWithResults(this.val$callback, data == null ? null : data.optString(TtmlNode.ATTR_ID), response);
        }
    }

    /* renamed from: com.facebook.share.ShareApi.2 */
    class C09112 implements OnMapperCompleteListener {
        final /* synthetic */ ShareOpenGraphAction val$action;
        final /* synthetic */ FacebookCallback val$callback;
        final /* synthetic */ Bundle val$parameters;
        final /* synthetic */ Callback val$requestCallback;

        C09112(Bundle bundle, ShareOpenGraphAction shareOpenGraphAction, Callback callback, FacebookCallback facebookCallback) {
    ...
    class C09123 implements Callback {
        final /* synthetic */ FacebookCallback val$callback;
        ...
        C09123(ArrayList arrayList, ArrayList arrayList2, Mutable mutable, FacebookCallback facebookCallback) {
        ...
        public void onCompleted(GraphResponse response) {
            ...
            if (!this.val$errorResponses.isEmpty()) {
                ...
                ShareInternalUtility.invokeCallbackWithResults(this.val$callback, ((JSONObject) this.val$results.get(0)).optString(TtmlNode.ATTR_ID), response);
            }
        }
    }

    /* renamed from: com.facebook.share.ShareApi.4 */
    class C09134 implements Callback {
        final /* synthetic */ FacebookCallback val$callback;

        C09134(FacebookCallback facebookCallback) {
            this.val$callback = facebookCallback;
        }
    ...
    class C09155 implements Collection<Integer> {
        ...
        C09155(ArrayList arrayList, JSONArray jSONArray) {
            this.val$arrayList = arrayList;
            this.val$stagedObject = jSONArray;
        }

        public Iterator<Integer> keyIterator() {
            return new C09141(new Mutable(Integer.valueOf(0)), this.val$arrayList.size());
        }
    ...
    class C09166 implements OnMapperCompleteListener {
        final /* synthetic */ OnMapValueCompleteListener val$onArrayListStagedListener;
        final /* synthetic */ JSONArray val$stagedObject;

        C09166(OnMapValueCompleteListener onMapValueCompleteListener, JSONArray jSONArray) {
    ...
    class C09177 implements ValueMapper {
        C09177() {
        }
    ...
    class C09188 implements Collection<String> {
        final /* synthetic */ Bundle val$parameters;

        C09188(Bundle bundle) {
            this.val$parameters = bundle;
        }
    ...
    class C09199 implements Collection<String> {
        final /* synthetic */ ShareOpenGraphObject val$object;
        final /* synthetic */ JSONObject val$stagedObject;

        C09199(ShareOpenGraphObject shareOpenGraphObject, JSONObject jSONObject) {
    ...
    private void shareOpenGraphContent(ShareOpenGraphContent openGraphContent, FacebookCallback<Result> callback) {
        Callback requestCallback = new C09101(callback);
        ...
        stageOpenGraphAction(parameters, new C09112(parameters, action, requestCallback, callback));
    }
    ...
    private void sharePhotoContent(SharePhotoContent photoContent, FacebookCallback<Result> callback) {
        ...
        Callback requestCallback = new C09123(new ArrayList(), new ArrayList(), requestCount, callback);
        try {
    ...
    private void shareLinkContent(ShareLinkContent linkContent, FacebookCallback<Result> callback) {
        Callback requestCallback = new C09134(callback);
        Bundle parameters = new Bundle();
    ...
    private void stageArrayList(ArrayList arrayList, OnMapValueCompleteListener onArrayListStagedListener) {
        ...
        stageCollectionValues(new C09155(arrayList, stagedObject), new C09166(onArrayListStagedListener, stagedObject));
    }

    private <T> void stageCollectionValues(Collection<T> collection, OnMapperCompleteListener onCollectionValuesStagedListener) {
        CollectionMapper.iterate(collection, new C09177(), onCollectionValuesStagedListener);
    }

    private void stageOpenGraphAction(Bundle parameters, OnMapperCompleteListener onOpenGraphActionStagedListener) {
        stageCollectionValues(new C09188(parameters), onOpenGraphActionStagedListener);
    }
    ...
    private void stageOpenGraphObject(ShareOpenGraphObject object, OnMapValueCompleteListener onOpenGraphObjectStagedListener) {
        ...
        JSONObject stagedObject = new JSONObject();
        stageCollectionValues(new C09199(object, stagedObject), new AnonymousClass11(stagedObject, type, new AnonymousClass10(onOpenGraphObjectStagedListener), onOpenGraphObjectStagedListener));
    }
