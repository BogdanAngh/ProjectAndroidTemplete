...
public class TestUserManager {
    ...
    private AccessToken getAccessTokenForUser(List<String> permissions, Mode mode, String uniqueUserTag) {
        ...
        return new AccessToken(testAccount.optString(ServerProtocol.DIALOG_PARAM_ACCESS_TOKEN), this.testApplicationId, testAccount.optString(TtmlNode.ATTR_ID), permissions, null, AccessTokenSource.TEST_USER, null, null);
    }
    ...
    private synchronized void storeTestAccount(JSONObject testAccount) {
        this.appTestAccounts.put(testAccount.optString(TtmlNode.ATTR_ID), testAccount);
    }
