...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, String analyticsButtonCreatedEventName, String analyticsButtonTappedEventName) {
        ...
        if (defStyleRes == 0) {
            defStyleRes = C0369R.style.com_facebook_button;
        }
        ...
        if (!isInEditMode()) {
            ...
            try {
                if (a.hasValue(0)) {
                    ...
                    setBackgroundColor(ContextCompat.getColor(context, C0369R.color.com_facebook_blue));
                }
                a.recycle();
            } catch (Throwable th) {
                a.recycle();
    ...
    private void setupOnClickListener() {
        super.setOnClickListener(new C03511());
    }
}
