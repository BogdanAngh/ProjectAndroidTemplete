...
public final class Utility {
    ...
    static class C08651 implements Callback {
        final /* synthetic */ String val$accessToken;
        final /* synthetic */ GraphMeRequestWithCacheCallback val$callback;

        C08651(GraphMeRequestWithCacheCallback graphMeRequestWithCacheCallback, String str) {
    ...
    static class C08662 implements FilenameFilter {
        C08662() {
        }
    ...
    public static boolean hasSameId(JSONObject a, JSONObject b) {
        if (a == null || b == null || !a.has(TtmlNode.ATTR_ID) || !b.has(TtmlNode.ATTR_ID)) {
            return false;
        }
        if (a.equals(b)) {
            return true;
        }
        String idA = a.optString(TtmlNode.ATTR_ID);
        String idB = b.optString(TtmlNode.ATTR_ID);
    ...
    public static void getGraphMeRequestWithCacheAsync(String accessToken, GraphMeRequestWithCacheCallback callback) {
        ...
        Callback graphCallback = new C08651(callback, accessToken);
    ...
    private static int refreshBestGuessNumberOfCPUCores() {
        ...
        try {
            File[] cpuFiles = new File("/sys/devices/system/cpu/").listFiles(new C08662());
            if (cpuFiles != null) {
