...
public final class FetchedAppSettingsManager {
    ...
    public static void loadAppSettingsAsync(Context context, String applicationId) {
        ...
        if (!Utility.isNullOrEmpty(applicationId) && !fetchedAppSettings.containsKey(applicationId) && canStartLoading) {
            FacebookSdk.getExecutor().execute(new C08531(context, String.format(APP_SETTINGS_PREFS_KEY_FORMAT, new Object[]{applicationId}), applicationId));
        }
    }
