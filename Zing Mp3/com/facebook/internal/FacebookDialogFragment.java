...
public class FacebookDialogFragment extends DialogFragment {
    ...
    class C08471 implements OnCompleteListener {
        C08471() {
        }
    ...
    class C08482 implements OnCompleteListener {
        C08482() {
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.dialog == null) {
            ...
            if (params.getBoolean(NativeProtocol.WEB_DIALOG_IS_FALLBACK, false)) {
                ...
                webDialog.setOnCompleteListener(new C08482());
            } else {
                ...
                webDialog = new Builder(activity, actionName, webParams).setOnCompleteListener(new C08471()).build();
            }
