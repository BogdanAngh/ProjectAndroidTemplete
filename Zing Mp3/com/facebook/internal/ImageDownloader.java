...
public class ImageDownloader {
    ...
    static class C08591 implements Runnable {
        ...
        C08591(ImageRequest imageRequest, Exception exception, boolean z, Bitmap bitmap, Callback callback) {
    ...
    private static void issueResponse(RequestKey key, Exception error, Bitmap bitmap, boolean isCachedRedirect) {
        ...
        if (completedRequestContext != null && !completedRequestContext.isCancelled) {
            ...
            if (callback != null) {
                getHandler().post(new C08591(request, error, isCachedRedirect, bitmap, callback));
            }
        }
    }
    ...
    L_0x00c3:
        ...
        goto L_0x00ae;
    L_0x00cf:
        r16 = com.facebook.C0369R.string.com_facebook_image_download_unknown_error;	 Catch:{ IOException -> 0x0058, all -> 0x00df }
        r0 = r20;
        r1 = r16;
