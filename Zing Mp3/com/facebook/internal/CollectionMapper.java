...
public class CollectionMapper {
    ...
    static class C08451 implements OnMapperCompleteListener {
        ...
        C08451(Mutable mutable, Mutable mutable2, OnMapperCompleteListener onMapperCompleteListener) {
    ...
    static class C08462 implements OnMapValueCompleteListener {
        final /* synthetic */ Collection val$collection;
        final /* synthetic */ OnMapperCompleteListener val$jobCompleteListener;
        final /* synthetic */ Object val$key;

        C08462(Collection collection, Object obj, OnMapperCompleteListener onMapperCompleteListener) {
    ...
    public static <T> void iterate(Collection<T> collection, ValueMapper valueMapper, OnMapperCompleteListener onMapperCompleteListener) {
        ...
        OnMapperCompleteListener jobCompleteListener = new C08451(didReturnError, pendingJobCount, onMapperCompleteListener);
        ...
        for (T key : keys) {
            ...
            OnMapValueCompleteListener onMapValueCompleteListener = new C08462(collection, key, jobCompleteListener);
