...
final class AccessTokenManager {
    ...
    class C03441 implements Runnable {
        ...
        C03441(AccessTokenRefreshCallback accessTokenRefreshCallback) {
    ...
    class C03452 implements Callback {
        ...
        C03452(AtomicBoolean atomicBoolean, Set set, Set set2) {
    ...
    class C03463 implements Callback {
        final /* synthetic */ RefreshResult val$refreshResult;

        C03463(RefreshResult refreshResult) {
    ...
    class C03474 implements GraphRequestBatch.Callback {
        ...
        C03474(AccessToken accessToken, AccessTokenRefreshCallback accessTokenRefreshCallback, AtomicBoolean atomicBoolean, RefreshResult refreshResult, Set set, Set set2) {
    ...
    void refreshCurrentAccessToken(AccessTokenRefreshCallback callback) {
        if (Looper.getMainLooper().equals(Looper.myLooper())) {
            ...
            new Handler(Looper.getMainLooper()).post(new C03441(callback));
        }
    }
    ...
    private void refreshCurrentAccessTokenImpl(AccessTokenRefreshCallback callback) {
        ...
        if (accessToken == null) {
            ...
            GraphRequestBatch batch = new GraphRequestBatch(createGrantedPermissionsRequest(accessToken, new C03452(new AtomicBoolean(false), permissions, declinedPermissions)), createExtendAccessTokenRequest(accessToken, new C03463(new RefreshResult())));
            batch.addCallback(new C03474(accessToken, callback, permissionsCallSucceeded, refreshResult, permissions, declinedPermissions));
            batch.executeAsync();
