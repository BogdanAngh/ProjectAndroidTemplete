...
public final class FacebookSdk {
    ...
    static class C03531 implements ThreadFactory {
    ...
    static class C03542 implements Callable<File> {
        C03542() {
        }
    ...
    static class C03553 implements Callable<Void> {
        final /* synthetic */ Context val$applicationContext;
        final /* synthetic */ InitializeCallback val$callback;

        C03553(InitializeCallback initializeCallback, Context context) {
    ...
    static class C03564 implements Runnable {
        final /* synthetic */ Context val$applicationContext;
        final /* synthetic */ String val$applicationId;

        C03564(Context context, String str) {
            this.val$applicationContext = context;
    ...
    public static synchronized void sdkInitialize(Context applicationContext, InitializeCallback callback) {
        synchronized (FacebookSdk.class) {
            if (!sdkInitialized.booleanValue()) {
                ...
                FetchedAppSettingsManager.loadAppSettingsAsync(applicationContext, applicationId);
                NativeProtocol.updateAllAvailableProtocolVersionsAsync();
                BoltsMeasurementEventListener.getInstance(applicationContext);
                cacheDir = new LockOnGetVariable(new C03542());
                getExecutor().execute(new FutureTask(new C03553(callback, applicationContext)));
    ...
    public static void publishInstallAsync(Context context, String applicationId) {
        getExecutor().execute(new C03564(context.getApplicationContext(), applicationId));
    }
