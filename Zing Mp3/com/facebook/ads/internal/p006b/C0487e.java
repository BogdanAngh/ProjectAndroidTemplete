...
public class C0487e {
    public static double m720a(View view, Context context) {
        if (!C0487e.m724a(context) || !C0487e.m727d(view)) {
            return 0.0d;
        }
        Rect rect = new Rect();
        ...
        Vector a = C0487e.m723a(view);
        int a2 = C0487e.m721a(a);
        a.add(rect);
        return (((double) (C0487e.m721a(a) - a2)) * 1.0d) / ((double) (view.getMeasuredHeight() * view.getMeasuredWidth()));
    }

    private static int m721a(Vector<Rect> vector) {
        int i;
        int i2;
        ...
        for (i3 = 0; i3 < size; i3++) {
            ...
            i = C0487e.m722a(iArr, rect.left);
            i4 = C0487e.m722a(iArr, rect.right);
            i5 = C0487e.m722a(iArr2, rect.top);
            i6 = C0487e.m722a(iArr2, rect.bottom);
            for (i++; i <= i4; i++) {
    ...
    private static int m722a(int[] iArr, int i) {
        int i2 = 0;
    ...
    private static Vector<Rect> m723a(View view) {
        ...
        for (int indexOfChild = view2.indexOfChild(view) + 1; indexOfChild < view2.getChildCount(); indexOfChild++) {
            vector.addAll(C0487e.m725b(view2.getChildAt(indexOfChild)));
        }
        vector.addAll(C0487e.m723a(view2));
        return vector;
    }

    private static boolean m724a(Context context) {
        if (context == null) {
            return true;
        }
        try {
    ...
    private static Vector<Rect> m725b(View view) {
        Vector<Rect> vector = new Vector();
        if (!view.isShown() || (VERSION.SDK_INT >= 11 && view.getAlpha() <= 0.0f)) {
            return vector;
        }
        if ((view instanceof ViewGroup) && C0487e.m726c(view)) {
            ViewGroup viewGroup = (ViewGroup) view;
            for (int i = 0; i < viewGroup.getChildCount(); i++) {
                vector.addAll(C0487e.m725b(viewGroup.getChildAt(i)));
            }
            return vector;
        }
        Rect rect = new Rect();
