...
class AnalyticsUserIDStore {
    ...
    static class C08101 implements Runnable {
        C08101() {
        }
    ...
    static class C08112 implements Runnable {
    ...
    public static void initStore() {
        if (!initialized) {
            AppEventsLogger.getAnalyticsExecutor().execute(new C08101());
        }
    }
    ...
    public static void setUserID(String id) {
        ...
        AppEventsLogger.getAnalyticsExecutor().execute(new C08112(id));
    }
