...
public class AppEventsLogger {
    ...
    static class C08191 implements Runnable {
        ...
        C08191(AppEventsLogger appEventsLogger, long j, String str) {
    ...
    static class C08202 implements Runnable {
        final /* synthetic */ long val$eventTime;
        final /* synthetic */ AppEventsLogger val$logger;

        C08202(AppEventsLogger appEventsLogger, long j) {
            this.val$logger = appEventsLogger;
            this.val$eventTime = j;
        }
    ...
    static class C08213 implements Runnable {
        final /* synthetic */ String val$applicationID;
        final /* synthetic */ Callback val$callback;
        final /* synthetic */ Bundle val$parameters;
        final /* synthetic */ String val$userID;

        C08213(String str, Bundle bundle, String str2, Callback callback) {
            this.val$userID = str;
    ...
    static class C08224 implements Runnable {
        C08224() {
        }
    ...
    static class PersistedAppSessionInfo {
        ...
        static class C08231 implements Runnable {
            C08231() {
            }
        ...
        static {
            ...
            hasChanges = false;
            isLoaded = false;
            appSessionInfoFlushRunnable = new C08231();
        }
    ...
    public static void activateApp(Context context, String applicationId) {
        if (ActivityLifecycleTracker.isTracking()) {
            ...
            backgroundExecutor.execute(new C08191(new AppEventsLogger(context, applicationId, null), System.currentTimeMillis(), getSourceApplication()));
        }
    }
    ...
    public static void deactivateApp(Context context, String applicationId) {
        if (ActivityLifecycleTracker.isTracking()) {
            ...
            resetSourceApplication();
            backgroundExecutor.execute(new C08202(new AppEventsLogger(context, applicationId, null), System.currentTimeMillis()));
        }
    }
    ...
    public static void updateUserProperties(Bundle parameters, String applicationID, Callback callback) {
        ...
        if (userID == null || userID.isEmpty()) {
            ...
            getAnalyticsExecutor().execute(new C08213(userID, parameters, applicationID, callback));
        }
    }
    ...
    private static void initializeTimersIfNeeded() {
        synchronized (staticLock) {
            ...
            backgroundExecutor.scheduleAtFixedRate(new C08224(), 0, 86400, TimeUnit.SECONDS);
        }
    }
