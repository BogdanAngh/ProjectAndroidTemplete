...
public final class AccessToken implements Parcelable {
    ...
    static class C03421 implements GraphMeRequestWithCacheCallback {
        final /* synthetic */ AccessTokenCreationCallback val$accessTokenCallback;
        final /* synthetic */ String val$applicationId;
        final /* synthetic */ Bundle val$extras;

        C03421(Bundle bundle, AccessTokenCreationCallback accessTokenCreationCallback, String str) {
        ...
        public void onSuccess(JSONObject userInfo) {
            try {
                this.val$extras.putString(AccessToken.USER_ID_KEY, userInfo.getString(TtmlNode.ATTR_ID));
    ...
    static class C03432 implements Creator {
        C03432() {
        }
    ...
    public static void createFromNativeLinkingIntent(Intent intent, String applicationId, AccessTokenCreationCallback accessTokenCallback) {
        ...
        if (userId == null || userId.isEmpty()) {
            Utility.getGraphMeRequestWithCacheAsync(accessToken, new C03421(extras, accessTokenCallback, applicationId));
        } else {
