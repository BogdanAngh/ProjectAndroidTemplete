...
public class MediaCodecAudioTrackRenderer extends MediaCodecTrackRenderer implements MediaClock {
    ...
    class C09921 implements Runnable {
        ...
        C09921(InitializationException initializationException) {
    ...
    class C09932 implements Runnable {
        final /* synthetic */ WriteException val$e;

        C09932(WriteException writeException) {
    ...
    public MediaCodecAudioTrackRenderer(SampleSource[] sources, MediaCodecSelector mediaCodecSelector, DrmSessionManager drmSessionManager, boolean playClearSamplesWithoutKeys, Handler eventHandler, EventListener eventListener, AudioCapabilities audioCapabilities, int streamType) {
        super(sources, mediaCodecSelector, drmSessionManager, playClearSamplesWithoutKeys, eventHandler, (com.google.android.exoplayer.MediaCodecTrackRenderer.EventListener) eventListener);
