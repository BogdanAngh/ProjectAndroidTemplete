...
public final class AudioTrack {
    ...
    class C10061 extends Thread {
        final /* synthetic */ android.media.AudioTrack val$toRelease;

        C10061(android.media.AudioTrack audioTrack) {
    ...
    class C10072 extends Thread {
        final /* synthetic */ android.media.AudioTrack val$toRelease;

        C10072(android.media.AudioTrack audioTrack) {
            this.val$toRelease = audioTrack;
        }
    ...
    private static class AudioTrackUtil {
        ...
        public long getPlaybackHeadPosition() {
            if (this.stopTimestampUs != -1) {
                return Math.min(this.endPlaybackHeadPosition, this.stopPlaybackHeadPosition + ((((long) this.sampleRate) * ((SystemClock.elapsedRealtime() * 1000) - this.stopTimestampUs)) / C0989C.MICROS_PER_SECOND));
            }
        ...
        public long getPlaybackHeadPositionUs() {
            return (getPlaybackHeadPosition() * C0989C.MICROS_PER_SECOND) / ((long) this.sampleRate);
        }
    ...
    public void configure(String mimeType, int channelCount, int sampleRate, int pcmEncoding, int specifiedBufferSize) {
        ...
        switch (channelCount) {
            ...
            case C1569R.styleable.Toolbar_contentInsetRight /*8*/:
                channelConfig = C0989C.CHANNEL_OUT_7POINT1_SURROUND;
                break;
            default:
    ...
    private long framesToDurationUs(long frameCount) {
        return (C0989C.MICROS_PER_SECOND * frameCount) / ((long) this.sampleRate);
    }

    private long durationUsToFrames(long durationUs) {
        return (((long) this.sampleRate) * durationUs) / C0989C.MICROS_PER_SECOND;
    }
