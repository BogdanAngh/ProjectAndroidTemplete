...
public class ChunkSampleSource implements SampleSource, SampleSourceReader, Callback {
    ...
    class C10081 implements Runnable {
        ...
        C10081(long j, int i, int i2, Format format, long j2, long j3) {
            this.val$length = j;
            this.val$type = i;
            this.val$trigger = i2;
    ...
    class C10092 implements Runnable {
        ...
        C10092(long j, int i, int i2, Format format, long j2, long j3, long j4, long j5) {
    ...
    class C10103 implements Runnable {
        final /* synthetic */ long val$bytesLoaded;
    ...
    class C10114 implements Runnable {
        final /* synthetic */ IOException val$e;

        C10114(IOException iOException) {
    ...
    class C10136 implements Runnable {
        ...
        C10136(Format format, int i, long j) {
            this.val$format = format;
            this.val$trigger = i;
    ...
    public int readData(int track, long positionUs, MediaFormatHolder formatHolder, SampleHolder sampleHolder) {
        ...
        if (haveSamples) {
            ...
            sampleHolder.flags = (decodeOnly ? C0989C.SAMPLE_FLAG_DECODE_ONLY : STATE_IDLE) | sampleHolder.flags;
    ...
    private void notifyLoadStarted(long length, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10081(length, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs));
        }
    }
    ...
    private void notifyLoadCompleted(long bytesLoaded, int type, int trigger, Format format, long mediaStartTimeUs, long mediaEndTimeUs, long elapsedRealtimeMs, long loadDurationMs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10092(bytesLoaded, type, trigger, format, mediaStartTimeUs, mediaEndTimeUs, elapsedRealtimeMs, loadDurationMs));
        }
    }

    private void notifyLoadCanceled(long bytesLoaded) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10103(bytesLoaded));
        }
    }

    private void notifyLoadError(IOException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10114(e));
        }
    }

    private void notifyUpstreamDiscarded(long mediaStartTimeUs, long mediaEndTimeUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10125(mediaStartTimeUs, mediaEndTimeUs));
        }
    }

    private void notifyDownstreamFormatChanged(Format format, int trigger, long positionUs) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10136(format, trigger, positionUs));
        }
    }
}
