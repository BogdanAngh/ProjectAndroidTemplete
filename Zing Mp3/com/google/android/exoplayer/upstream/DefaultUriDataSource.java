...
public final class DefaultUriDataSource implements UriDataSource {
    ...
    public DefaultUriDataSource(Context context, TransferListener listener, String userAgent, boolean allowCrossProtocolRedirects) {
        this(context, listener, new DefaultHttpDataSource(userAgent, null, listener, UdpDataSource.DEAFULT_SOCKET_TIMEOUT_MILLIS, UdpDataSource.DEAFULT_SOCKET_TIMEOUT_MILLIS, allowCrossProtocolRedirects));
    }
