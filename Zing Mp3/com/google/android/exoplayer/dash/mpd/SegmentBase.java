...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public int getSegmentNum(long timeUs, long periodDurationUs) {
            ...
            if (this.segmentTimeline == null) {
                int segmentNum = this.startNumber + ((int) (timeUs / ((this.duration * C0989C.MICROS_PER_SECOND) / this.timescale)));
        ...
        public final long getSegmentDurationUs(int sequenceNumber, long periodDurationUs) {
            if (this.segmentTimeline != null) {
                return (((SegmentTimelineElement) this.segmentTimeline.get(sequenceNumber - this.startNumber)).duration * C0989C.MICROS_PER_SECOND) / this.timescale;
            }
            return sequenceNumber == getLastSegmentNum(periodDurationUs) ? periodDurationUs - getSegmentTimeUs(sequenceNumber) : (this.duration * C0989C.MICROS_PER_SECOND) / this.timescale;
        }
        ...
        public final long getSegmentTimeUs(int sequenceNumber) {
            ...
            return Util.scaleLargeTimestamp(unscaledSegmentTime, C0989C.MICROS_PER_SECOND, this.timescale);
        }
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public int getLastSegmentNum(long periodDurationUs) {
            ...
            return (this.startNumber + ((int) Util.ceilDivide(periodDurationUs, (this.duration * C0989C.MICROS_PER_SECOND) / this.timescale))) - 1;
        }
    }
    ...
    public long getPresentationTimeOffsetUs() {
        return Util.scaleLargeTimestamp(this.presentationTimeOffset, C0989C.MICROS_PER_SECOND, this.timescale);
    }
}
