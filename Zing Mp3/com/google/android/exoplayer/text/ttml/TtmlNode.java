...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(text), UNDEFINED_TIME, UNDEFINED_TIME, null, null, ANONYMOUS_REGION_ID);
    }
    ...
    public long[] getEventTimesUs() {
        ...
        int i = 0;
        Iterator i$ = eventTimeSet.iterator();
        while (i$.hasNext()) {
            int i2 = i + 1;
            eventTimes[i] = ((Long) i$.next()).longValue();
            i = i2;
        }
        return eventTimes;
    }
    ...
    public List<Cue> getCues(long timeUs, Map<String, TtmlStyle> globalStyles, Map<String, TtmlRegion> regionMap) {
        ...
        for (Entry<String, SpannableStringBuilder> entry : regionOutputs.entrySet()) {
            ...
            cues.add(new Cue(cleanUpText((SpannableStringBuilder) entry.getValue()), null, region.line, Cue.TYPE_UNSET, Cue.TYPE_UNSET, region.position, Cue.TYPE_UNSET, region.width));
        }
        return cues;
    }
