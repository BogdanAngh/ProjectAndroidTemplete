...
public final class WavExtractor implements Extractor, SeekMap {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        ...
        if (!this.wavHeader.hasDataBounds()) {
            ...
            r16.format(MediaFormat.createAudioFormat(null, MimeTypes.AUDIO_RAW, this.wavHeader.getBitrate(), MAX_INPUT_SIZE, this.wavHeader.getDurationUs(), this.wavHeader.getNumChannels(), this.wavHeader.getSampleRateHz(), null, null, this.wavHeader.getEncoding()));
            this.extractorOutput.seekMap(this);
        }
        int bytesAppended = this.trackOutput.sampleData(input, MAX_INPUT_SIZE - this.pendingBytes, true);
        if (bytesAppended != -1) {
