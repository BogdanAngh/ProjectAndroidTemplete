...
final class Ac3Reader extends ElementaryStreamReader {
    ...
    private void parseHeader() {
        ...
        this.sampleDurationUs = (long) ((int) ((C0989C.MICROS_PER_SECOND * ((long) (this.isEac3 ? Ac3Util.parseEAc3SyncframeAudioSampleCount(this.headerScratchBits.data) : Ac3Util.getAc3SyncframeAudioSampleCount()))) / ((long) this.mediaFormat.sampleRate)));
    }
}
