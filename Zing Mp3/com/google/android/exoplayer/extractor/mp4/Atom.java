...
abstract class Atom {
    ...
    static {
        ...
        TYPE_name = Util.getIntegerCodeForString(ShareConstants.WEB_DIALOG_PARAM_NAME);
        TYPE_data = Util.getIntegerCodeForString(ShareConstants.WEB_DIALOG_PARAM_DATA);
