...
final class VorbisUtil {
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int headerType, ParsableByteArray header, boolean quite) throws ParserException {
        ...
        } else if (header.readUnsignedByte() == 118 && header.readUnsignedByte() == C1569R.styleable.AppCompatTheme_seekBarStyle && header.readUnsignedByte() == C1569R.styleable.AppCompatTheme_listMenuViewStyle && header.readUnsignedByte() == 98 && header.readUnsignedByte() == C1569R.styleable.AppCompatTheme_checkedTextViewStyle && header.readUnsignedByte() == 115) {
            return true;
        } else {
            if (quite) {
                return false;
