...
final class VorbisReader extends StreamReader implements SeekMap {
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        if (this.totalSamples == 0) {
            ...
            this.totalSamples = this.inputLength == -1 ? -1 : this.oggParser.readGranuleOfLastPage(input);
            ...
            if (this.inputLength == -1) {
                ...
                j = (this.totalSamples * C0989C.MICROS_PER_SECOND) / this.vorbisSetup.idHeader.sampleRate;
            }
            this.duration = j;
        ...
        if ((this.scratch.data[0] & 1) != 1) {
            ...
            if (this.elapsedSamples + ((long) samplesInPacket) >= this.targetGranule) {
                ...
                long timeUs = (this.elapsedSamples * C0989C.MICROS_PER_SECOND) / this.vorbisSetup.idHeader.sampleRate;
    ...
    public long getPosition(long timeUs) {
        ...
        this.targetGranule = (this.vorbisSetup.idHeader.sampleRate * timeUs) / C0989C.MICROS_PER_SECOND;
