...
final class VorbisBitArray {
    ...
    public int readBits(int numBits) {
        ...
        if (this.bitOffset != 0) {
            ...
            result = (this.data[this.byteOffset] >>> this.bitOffset) & (NalUnitUtil.EXTENDED_SAR >>> (8 - bitCount));
        ...
        if (numBits > bitCount) {
            ...
            result |= (this.data[this.byteOffset] & (NalUnitUtil.EXTENDED_SAR >>> (8 - bitsOnNextByte))) << bitCount;
