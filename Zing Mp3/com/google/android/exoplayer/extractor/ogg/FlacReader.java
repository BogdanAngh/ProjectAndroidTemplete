...
final class FlacReader extends StreamReader {
    ...
    static boolean verifyBitstreamType(ParsableByteArray data) {
        return data.readUnsignedByte() == TransportMediator.KEYCODE_MEDIA_PAUSE && data.readUnsignedInt() == 1179402563;
    }
    ...
    public int read(ExtractorInput input, PositionHolder seekPosition) throws IOException, InterruptedException {
        ...
        } else if ((data[0] & TransportMediator.KEYCODE_MEDIA_PAUSE) == 3 && this.seekTable == null) {
