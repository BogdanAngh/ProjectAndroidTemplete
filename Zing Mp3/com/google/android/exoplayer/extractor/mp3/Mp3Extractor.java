...
public final class Mp3Extractor implements Extractor {
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        this.trackOutput.sampleMetadata(this.basisTimeUs + ((this.samplesRead * C0989C.MICROS_PER_SECOND) / ((long) this.synchronizedHeader.sampleRate)), 1, this.synchronizedHeader.frameSize, INFO_HEADER, null);
