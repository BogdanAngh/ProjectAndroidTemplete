...
public final class SlidingPercentile {
    ...
    static class C10401 implements Comparator<Sample> {
        C10401() {
        }
    ...
    static class C10412 implements Comparator<Sample> {
        C10412() {
        }
    ...
    static {
        INDEX_COMPARATOR = new C10401();
        VALUE_COMPARATOR = new C10412();
    }
