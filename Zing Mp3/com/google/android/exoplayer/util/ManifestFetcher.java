...
public class ManifestFetcher<T> implements Callback {
    ...
    class C10382 implements Runnable {
        C10382() {
        }
    ...
    class C10393 implements Runnable {
        ...
        C10393(IOException iOException) {
    ...
    private void notifyManifestRefreshStarted() {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10371());
        }
    }

    private void notifyManifestRefreshed() {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10382());
        }
    }

    private void notifyManifestError(IOException e) {
        if (this.eventHandler != null && this.eventListener != null) {
            this.eventHandler.post(new C10393(e));
        }
    }
}
