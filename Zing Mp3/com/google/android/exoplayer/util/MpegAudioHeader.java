...
public final class MpegAudioHeader {
    ...
    static {
        ...
        BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, C1569R.styleable.AppCompatTheme_spinnerStyle, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 144, 160, 176, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY};
        BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, C1569R.styleable.AppCompatTheme_spinnerStyle, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, 320, 384};
        BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, C1569R.styleable.AppCompatTheme_spinnerStyle, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 160, PsExtractor.AUDIO_STREAM, PsExtractor.VIDEO_STREAM, AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY, 320};
        BITRATE_V2 = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, C1569R.styleable.AppCompatTheme_spinnerStyle, AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS, 144, 160};
    }
