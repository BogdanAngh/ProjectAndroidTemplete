...
public final class zzk {
    ...
    public zzk(Context context, AttributeSet attributeSet) {
        Object obj = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1044R.styleable.AdsAttrs);
        Object string = obtainAttributes.getString(C1044R.styleable.AdsAttrs_adSize);
        Object string2 = obtainAttributes.getString(C1044R.styleable.AdsAttrs_adSizes);
        ...
        this.zzant = obtainAttributes.getString(C1044R.styleable.AdsAttrs_adUnitId);
