...
public class zzl {
    public static boolean zza(PublicKey publicKey, String str, String str2) {
        try {
            ...
            zzb.m1695e("Signature verification failed.");
            return false;
        } catch (NoSuchAlgorithmException e) {
            zzb.m1695e("NoSuchAlgorithmException.");
            return false;
        } catch (InvalidKeyException e2) {
            zzb.m1695e("Invalid key specification.");
            return false;
        } catch (SignatureException e3) {
            zzb.m1695e("Signature exception.");
            return false;
        }
    }
    ...
    public static boolean zzc(String str, String str2, String str3) {
        ...
        zzb.m1695e("Purchase verification failed: missing data.");
        return false;
    }
