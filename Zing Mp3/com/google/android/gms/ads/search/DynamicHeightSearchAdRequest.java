...
public final class DynamicHeightSearchAdRequest {
    private final SearchAdRequest f1518Z;

    public static final class Builder {
        private final com.google.android.gms.ads.search.SearchAdRequest.Builder aa;
        private final Bundle ab;

        public Builder() {
            this.aa = new com.google.android.gms.ads.search.SearchAdRequest.Builder();
            this.ab = new Bundle();
        }
    ...
    private DynamicHeightSearchAdRequest(Builder builder) {
        this.f1518Z = builder.aa.build();
    }

    public <T extends CustomEvent> Bundle getCustomEventExtrasBundle(Class<T> cls) {
        return this.f1518Z.getCustomEventExtrasBundle(cls);
    }

    @Deprecated
    public <T extends NetworkExtras> T getNetworkExtras(Class<T> cls) {
        return this.f1518Z.getNetworkExtras(cls);
    }

    public <T extends MediationAdapter> Bundle getNetworkExtrasBundle(Class<T> cls) {
        return this.f1518Z.getNetworkExtrasBundle(cls);
    }

    public String getQuery() {
        return this.f1518Z.getQuery();
    }

    public boolean isTestDevice(Context context) {
        return this.f1518Z.isTestDevice(context);
    }

    zzad zzdt() {
        return this.f1518Z.zzdt();
    }
}
