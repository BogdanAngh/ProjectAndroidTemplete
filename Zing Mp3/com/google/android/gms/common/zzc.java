    ...
    public Intent zzb(Context context, int i, @Nullable String str) {
        switch (i) {
            ...
            case C1569R.styleable.com_facebook_login_view_com_facebook_logout_text /*2*/:
                return (context == null || !zzi.zzci(context)) ? zzn.zzac(GOOGLE_PLAY_SERVICES_PACKAGE, zzt(context, str)) : zzn.zzawg();
            case C1569R.styleable.com_facebook_login_view_com_facebook_tooltip_mode /*3*/:
                return zzn.zzhy(GOOGLE_PLAY_SERVICES_PACKAGE);
            default:
                return null;
        }
    }
