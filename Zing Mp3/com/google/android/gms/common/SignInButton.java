...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    private void zzb(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1044R.styleable.SignInButton, SIZE_STANDARD, SIZE_STANDARD);
        try {
            this.mSize = obtainStyledAttributes.getInt(C1044R.styleable.SignInButton_buttonSize, SIZE_STANDARD);
            this.mColor = obtainStyledAttributes.getInt(C1044R.styleable.SignInButton_colorScheme, SIZE_ICON_ONLY);
        } finally {
