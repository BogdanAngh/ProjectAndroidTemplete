...
public abstract class zzj<T extends IInterface> extends zze<T> implements zze, zza {
    ...
    class C11801 implements zzb {
        final /* synthetic */ ConnectionCallbacks Ec;

        C11801(ConnectionCallbacks connectionCallbacks) {
    ...
    class C11812 implements zzc {
        final /* synthetic */ OnConnectionFailedListener Ed;

        C11812(OnConnectionFailedListener onConnectionFailedListener) {
    ...
    private static zzb zza(ConnectionCallbacks connectionCallbacks) {
        return connectionCallbacks == null ? null : new C11801(connectionCallbacks);
    }

    @Nullable
    private static zzc zza(OnConnectionFailedListener onConnectionFailedListener) {
        return onConnectionFailedListener == null ? null : new C11812(onConnectionFailedListener);
    }
