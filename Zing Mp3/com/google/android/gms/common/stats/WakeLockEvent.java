...
public final class WakeLockEvent extends StatsEvent {
    ...
    public String zzaxu() {
        ...
        String join = zzaxz() == null ? BuildConfig.FLAVOR : TextUtils.join(",", zzaxz());
        String valueOf5 = String.valueOf("\t");
        int zzayc = zzayc();
        String valueOf6 = String.valueOf("\t");
        String zzaxw = zzaxw() == null ? BuildConfig.FLAVOR : zzaxw();
        String valueOf7 = String.valueOf("\t");
        String zzayd = zzayd() == null ? BuildConfig.FLAVOR : zzayd();
        String valueOf8 = String.valueOf("\t");
        float zzaye = zzaye();
        String valueOf9 = String.valueOf("\t");
        String zzaxx = zzaxx() == null ? BuildConfig.FLAVOR : zzaxx();
