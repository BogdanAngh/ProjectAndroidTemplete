...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    static {
        wO = new ConnectionResult(SUCCESS);
        CREATOR = new zzb();
    }
    ...
    public int hashCode() {
        ...
        objArr[SUCCESS] = Integer.valueOf(this.uo);
        objArr[SERVICE_MISSING] = this.mPendingIntent;
        objArr[SERVICE_VERSION_UPDATE_REQUIRED] = this.wP;
    ...
    public String toString() {
        return zzz.zzx(this).zzg("statusCode", getStatusString(this.uo)).zzg("resolution", this.mPendingIntent).zzg(ShareConstants.WEB_DIALOG_PARAM_MESSAGE, this.wP).toString();
    }
