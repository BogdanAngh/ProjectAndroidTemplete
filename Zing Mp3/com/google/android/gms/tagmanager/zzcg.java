...
class zzcg implements zzaw {
    ...
    class zza implements com.google.android.gms.tagmanager.zzdf.zza {
        ...
        public void zzb(zzas com_google_android_gms_tagmanager_zzas) {
            this.aGf.zzu(com_google_android_gms_tagmanager_zzas.zzcfi());
            zzbo.m1699v("Permanent failure dispatching hitId: " + com_google_android_gms_tagmanager_zzas.zzcfi());
        }
        ...
        public void zzc(zzas com_google_android_gms_tagmanager_zzas) {
            ...
            if (zzcfj == 0) {
                ...
                this.aGf.zzu(com_google_android_gms_tagmanager_zzas.zzcfi());
                zzbo.m1699v("Giving up on failed hitId: " + com_google_android_gms_tagmanager_zzas.zzcfi());
            }
        }
    }
    ...
    static {
        dw = String.format("CREATE TABLE IF NOT EXISTS %s ( '%s' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, '%s' INTEGER NOT NULL, '%s' TEXT NOT NULL,'%s' INTEGER NOT NULL);", new Object[]{"gtm_hits", "hit_id", "hit_time", "hit_url", "hit_first_send_time"});
    }

    zzcg(zzax com_google_android_gms_tagmanager_zzax, Context context) {
        this(com_google_android_gms_tagmanager_zzax, context, "gtm_urls.db", UdpDataSource.DEFAULT_MAX_PACKET_SIZE);
    }
    ...
    private void zzcfv() {
        ...
        if (zzcfw > 0) {
            ...
            zzbo.m1699v("Store full, deleting " + zzaag.size() + " hits to make room.");
    ...
    public void dispatch() {
        zzbo.m1699v("GTM Dispatch running...");
        if (this.aGa.zzcez()) {
            List zzaah = zzaah(40);
            if (zzaah.isEmpty()) {
                zzbo.m1699v("...nothing to dispatch");
                this.aGb.zzcn(true);
                return;
            }
            this.aGa.zzal(zzaah);
    ...
    List<String> zzaag(int i) {
        ...
        try {
            query = zzpf.query("gtm_hits", new String[]{"hit_id"}, null, null, null, null, String.format("%s ASC", new Object[]{"hit_id"}), Integer.toString(i));
            try {
    ...
    L_0x00ac:
        ...
        r2.zzpj(r5);	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
    L_0x00ba:
        r2 = r4 + 1;
    ...
    L_0x00e2:
        com.google.android.gms.tagmanager.zzbo.zzdi(r3);	 Catch:{ all -> 0x00f2 }
    ...
    L_0x00fa:
        ...
        r2 = r12.get(r4);	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        r2 = (com.google.android.gms.tagmanager.zzas) r2;	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        r8 = r2.zzcfi();	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        ...
        com.google.android.gms.tagmanager.zzbo.zzdi(r2);	 Catch:{ SQLiteException -> 0x0118, all -> 0x016d }
        goto L_0x00ba;
    L_0x0118:
        r2 = move-exception;
        r13 = r3;
    ...
    L_0x012e:
        com.google.android.gms.tagmanager.zzbo.zzdi(r2);	 Catch:{ all -> 0x0161 }
    ...
    L_0x0184:
        ...
        goto L_0x009e;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.tagmanager.zzcg.zzaah(int):java.util.List<com.google.android.gms.tagmanager.zzas>");
    }
    ...
    int zzadb() {
        ...
        int delete = zzpf.delete("gtm_hits", "HIT_TIME < ?", new String[]{Long.toString(this.zzaql.currentTimeMillis() - 2592000000L)});
    ...
    int zzcfx() {
        ...
        try {
            Cursor query = zzpf.query("gtm_hits", new String[]{"hit_id", "hit_first_send_time"}, "hit_first_send_time=0", null, null, null, null);
            try {
    ...
    void zzh(String[] strArr) {
        ...
        if (strArr != null && strArr.length != 0) {
            ...
            if (zzpf != null) {
                try {
                    zzpf.delete("gtm_hits", String.format("HIT_ID in (%s)", new Object[]{TextUtils.join(",", Collections.nCopies(strArr.length, "?"))}), strArr);
                    zzax com_google_android_gms_tagmanager_zzax = this.aGb;
                    if (zzcfw() != 0) {
                        z = false;
                    }
