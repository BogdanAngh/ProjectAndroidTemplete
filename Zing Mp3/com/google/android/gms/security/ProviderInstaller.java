...
public class ProviderInstaller {
    ...
    class C15201 extends AsyncTask<Void, Void, Integer> {
        final /* synthetic */ ProviderInstallListener aDh;
        final /* synthetic */ Context zzang;

        C15201(Context context, ProviderInstallListener providerInstallListener) {
            this.zzang = context;
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        new C15201(context, providerInstallListener).execute(new Void[0]);
    }
