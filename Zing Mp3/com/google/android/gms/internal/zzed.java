...
public interface zzed extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzed {
        ...
        private static class zza implements zzed {
            ...
            public void zza(zzec com_google_android_gms_internal_zzec) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzec != null ? com_google_android_gms_internal_zzec.asBinder() : null);
        ...
        public static zzed zzaa(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzed)) ? new zza(iBinder) : (zzed) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case C1569R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
                    ...
                    zza(com.google.android.gms.internal.zzec.zza.zzz(parcel.readStrongBinder()));
