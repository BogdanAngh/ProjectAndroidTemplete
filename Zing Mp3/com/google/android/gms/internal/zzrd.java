...
public final class zzrd extends GoogleApiClient implements com.google.android.gms.internal.zzrm.zza {
    ...
    private zzrm Ac;
    final Queue<com.google.android.gms.internal.zzqo.zza<?, ?>> Ad;
    ...
    Set<Scope> Ak;
    private final zzrs Al;
    private final ArrayList<zzqr> Am;
    private Integer An;
    Set<zzsf> Ao;
    final zzsg Ap;
    private final com.google.android.gms.common.internal.zzk.zza Aq;
    ...
    class C14881 implements com.google.android.gms.common.internal.zzk.zza {
        final /* synthetic */ zzrd Ar;

        C14881(zzrd com_google_android_gms_internal_zzrd) {
    ...
    class C14892 implements ConnectionCallbacks {
        final /* synthetic */ zzrd Ar;
        final /* synthetic */ AtomicReference As;
        final /* synthetic */ zzsc At;

        C14892(zzrd com_google_android_gms_internal_zzrd, AtomicReference atomicReference, zzsc com_google_android_gms_internal_zzsc) {
            this.Ar = com_google_android_gms_internal_zzrd;
            this.As = atomicReference;
            this.At = com_google_android_gms_internal_zzsc;
        }

        public void onConnected(Bundle bundle) {
            this.Ar.zza((GoogleApiClient) this.As.get(), this.At, true);
        }
    ...
    class C14903 implements OnConnectionFailedListener {
        final /* synthetic */ zzrd Ar;
        final /* synthetic */ zzsc At;

        C14903(zzrd com_google_android_gms_internal_zzrd, zzsc com_google_android_gms_internal_zzsc) {
            this.Ar = com_google_android_gms_internal_zzrd;
            this.At = com_google_android_gms_internal_zzsc;
        }
    ...
    class C14914 implements ResultCallback<Status> {
        final /* synthetic */ zzrd Ar;
        final /* synthetic */ zzsc At;
        final /* synthetic */ boolean Au;
        final /* synthetic */ GoogleApiClient of;

        C14914(zzrd com_google_android_gms_internal_zzrd, zzsc com_google_android_gms_internal_zzsc, boolean z, GoogleApiClient googleApiClient) {
            this.Ar = com_google_android_gms_internal_zzrd;
            this.At = com_google_android_gms_internal_zzsc;
            this.Au = z;
    ...
    private void zza(GoogleApiClient googleApiClient, zzsc com_google_android_gms_internal_zzsc, boolean z) {
        zzsn.EU.zzg(googleApiClient).setResultCallback(new C14914(this, com_google_android_gms_internal_zzsc, z, googleApiClient));
    }
    ...
    public PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        PendingResult com_google_android_gms_internal_zzsc = new zzsc((GoogleApiClient) this);
        if (this.Aj.containsKey(zzsn.hg)) {
            zza(this, com_google_android_gms_internal_zzsc, false);
        } else {
            AtomicReference atomicReference = new AtomicReference();
            GoogleApiClient build = new Builder(this.mContext).addApi(zzsn.API).addConnectionCallbacks(new C14892(this, atomicReference, com_google_android_gms_internal_zzsc)).addOnConnectionFailedListener(new C14903(this, com_google_android_gms_internal_zzsc)).setHandler(this.Ah).build();
