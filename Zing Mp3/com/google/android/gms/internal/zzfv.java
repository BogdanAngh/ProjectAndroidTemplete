...
public class zzfv extends zzfs {
    private static final Set<String> zzbrn;
    private static final DecimalFormat zzbro;
    private File zzbrp;
    private boolean zzbrq;

    static {
        zzbrn = Collections.synchronizedSet(new HashSet());
        zzbro = new DecimalFormat("#,###");
    }

    public zzfv(zzmd com_google_android_gms_internal_zzmd) {
        super(com_google_android_gms_internal_zzmd);
        File cacheDir = this.mContext.getCacheDir();
        if (cacheDir == null) {
            zzb.zzdi("Context.getCacheDir() returned null");
            return;
        }
        ...
        if (!this.zzbrp.isDirectory() && !this.zzbrp.mkdirs()) {
            ...
            valueOf = String.valueOf(this.zzbrp.getAbsolutePath());
    ...
    L_0x0013:
        r3 = r26.zznj();
        r2 = com.google.android.gms.internal.zzdr.zzbdn;
        r2 = r2.get();
    ...
    L_0x006d:
        r2 = r4.concat(r2);
    L_0x0071:
        com.google.android.gms.ads.internal.util.client.zzb.zzdg(r2);
    ...
    L_0x00bd:
        com.google.android.gms.ads.internal.util.client.zzb.zzdi(r2);	 Catch:{ all -> 0x00d2 }
    ...
    L_0x00e2:
        ...
        r10 = "error";
        r9 = 0;
        r3 = com.google.android.gms.ads.internal.zzu.zzgz();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = com.google.android.gms.internal.zzdr.zzbdt;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x015c:
        r6 = com.google.android.gms.ads.internal.zzu.zzgq();
    ...
    L_0x01ec:
        com.google.android.gms.ads.internal.util.client.zzb.zzdi(r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r2 = zzbrn;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x020b:
        ...
        goto L_0x0158;
    L_0x0210:
        r2 = zzbro;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r2 = com.google.android.gms.internal.zzdr.zzbdo;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r2.get();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = (java.lang.Integer) r2;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x028a:
        ...
        r2 = r2.append(r0);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r2.toString();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        com.google.android.gms.ads.internal.util.client.zzb.zzdg(r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r18 = com.google.android.gms.ads.internal.zzu.zzgs();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r5 = 0;
        r20 = r18.currentTimeMillis();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = com.google.android.gms.internal.zzdr.zzbds;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        ...
        r19 = new com.google.android.gms.internal.zzlm;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r0 = r19;
        r0.<init>(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = com.google.android.gms.internal.zzdr.zzbdr;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = r2.get();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = (java.lang.Long) r2;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x0389:
        r0 = r26;
        r2 = r0.zzbrq;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x03b8:
        ...
        r2 = 3;
        r2 = com.google.android.gms.ads.internal.util.client.zzb.zzbi(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        if (r2 == 0) goto L_0x03fe;
    L_0x03c2:
        r2 = zzbro;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        ...
        com.google.android.gms.ads.internal.util.client.zzb.zzdg(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    L_0x03fe:
        r2 = 1;
        r3 = 0;
        ...
        r2 = zzbrn;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x0419:
        ...
        r5 = r5.append(r6);
        r5 = r5.toString();
        com.google.android.gms.ads.internal.util.client.zzb.zzc(r5, r2);
        goto L_0x0196;
    L_0x0443:
        r2 = new java.lang.String;
        r2.<init>(r5);
    ...
    public int zznj() {
        int i = 0;
        if (this.zzbrp != null) {
            for (File name : this.zzbrp.listFiles()) {
