...
public final class zzaqj implements zzapl {
    ...
    class C12401 extends zzb {
        ...
        C12401(zzaqj com_google_android_gms_internal_zzaqj, String str, boolean z, boolean z2, zzaos com_google_android_gms_internal_zzaos, Field field, zzaqo com_google_android_gms_internal_zzaqo, boolean z3) {
            this.bqc = com_google_android_gms_internal_zzaqj;
            this.bpY = com_google_android_gms_internal_zzaos;
            this.bpZ = field;
            this.bqa = com_google_android_gms_internal_zzaqo;
            this.bqb = z3;
            super(str, z, z2);
            this.bpX = this.bqc.zza(this.bpY, this.bpZ, this.bqa);
        }
    ...
    private zzb zza(zzaos com_google_android_gms_internal_zzaos, Field field, String str, zzaqo<?> com_google_android_gms_internal_zzaqo_, boolean z, boolean z2) {
        return new C12401(this, str, z, z2, com_google_android_gms_internal_zzaos, field, com_google_android_gms_internal_zzaqo_, zzapy.zzk(com_google_android_gms_internal_zzaqo_.bB()));
    }
    ...
    public <T> zzapk<T> zza(zzaos com_google_android_gms_internal_zzaos, zzaqo<T> com_google_android_gms_internal_zzaqo_T) {
        ...
        return !Object.class.isAssignableFrom(bB) ? null : new zza(zza(com_google_android_gms_internal_zzaos, (zzaqo) com_google_android_gms_internal_zzaqo_T, bB), null);
    }
