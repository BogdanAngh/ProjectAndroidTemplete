...
public final class zzapw<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    static class C12261 implements Comparator<Comparable> {
        C12261() {
        }
    ...
    class zza extends AbstractSet<Entry<K, V>> {
        ...
        class C12271 extends zzc<Entry<K, V>> {
            final /* synthetic */ zza bpo;

            C12271(zza com_google_android_gms_internal_zzapw_zza) {
                this.bpo = com_google_android_gms_internal_zzapw_zza;
                super(null);
            }
    ...
    final class zzb extends AbstractSet<K> {
        ...
        class C12281 extends zzc<K> {
            final /* synthetic */ zzb bpp;

            C12281(zzb com_google_android_gms_internal_zzapw_zzb) {
                this.bpp = com_google_android_gms_internal_zzapw_zzb;
                super(null);
            }
