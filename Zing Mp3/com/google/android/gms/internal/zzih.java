...
public interface zzih extends IInterface {

    public static abstract class zza extends Binder implements zzih {

        private static class zza implements zzih {
        ...
        public static zzih zzay(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzih)) ? new zza(iBinder) : (zzih) queryLocalInterface;
        }
