...
public interface zzhz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzhz {
        ...
        public static zzhz zzau(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzhz)) ? new zza(iBinder) : (zzhz) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case C1569R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped /*1*/:
                    ...
                    IBinder zzo = zzo(com.google.android.gms.dynamic.zzd.zza.zzfd(parcel.readStrongBinder()));
