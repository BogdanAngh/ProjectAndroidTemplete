...
public final class zztl {
    ...
    private static final zza Qk;
    private static final zza Ql;
    ...
    class C15139 extends PathClassLoader {
        C15139(String str, ClassLoader classLoader) {
    ...
    private static Context zza(Context context, String str, byte[] bArr, String str2) {
        ...
        try {
            return (Context) zze.zzae(com.google.android.gms.internal.zztn.zza.zzff((IBinder) new C15139(str2, context.getClassLoader()).loadClass("com.google.android.gms.dynamiteloader.DynamiteLoaderV2").getConstructor(new Class[0]).newInstance(new Object[0])).zza(zze.zzac(context), str, bArr));
        ...
        if (zza.Qv == 0 || ((zza.Qv == -1 && zza.Qt == 0) || (zza.Qv == 1 && zza.Qu == 0))) {
            ...
            if (zza.Qv == 1) {
                try {
                    ...
                    if (zza.Qt != 0 && com_google_android_gms_internal_zztl_zzb.zza(context, str, new C15128(zza.Qt)).Qv == -1) {
                        return zzac(context, str);
                    }
    ...
    private static zztm zzcs(Context context) {
        synchronized (zztl.class) {
            ...
            if (Qh != null) {
                ...
                try {
                    com_google_android_gms_internal_zztm = com.google.android.gms.internal.zztm.zza.zzfe((IBinder) context.createPackageContext(GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_PACKAGE, 3).getClassLoader().loadClass("com.google.android.gms.chimera.container.DynamiteLoaderImpl").newInstance());
