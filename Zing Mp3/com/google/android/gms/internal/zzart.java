...
public final class zzart {
    ...
    public static class zza extends IOException {
        zza(int i, int i2) {
            super(new StringBuilder(C1569R.styleable.AppCompatTheme_ratingBarStyle).append("CodedOutputStream was writing to a flat byte array and ran out of space (pos ").append(i).append(" limit ").append(i2).append(").").toString());
        }
    }
    ...
    public void zzahd(int i) throws IOException {
        while ((i & -128) != 0) {
            zzahb((i & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            i >>>= 7;
        }
        zzahb(i);
    }
    ...
    public void zzdb(long j) throws IOException {
        while ((-128 & j) != 0) {
            zzahb((((int) j) & TransportMediator.KEYCODE_MEDIA_PAUSE) | AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
            j >>>= 7;
        }
        zzahb((int) j);
    }
