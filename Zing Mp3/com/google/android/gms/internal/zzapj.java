...
final class zzapj<T> extends zzapk<T> {
    ...
    private static class zza implements zzapl {
        ...
        public <T> zzapk<T> zza(zzaos com_google_android_gms_internal_zzaos, zzaqo<T> com_google_android_gms_internal_zzaqo_T) {
            ...
            return isAssignableFrom ? new zzapj(this.boB, com_google_android_gms_internal_zzaos, com_google_android_gms_internal_zzaqo_T, this, null) : null;
        }
    }
    ...
    public static zzapl zza(zzaqo<?> com_google_android_gms_internal_zzaqo_, Object obj) {
        return new zza(com_google_android_gms_internal_zzaqo_, false, null, null);
    }

    public static zzapl zzb(zzaqo<?> com_google_android_gms_internal_zzaqo_, Object obj) {
        return new zza(com_google_android_gms_internal_zzaqo_, com_google_android_gms_internal_zzaqo_.bC() == com_google_android_gms_internal_zzaqo_.bB(), null, null);
    }
