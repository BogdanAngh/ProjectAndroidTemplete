...
public interface zzif extends IInterface {

    public static abstract class zza extends Binder implements zzif {

        private static class zza implements zzif {
        ...
        public static zzif zzaw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzif)) ? new zza(iBinder) : (zzif) queryLocalInterface;
        }
