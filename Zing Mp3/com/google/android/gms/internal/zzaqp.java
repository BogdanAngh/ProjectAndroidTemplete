...
public class zzaqp implements Closeable {
    ...
    static class C12531 extends zzapu {
        C12531() {
        }
    ...
    static {
        bro = ")]}'\n".toCharArray();
        zzapu.bph = new C12531();
    }

    public zzaqp(Reader reader) {
        this.brp = false;
        this.brq = new char[AccessibilityNodeInfoCompat.ACTION_NEXT_HTML_ELEMENT];
        this.pos = 0;
        this.limit = 0;
        this.brr = 0;
        this.brs = 0;
        ...
        if (i == 1) {
            ...
            switch (zzdi(true)) {
                case C1569R.styleable.AppCompatTheme_dialogPreferredPadding /*44*/:
                    break;
                case C1569R.styleable.AppCompatTheme_toolbarStyle /*59*/:
                    bI();
                    break;
                case C1569R.styleable.AppCompatTheme_alertDialogStyle /*93*/:
                    this.brt = 4;
                    return 4;
                default:
        ...
        if (this.pos != this.limit || zzago(1)) {
            ...
            switch (c) {
                ...
                case C1569R.styleable.AppCompatTheme_buttonStyle /*102*/:
                    return '\f';
                case C1569R.styleable.AppCompatTheme_ratingBarStyleSmall /*110*/:
                    return '\n';
    ...
    public double nextDouble() throws IOException {
        ...
        throw new zzaqs(new StringBuilder(String.valueOf(path2).length() + C1569R.styleable.AppCompatTheme_buttonStyle).append("JSON forbids NaN and infinities: ").append(parseDouble).append(" at line ").append(columnNumber).append(" column ").append(columnNumber2).append(" path ").append(path2).toString());
    }
