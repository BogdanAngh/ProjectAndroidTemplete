...
public final class zzrk {
    ...
    zzrk(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C1044R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
