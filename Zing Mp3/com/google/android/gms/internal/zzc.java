...
public class zzc extends Thread {
    ...
    class C12581 implements Runnable {
        ...
        C12581(zzc com_google_android_gms_internal_zzc, zzk com_google_android_gms_internal_zzk) {
                ...
                if (com_google_android_gms_internal_zzk.isCanceled()) {
                    ...
                    if (zza == null) {
                        ...
                        if (zza.zzb()) {
                            ...
                            com_google_android_gms_internal_zzk.zza(zza);
                            zza2.zzbh = true;
                            this.zzj.zza(com_google_android_gms_internal_zzk, zza2, new C12581(this, com_google_android_gms_internal_zzk));
                        } else {
