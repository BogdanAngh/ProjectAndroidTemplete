...
public class zzqe {
    ...
    private static long zza(byte[] bArr, long j) {
        ...
        int i = 0;
        while (i < length) {
            long zzah = (length3 ^ (zzah(zzb(bArr, i) * -4132994306676758123L) * -4132994306676758123L)) * -4132994306676758123L;
            i += 8;
            length3 = zzah;
        }
        if (length2 != 0) {
        ...
        return zzah(zzah(length3) * -4132994306676758123L);
    }
    ...
    private static long zzah(long j) {
        return (j >>> 47) ^ j;
    }
    ...
    private static long zzo(byte[] bArr) {
        ...
        return zzah((zzah(((((Long.rotateRight(zzb3, 31) + rotateRight3) + (rotateRight4 + Long.rotateRight(rotateRight, 7))) + zzb) * -4288712594273399085L) + (((zzb3 + rotateRight2) + zzb2) * -6505348102511208375L)) * -6505348102511208375L) + zzb2) * -4288712594273399085L;
    }
    ...
    private static long zzp(byte[] bArr) {
        ...
        long zzah = zzb3 + (zzah(jArr[1]) * -8261664234251669945L);
        long rotateRight = Long.rotateRight(zzb2, 33) * -8261664234251669945L;
        int i = 0;
        zzb2 = -8261664234251669945L * Long.rotateRight(zzah + zzb, 39);
        length = (length - 1) & -64;
        while (true) {
            ...
            zzb3 = Long.rotateRight(zzah ^ jArr2[0], 33);
            zza(bArr, i, jArr[1] * -8261664234251669945L, jArr2[0] + zzb, jArr);
            zza(bArr, i + 32, zzb3 + jArr2[1], rotateRight, jArr2);
            i += 64;
            int i2 = length - 64;
            if (i2 == 0) {
                return zzc((zzc(jArr[0], jArr2[0]) + (zzah(rotateRight) * -8261664234251669945L)) + zzb, zzc(jArr[1], jArr2[1]) + zzb3);
            }
            zzah = zzb;
            zzb2 = zzb3;
            length = i2;
