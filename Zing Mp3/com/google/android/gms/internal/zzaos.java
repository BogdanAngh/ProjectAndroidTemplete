...
public final class zzaos {
    ...
    class C12071 implements zzaow {
        final /* synthetic */ zzaos bok;

        C12071(zzaos com_google_android_gms_internal_zzaos) {
            this.bok = com_google_android_gms_internal_zzaos;
        }
    }

    /* renamed from: com.google.android.gms.internal.zzaos.2 */
    class C12082 implements zzapf {
        final /* synthetic */ zzaos bok;

        C12082(zzaos com_google_android_gms_internal_zzaos) {
            this.bok = com_google_android_gms_internal_zzaos;
        }
    }

    /* renamed from: com.google.android.gms.internal.zzaos.3 */
    class C12093 extends zzapk<Number> {
        final /* synthetic */ zzaos bok;

        C12093(zzaos com_google_android_gms_internal_zzaos) {
            this.bok = com_google_android_gms_internal_zzaos;
        }
    ...
    class C12104 extends zzapk<Number> {
        final /* synthetic */ zzaos bok;

        C12104(zzaos com_google_android_gms_internal_zzaos) {
            this.bok = com_google_android_gms_internal_zzaos;
        }
    ...
    class C12115 extends zzapk<Number> {
        final /* synthetic */ zzaos bok;

        C12115(zzaos com_google_android_gms_internal_zzaos) {
            this.bok = com_google_android_gms_internal_zzaos;
        }
    ...
    zzaos(zzapt com_google_android_gms_internal_zzapt, zzaor com_google_android_gms_internal_zzaor, Map<Type, zzaou<?>> map, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, zzapi com_google_android_gms_internal_zzapi, List<zzapl> list) {
        ...
        this.boi = new C12071(this);
        this.boj = new C12082(this);
    ...
    private zzapk<Number> zza(zzapi com_google_android_gms_internal_zzapi) {
        return com_google_android_gms_internal_zzapi == zzapi.DEFAULT ? zzaqn.bqw : new C12115(this);
    }
    ...
    private zzapk<Number> zzdf(boolean z) {
        return z ? zzaqn.bqy : new C12093(this);
    }

    private zzapk<Number> zzdg(boolean z) {
        return z ? zzaqn.bqx : new C12104(this);
    }
