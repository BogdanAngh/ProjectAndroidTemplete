...
public class Jsoup {
    ...
    public static Document parse(String html) {
        return Parser.parse(html, BuildConfig.FLAVOR);
    }
    ...
    public static Document parseBodyFragment(String bodyHtml) {
        return Parser.parseBodyFragment(bodyHtml, BuildConfig.FLAVOR);
    }
    ...
    public static String clean(String bodyHtml, Whitelist whitelist) {
        return clean(bodyHtml, BuildConfig.FLAVOR, whitelist);
    }
    ...
    public static boolean isValid(String bodyHtml, Whitelist whitelist) {
        return new Cleaner(whitelist).isValid(parseBodyFragment(bodyHtml, BuildConfig.FLAVOR));
    }
}
