...
class HtmlTreeBuilder extends TreeBuilder {
    ...
    static {
        ...
        TagsScriptStyle = new String[]{"script", TtmlNode.TAG_STYLE};
        TagsSearchInScope = new String[]{"applet", ShareConstants.FEED_CAPTION_PARAM, "html", "table", "td", "th", "marquee", "object"};
        ...
        TagSearchEndTags = new String[]{"dd", "dt", "li", "option", "optgroup", TtmlNode.TAG_P, "rp", "rt"};
        TagSearchSpecial = new String[]{"address", "applet", "area", "article", "aside", "base", "basefont", "bgsound", "blockquote", TtmlNode.TAG_BODY, TtmlNode.TAG_BR, "button", ShareConstants.FEED_CAPTION_PARAM, TtmlNode.CENTER, "col", "colgroup", "command", "dd", "details", "dir", TtmlNode.TAG_DIV, "dl", "dt", "embed", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", TtmlNode.TAG_HEAD, "header", "hgroup", "hr", "html", "iframe", "img", "input", "isindex", "li", ShareConstants.WEB_DIALOG_PARAM_LINK, "listing", "marquee", "menu", "meta", "nav", "noembed", "noframes", "noscript", "object", "ol", TtmlNode.TAG_P, "param", "plaintext", "pre", "script", "section", "select", TtmlNode.TAG_STYLE, "summary", "table", "tbody", "td", "textarea", "tfoot", "th", "thead", ShareConstants.WEB_DIALOG_PARAM_TITLE, "tr", "ul", "wbr", "xmp"};
    }
    ...
    List<Node> parseFragment(String inputFragment, Element context, String baseUri, ParseErrorList errors) {
        ...
        if (context != null) {
            ...
            if (StringUtil.in(contextTag, ShareConstants.WEB_DIALOG_PARAM_TITLE, "textarea")) {
