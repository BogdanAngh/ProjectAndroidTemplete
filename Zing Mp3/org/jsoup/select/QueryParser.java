...
class QueryParser {
    ...
    private void cssNthChild(boolean backwards, boolean ofType) {
        ...
        if ("odd".equals(argS)) {
            ...
            if (mAB.group(3) != null) {
                a = Integer.parseInt(mAB.group(1).replaceFirst("^\\+", BuildConfig.FLAVOR));
            }
            if (mAB.group(4) != null) {
                b = Integer.parseInt(mAB.group(4).replaceFirst("^\\+", BuildConfig.FLAVOR));
            }
        } else if (mB.matches()) {
            a = 0;
            b = Integer.parseInt(mB.group().replaceFirst("^\\+", BuildConfig.FLAVOR));
        } else {
