...
public abstract class Evaluator {
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        protected final int f1565a;
        protected final int f1566b;
        ...
        public boolean matches(Element root, Element element) {
            ...
            if (this.f1565a == 0) {
                ...
                return true;
            } else if ((pos - this.f1566b) * this.f1565a < 0 || (pos - this.f1566b) % this.f1565a != 0) {
                return false;
            } else {
                return true;
            }
        ...
        public String toString() {
            if (this.f1565a == 0) {
                return String.format(":%s(%d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f1566b)});
            } else if (this.f1566b == 0) {
                return String.format(":%s(%dn)", new Object[]{getPseudoClass(), Integer.valueOf(this.f1565a)});
            } else {
                return String.format(":%s(%dn%+d)", new Object[]{getPseudoClass(), Integer.valueOf(this.f1565a), Integer.valueOf(this.f1566b)});
            }
        }
    }
